...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "CDSUnMatchedHoldings"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			entryID = rs.Fields("importedID") '& "<->" & rs.Fields("Lot_DPA_")
			...
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & ApplyDisplayColor(FormatDate1(rs.Fields("tradeDate"))) & quote & ","
			rowData = rowData & quote & ApplyDisplayColor(rs.Fields("CDSNO")) & quote & "," 
			'rowData = rowData & quote & ApplyDisplayColor(rs.Fields("ClientCode")) & quote & ","
			rowData = rowData & quote & ApplyDisplayColor(rs.Fields("SecurityImportCode")) & quote & "," 
			rowData = rowData & quote & ApplyDisplayColor(FormatNumCommasOnly(rs.Fields("Quantity"))) & quote & ","
			rowData = rowData & quote & ApplyDisplayColor(rs.Fields("AccountStatus")) & quote & ","
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Trade Date", "CDSNo","Security", "Quantity", "Account Status",];
