		...
		try{
			...
			if (selFile.length > 3){
				...
				if (isAccepted==true){
					...
					document.forms[0].action="import_PriceList.asp";
					  }
					document.forms[0].submit(); 
				}
				else {
					ShowMessage('The selected type of file is not accepted.\nEnsure that the file picked out is a valid Excel file.');
				}	
			}	
		}	
...
<body class="Reports" leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	<form method="post" enctype="multipart/form-data"  action="import_PriceList.asp" name="frmFile">
	...
	<table border=0 cellspacing=5 cellpadding=5>
		...
		<tr>
			<td>
				...
				<br><input type="radio" class="BorderLess" value="dTrade2" id="dTrade2" name="CDSMode" onclick ="javascript: window.location.replace('importHoldings.asp');">&nbsp;&nbsp;<label for="dTrade2" style="cursor: hand">Client Holdings<label>
				...
				<br><input type="radio" checked class="BorderLess" value="1" id="price" name="CDSMode"  onclick ="javascript: window.location.replace('importPriceList.asp');">&nbsp;&nbsp;<label for="price" style="cursor: hand">Import Price List</label>
