<%
	Const report_ViewName = "SaleOrderList"
	Const reportPage = "down_SaleOrderList.asp"
	Const headerColCount = 3
	Const groupingHeaderCol = 0
	Const reportTitle = "Sale Orders"
%>
<html>
<head>
...
End Select
	...
	GroupingColumn = Rs.Fields(groupingHeaderCol).Value  	
		...
		filename = "SaleOrder_" & FormatDate(date) & ".csv"
...
Loop
	...
	sqlStr=sqlStr & " SELECT '" & filename & "' AS Filename, '" & "Sale Order Schedule" & "' AS Report, " & Session("UserID") & " AS CreatedBy,  "
...
<SCRIPT Language="JavaScript">
	alert ("Sale order schedule generated!");
