<%
	...
	Const reportPage = "down_OutstandingOrderList.asp"
...
<%
		...
		Dim fso, txtLine, txtStream, txtStreamOut, filename
			...
			filename = "OutstandingOrderSchedule_" & FormatDate(date) & ".csv"
...
Loop
		...
		sqlStr=sqlStr & " SELECT '" & filename & "' AS Filename, '" & "Outstanding Order Schedule" & "' AS Report, " & Session("UserID") & " AS CreatedBy,  "
...
<SCRIPT Language="JavaScript">
	alert ("Outstanding order schedule generated!");
