...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "GroupAccessList"
		const DataEntity = "GroupAccess"
		const DataEntityPlural = "Group Access"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowIDs = rowIDs & quote & rs.Fields("ID") & quote 
			rowCount = rowCount + 1
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="GroupName:Group*0;mnuCaption:Access*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="GroupName:Group;mnuCaption:Access">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="GroupName:Group*0;mnuCaption:Access*0">
