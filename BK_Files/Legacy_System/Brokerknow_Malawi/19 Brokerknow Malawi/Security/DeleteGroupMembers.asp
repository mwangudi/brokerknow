   ...
   Dim rs
	...
	if action = "EXECUTE" then
       ...
       ID = Request.Form("ID")
        ...
        sqlStr = "SELECT Child,DeletionMessage,ParentKey FROM [_Parent_Child_Links_] WHERE (Parent = 'UserGroups') AND (ChildType = " & LinkedIndependent & ")"
        ...
        sqlStr = "DELETE FROM [UserGroups] WHERE MemberID = " & ID
        conn.Execute sqlStr
        Set Conn = Nothing
