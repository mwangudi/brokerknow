   ...
   Dim rs
	...
	if action = "EXECUTE" then
       ...
       ID = Request.Form("ID")
        ...
        sqlStr = "SELECT Child,DeletionMessage,ParentKey FROM [_Parent_Child_Links_] WHERE (Parent = 'Groups') AND (ChildType = " & LinkedIndependent & ")"
        ...
        sqlStr = "DELETE FROM [Groups] WHERE GroupID = " & ID
        conn.Execute sqlStr
        Set Conn = Nothing
