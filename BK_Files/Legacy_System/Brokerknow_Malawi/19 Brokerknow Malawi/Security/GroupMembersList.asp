...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "GroupMembersList"
		const DataEntity = "GroupMembers"
		const DataEntityPlural = "Group Members"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("MemberID") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("GroupName") & quote & "," 
			rowData = rowData & quote & rs.Fields("Member") & quote  			
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("MemberID") & quote 
			rowCount = rowCount + 1
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="GroupName:Group*0;Member:Member*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="GroupName:Group;Member:Member">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="GroupName:Group*0;Member:Member*0">
