...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "GroupsList"
		const DataEntity = "Group"
		const DataEntityPlural = "Groups"
		const ActionFolder = "Security"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("GroupID") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("GroupName") & quote & "," 
			rowData = rowData & quote & rs.Fields("Description") & quote  			
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("GroupID") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Group", "Description"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="GroupName:Group*0;Description:Description*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="GroupName:Group;Description:Description">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="GroupName:Group*0;Description:Description*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:10em;width:17em">
