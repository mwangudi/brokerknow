...
With cdoConfig.Fields  
	...
	.Item(cdoSMTPServer) = Rs.Fields("SMTPServer").Value
	.Item(cdoSMTPAuthenticate) = 1  
	.Item(cdoSendUsername) = Rs.Fields("SendUserName").Value
	.Item(cdoSendPassword) = Rs.Fields("SendPassword").Value
	.Update  
End With 
...
With cdoMessage 
	...
	'.CreateMHTMLBody "file://D:\08 - Brokerknow KENYA\blank.htm" 
	.Send 
End With 
