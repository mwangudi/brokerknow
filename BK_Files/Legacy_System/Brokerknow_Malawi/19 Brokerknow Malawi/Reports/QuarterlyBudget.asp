...
<div id="spiffycalendar" class="text" STYLE="z-Index: 1000"></div>
	<form method="POST" action="QuarterlyBudget.asp" Name="frmMain" id="frmMain">	
			<table>			
			<tr>
				<td>Select date:</td>
				<td>
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
     <tr>
		<td nowrap><b><font face="Arial Narrow" size="4">QUARTERLY BUDGET</font></b></td>
	...
	%>
	<tr>
		  <td COLSPAN=2><font face="Arial" size="2"><b>For the&nbsp;<%=QuarterName%>&nbsp; of the Year &nbsp;<%=ucase(Year((CDate(SelectedFromDate))))%></b></font></td>
	</tr>
</table>			
	...
	AccountType1=CloneRs("AccountTYpeParent_DPA_")
		...
		if(Month(CDate(SelectedFromDate))<=3) then
			...
			SecondDate=CDate("31/03/" & Year(CDate(SelectedFromDate)))
		end if
		if(Month(CDate(SelectedFromDate))>3 and Month(CDate(SelectedFromDate))<=6) then
