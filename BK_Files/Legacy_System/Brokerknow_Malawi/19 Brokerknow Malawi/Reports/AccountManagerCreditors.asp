...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="AccountmanagerCreditors.asp" Name="frmMain" id="frmMain">
...
<%
   ...
   Set conn = GetActiveConnection("KBroker")
	...
	Conn.Execute("ClientBalancesProcedure")
	    ...
	    sqlStr = "SELECT * FROM [AccountManagerCreditors] WHERE Owner_DPA_ LIKE '" & selectedAgent & "'"		 
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
      <td width="10%" nowrap><b><font face="Arial" size="4"><b>Account Manager Creditors</b></font></b></td>
