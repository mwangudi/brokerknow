...
Const report_ViewName = "ClientReport"
			...
			<tr>
				...
				<td>
					<SELECT Name="genReport">
						...
						<OPTION VALUE="4">Non Custodians</OPTION>	
					</SELECT>
				</td>
			</tr>
			<tr>
...
Select Case  genReport 
	...
	Case "4"
		If SelectedSearchArgs <> ""  Then
			SelectedSearchArgs = " AND " & Mid(SelectedSearchArgs,  7)
		End If
		sqlStr = "SELECT " & selColumns & " FROM " & report_ViewName & " WHERE [isCustodian] <> 1 "  & SelectedSearchArgs & " " &  orderByCols  
	Case Else
		Response.End
End Select
...
Set Rs = Conn.Execute(sqlStr)
 ...
 If Rs.EOF Or Rs.BOF Then%>
		<Script Language="JavaScript">	
			ShowMessage('No clients were found using the criteria entered.');
