...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then%>
	...
	<form method="POST" action="ContractStampsByDate.asp" Name="frmMain" id="frmMain">
...
<%
   ...
   Dim rs
		 ...
		 sqlStr = "SELECT * FROM [ContractStampsByDate] WHERE DATEPART(month, TransDate) = " & Month(selectedTradeDate) & " AND DATEPART(yy, TransDate) = " & Year(selectedTradeDate)  
...
<table border="0" cellspacing="0" cellpadding="4" style="font-family: Arial Narrow; LEFT-MARGIN:100PX">
    ...
    <tr>
      <td  colspan=3  align=left style="border-bottom-style: solid; border-bottom-width: 1"> &nbsp; </td>
    </tr>
    
    <tr>
      <td  colspan=3 align=left style="border-top-style: solid; border-top-width: 1;border-bottom-style: solid; border-bottom-width: 1">
...
RETURNS FOR:<%=  Space(6) & headerDescription %>
    ...
    <tr>
      <td  colspan=3 align=left style="border-top-style: solid; border-top-width: 1"> &nbsp;
	  </td>
    </tr>
