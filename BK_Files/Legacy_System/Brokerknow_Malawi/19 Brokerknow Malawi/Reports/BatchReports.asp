...
<form method="POST" action="BatchReports.asp" Name="frmMain" id="frmMain">
...
response.write "CONTRACT NOTE COMPOUNDED"
...
response.write "AGENT CONTRACTS"
...
response.write "AGENT CONTRACT COMPOUNDED"
