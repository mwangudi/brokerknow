...
If genReport <> "1" Then%>
	...
	<form method="POST" action="LeviesReportByDate1.asp" Name="frmMain" id="frmMain">
...
headerDescription = " Between " & FormatDate(selectedFromDate) & " and " & FormatDate(selectedToDate) 
		...
		End If
 		...
 		sqlStr = "Select * From TrialLeviesReportByDate Where SystemMaintained="& selectedClient & " and " & _
