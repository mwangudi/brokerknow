...
<%
	...
	sqlStr = "SELECT     tbOrder.*, Client.ClientAddr,ClientCDSNo,Client.Client_DPA_ FROM Lot INNER JOIN " & _
			" OrdDetail ON Lot.OrdDetail_DPA_ = OrdDetail.OrdDetail_DPA_ INNER JOIN " & _
	...
	<tr>
		<td nowrap width="80%" valign="top">			
			<table cellspacing=0 cellpadding=0 border=0  align ="center" width="100%">
				...
				<tr>					
					<td nowrap><b>Account:</b> <%=Rs.Fields("orddetailClient").Value  %>[<%= code %>] [<%=clientCDSNo %>]</td>
				</tr>
			</table>
		</td>
		...
		<td COLSPAN=2 VALIGN="TOP">
			<TABLE width="100%" CELLSPACING="0" CELLPADDING="4">
				<TR>		
					...
					if false then 'brokerRate= 0 then 
						Response.Write "0 %"
					else
