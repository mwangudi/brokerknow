...
<title>Client Trade Volume Totals</title>
...
report_description = "Client Trade Volume Totals"
...
If genReport = ""  Then%>
	...
	<form method="POST" action="ClientTradeVolumeTotals.asp" Name="frmMain" id="frmMain">
			...
			<tr style="display: none;" id="OwnFieldsSelectRow" align="right">
				<td colspan=2 valign="top" style="PADDING-LEFT: 25px">
					<TABLE border="0" cellpadding="2" cellspacing="5">
						...
						Set Rs = Conn.OpenSchema (adSchemaColumns, Array(Empty, Empty, "ClientTradeVolumeTotals"))
...
sqlStr = "SELECT " & selColumns & " FROM ClientTradeVolumeTotals " & SelectedSearchArgs & " " &  orderByCols 
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
	...
	if(i = 1 or i = 0) then
	%>		
	 	 <td nowrap align="left"><b><font color="#FFFFFF"><%= Rs.Fields(i).Name %></font></b></td>
   	<%	
	else
	%>		
