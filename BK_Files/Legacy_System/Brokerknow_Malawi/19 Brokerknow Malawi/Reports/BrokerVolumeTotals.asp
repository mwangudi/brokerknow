...
<title>Brokers Volume Totals</title>
...
report_description = "Brokers Volume Totals"
...
If genReport = ""  Then%>
	...
	<form method="POST" action="BrokerVolumeTotals.asp" Name="frmMain" id="frmMain">
			...
			<tr style="display: none;" id="OwnFieldsSelectRow" align="right">
				<td colspan=2 valign="top" style="PADDING-LEFT: 25px">
					<TABLE border="0" cellpadding="2" cellspacing="5">
						...
						Set Rs = Conn.OpenSchema (adSchemaColumns, Array(Empty, Empty, "BrokerVolumeTotals"))
...
sqlStr = "SELECT " & selColumns & " FROM BrokerVolumeTotals " & SelectedSearchArgs & " " &  orderByCols 
