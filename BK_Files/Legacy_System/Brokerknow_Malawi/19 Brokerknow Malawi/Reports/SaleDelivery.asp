...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then%>
	...
	<form method="POST" action="SaleDelivery.asp" Name="frmMain" id="frmMain">
		...
		<table>
			...
			<tr>
				<td>&nbsp;</td>
				<td>
					<p><input type="radio" class="BorderLess" checked Name="timeLimit" value="0" id="NSETime"><label for="NSETime" style="cursor: hand">Use USE time limit</label></p>
...
<%
   ...
   'For i = 0 To 1
		...
		SqlStr = "SELECT     Contract.Contract_DPA_, Contract.ContractTransferNo, Contract.ContractDeliveryDate, LotList.Lot_DPA_, LotList.BrokerCode, LotList.OrdDetailType,  " & _
			"                       LotList.OrderTypeSale, LotList.LotSlipNo, LotList.LotTDate, SUM(LotList.LotQty) AS LotQty, MAX(LotList.LotPrice) AS LotPrice, LotList.ContractNumber, LotList.StatusDescription,  " & _
			"                       LotList.OrdDetailClient, Contract.ContractDelivered, LotList.OrdDetailSecurity, Contract.Voucher_DPA_, Contract.ContractVouchered,  " & _
			"                       Contract.ContractCertNo AS ContractCertificate, Security.SecurityCode,  " & _
			"                       OrderSecType.OrderSecTypeDisplayName, OrderSecType.OrderSecType_DPA_, Contract.ContractCertNo AS ContractNCertificate " & _
			" FROM         Contract INNER JOIN " & _
			"                       LotList ON Contract.Contract_DPA_ = LotList.Contract_DPA_ INNER JOIN " & _
			"                       OrdDetail ON LotList.OrdDetail_DPA_ = OrdDetail.OrdDetail_DPA_ INNER JOIN " & _
			"                       LotView ON OrdDetail.OrdDetail_DPA_ = LotView.OrdDetail_DPA_ INNER JOIN " & _
			...
			"                       OrderSecType ON Security.OrderSecType_DPA_ = OrderSecType.OrderSecType_DPA_ " & _
			" WHERE     (OrdDetail.Deleted = 0 OR " & _
			"                       OrdDetail.Deleted IS NULL) AND (Contract.Deleted = 0 OR " & _
			"                       Contract.Deleted IS NULL) " & _
			" AND LotList.OrderTypeSale = " & transType & " AND LotList.LotTDate = '" & FormatDate(originalselectedTradeDate) & "'" & _
			" GROUP BY Contract.Contract_DPA_, Contract.ContractTransferNo, Contract.ContractDeliveryDate, LotList.Lot_DPA_, LotList.BrokerCode, LotList.OrdDetailType,  " & _
			"                       LotList.OrderTypeSale, LotList.LotSlipNo, LotList.LotTDate, LotList.ContractNumber, LotList.StatusDescription,  " & _
			"                       LotList.OrdDetailClient, Contract.ContractDelivered, LotList.OrdDetailSecurity, Contract.Voucher_DPA_, Contract.ContractVouchered,  " & _
			"                       Contract.ContractCertNo, Security.SecurityCode, OrderSecType.OrderSecTypeDisplayName, OrderSecType.OrderSecType_DPA_,  " & _
			"                       Contract.ContractCertNo"
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="80%">
     <tr>
		     <td>
		        <b><font face="Arial Narrow" size="4">Sale Delivery</font></b></td>
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="80%">
    <tr>
      <td colspan=2 align=right style="border-top-style: solid; border-top-width: 1"><b><font face="Arial Narrow" size="2">TO:&nbsp;UGANDA STOCK EXCHANGE</font></b></td>
    </tr>

    <tr>
      <td  style="border-bottom-style: solid; border-bottom-width: 1">
        <b><b><font face="Arial Narrow" size="2">EXPECTED DELIVERY DATE:</font></b></td>
...
<BR>
  ...
  <table border="0" cellspacing="0" cellpadding="4" style="font-family: Arial Narrow;" width="80%">
    <tr>
      ...
      <td align="right" bgcolor="#000000"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Quantity</font></b></td>
      <td align="right" bgcolor="#000000"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Price</font></b></td>
       <%
      If transType = 1 Then
