...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="EquitySettlement.asp" Name="frmMain" id="frmMain">
...
<br>
 <table border="0" cellspacing="0" cellpadding="3" style="font-family: Arial Narrow; LEFT-MARGIN:100PX" width="900">
	...
	<td bgcolor="#000000" width="9"><b><font color="#FFFFFF" face="Arial Narrow" size="3">&nbsp;</font></b></td>
      ...
      <td align="left" bgcolor="#000000" width="66"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Buy/Sale</font></b></td>
	...
	first=0
		...
		'CounterParty=Mid(rs("OwnerName"),1,30)
			...
			<tr>
			  ...
			  <td align="left" width="100"><font  face="Arial Narrow" size="2"><%= FormatDate(rs("LotTDate")) %></font></td>							  			  			  
			  <td align="left" width="63"><font  face="Arial Narrow" size="2"><%= rs("LotSlipNo") %></font></td>							  
			  <td align="left" width="60"><font face="Arial Narrow" size="2"><%= rs("OrderTypeDescription") %></font></td>
    ...
    <tr>
      <td align="right"><b>Net Settlement Position: </b></td>
