...
<SCRIPT language=Javascript src="../scripts/reports.js"></SCRIPT>
	...
	<script language="vbscript">
		Function DoSendMail()
			...
			frm1.method = "post"
			frm1.action = "../Mailer/EmailBatchReports2.asp"
			frm1.submit
		End Function
	</script>
</head>
...
<!--#include file="BatchReportsFunctions2.asp"-->
...
If genReport <> "1" Or selectedContractDate = "" Then
	...
	<Script Language="JavaScript">
		...
		{			
			...
			frm.action = 'BatchReportsSA2.asp?genReport=1&selectedContractDate='+frm.txtDate.value;
			frm.target = '_self';			
			frm.submit();
		}
	...
	<form method="POST" action="BatchReportsSA2.asp" Name="frmMain" id="frmMain">
