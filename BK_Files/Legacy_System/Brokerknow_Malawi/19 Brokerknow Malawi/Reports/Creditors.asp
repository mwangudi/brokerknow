...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="Creditors.asp" Name="frmMain" id="frmMain">
...
<br>
 <table border="0" cellspacing="0" cellpadding="3" style="font-family: Arial Narrow; LEFT-MARGIN:100PX" width="700">
    <tr>
      ...
      <td align="left" bgcolor="#000000" width="800"><b><font color="#FFFFFF" face="Arial Narrow" size="3" >Last Date</font></b></td>
    </tr>
