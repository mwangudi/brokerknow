...
Const report_ViewName = "ReceiptsReport"
...
If genReport = "" Or report_description = "" Then%>
	...
	<form method="POST" action="ReceiptsListing.asp" Name="frmMain" id="frmMain">
			...
			<tr>
				...
				<td>
					<SELECT Name="genReport">
						<OPTION VALUE="1">Receipts Listing</OPTION>
					</SELECT>
				</td>
			</tr>
...
Set Rs = Conn.Execute(sqlStr)
 ...
 If Rs.EOF Or Rs.BOF Then%>
		<Script Language="JavaScript">	
			ShowMessage('No records were found using the criteria entered.');
