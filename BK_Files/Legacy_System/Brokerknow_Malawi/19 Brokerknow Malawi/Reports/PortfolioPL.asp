...
If genReport <> "1" Then%>
		...
		var cal=new ctlSpiffyCalendarBox("cal", "frmMain", "txtFromDate","cmdDate","<%= FormatDate(Date) %>",1);
...
<%
	...
	sqlStr = "Select * From [Portfoliobs] WHERE Client_DPA_ = " & selectedClient
	...
	sqlStr = "SELECT Client.ClientAddr,Client.ClientContact,'W' + ClientOfficeTel + '/' + Client.ClientEmail as Contacts FROM Client " & _			
...
<table border="0" cellspacing="2" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
	  <td bgcolor="#000000" width="80%" nowrap align="right"><font color="#FFFFFF" face="Impact" size="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PORTFOLIO&nbsp;&nbsp;BS</font></td>
	...
	<tr>
		<td style="border: 1px solid #000000" valign="top">
				<table cellspacing=0 cellpadding=0 border=0>
					<tr>
						<td nowrap>CLIENT&nbsp;&nbsp;NAME&nbsp;&nbsp;<%= Rs.Fields("clientName").Value %> </td>					
					</tr>
					<tr>
...
Do Until Rs.EOF
	...
	<tr>
      ...
      <td><font face="Arial Narrow" size="2"><%=rs("SecurityName")%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=formatNumEx(rs("Lastquantity"),0)%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(rs("LastPrice"))%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(rs("MarketPrice"))%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(rs("SecurityBookValue"))%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(rs("SecurityCurrentValue"))%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(rs("LastPL"))%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNumEx(rs("LastPL_"),2)%>%</font></td>      
    </tr>
	<%
	Equityvalue=rs("ClientBookValue")
	Equityvalue1=rs("ClientCurrentValue")
    CashOnHand=rs("cash")
    Total=rs("TotalPortfolio")
...
<td colspan="9">&nbsp;</td>
	...
	<tr>
      ...
      <td><font face="Arial Narrow" size="2">&nbsp;</font></td>
      <td><font face="Arial Narrow" size="2">&nbsp;</font></td>
      <td><font face="Arial Narrow" size="2">Cash&nbsp;On&nbsp;Hand</font></td>
      <td><font face="Arial Narrow" size="2">&nbsp;</font></td>
      <td><font face="Arial Narrow" size="2">&nbsp;</font></td>
