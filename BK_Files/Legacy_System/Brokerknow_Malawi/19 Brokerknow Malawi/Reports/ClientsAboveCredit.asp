...
<title>Clients Above Credit Limit</title>
...
report_description = "Clients Above Credit Limit"
...
If genReport = ""  Then%>
	...
	<form method="POST" action="ClientsAboveCredit.asp" Name="frmMain" id="frmMain">
			...
			<tr style="display: none;" id="OwnFieldsSelectRow" align="right">
				<td colspan=2 valign="top" style="PADDING-LEFT: 25px">
					<TABLE border="0" cellpadding="2" cellspacing="5">
						...
						Set Rs = Conn.OpenSchema (adSchemaColumns, Array(Empty, Empty, "ClientsAboveCreditLimitProc"))
...
sqlStr = "SELECT " & selColumns & " FROM ClientsAboveCreditLimit " & SelectedSearchArgs & " " &  orderByCols 
