...
<title>Broker Balance List</title>
...
report_description = "Brokers Balance List"
...
If genReport = ""  Then%>
	...
	<form method="POST" action="BrokerBalanceList.asp" Name="frmMain" id="frmMain">
			...
			<tr style="display: none;" id="OwnFieldsSelectRow" align="right">
				<td colspan=2 valign="top" style="PADDING-LEFT: 25px">
					<TABLE border="0" cellpadding="2" cellspacing="5">
						...
						Set Rs = Conn.OpenSchema (adSchemaColumns, Array(Empty, Empty, "BrokerBalanceList"))
...
sqlStr = "SELECT " & selColumns & " FROM BrokerBalanceList " & SelectedSearchArgs & " " &  orderByCols 
