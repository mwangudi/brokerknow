...
<title>Contract CMA Compensation Funds</title>
...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then%>
	...
	<form method="POST" action="ContractCMAByDate.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="0" cellpadding="4" style="font-family: Arial Narrow; LEFT-MARGIN:100PX">
     ...
     <tr>
		     <td colspan=2>
		        <b><font face="Arial Narrow" size="4">Contract CMA Compensation Funds</font></b></td>
...
<tr>
	...
	<td bgcolor="#000000" align=right><b><font color="#FFFFFF" face="Arial" size="2">MSEC</font></b></td>	
  </tr>
<%		
	totalLevyAmount = 0
	totalgross=0
