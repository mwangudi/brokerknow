...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="FinalEquitySettlement.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    ...
    <tr>
      <td width="10%" nowrap><b><font face="Arial" size="4"><b>FINAL SETTLEMENT SCHEDULE</b></font></b></td>
