...
<table border="0" cellspacing=2 cellpadding=2 class="ReportsTable" align ="center" width="90%"> 
	...
	<tr>
		<td colspan=2><font face=Arial size=2>We wish to advise that we have <% If IsPurchase Then Response.Write "bought" Else Response.Write "sold"  %> the following securities as per your instruction. The cash balance in your investment account will be <% If IsPurchase Then Response.Write "debited" Else Response.Write "credited"  %> with the total amount reflected below. 
		<!--Kindly arrange to complete the transaction as per the details given below:--> </font></td>
	</tr>
	<tr>
...
<%
	...
	'important!
		If Not groupRs.EOF Then %>
			<table class="newpage"><tr><td></td></tr ></table>
	<%	End If
