   ...
   Set conn = GetActiveConnection("KBroker")
    ...
    Set tempRs = Nothing
     ...
     sqlStr = "SELECT * FROM [Holidays]"
		...
		sqlStr = "SELECT * FROM [PaymentVoucher] WHERE SettlementDate = '" & FormatDate(selectedTradeDate) & "' ORDER BY ClientName"
...
<table width=100%>
     <tr>
		     <td>
                <b><font face="Arial Narrow" size="4">Payment Voucher</font></b></td>
     ...
     <tr>
		     <td colspan=2>
		        <font face="Arial" size="2">printed for each individual client&nbsp;</font></td>
		</tr>
	<tr>
		     <td colspan=2>
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
      <td width="20%" style="border-top-style: solid; border-top-width: 1"><b><font face="Arial Narrow" size="2">CLIENT:</font></b></td>
      <td style="border-top-style: solid; border-top-width: 1"><font face="Arial" size="2"><%= Rs.Fields("ClientName").Value %></font></td>
    </tr>
    <tr>
      <td width="20%" >
    ...
    <tr>
      <td width="20%" style="border-bottom-style: solid; border-bottom-width: 1">
        <p align="left"><b><font size="2"  face="Arial Narrow">CHEQUE NO:</font></b></td>
...
<font face="Arial" size="2">
			<b>Payment to Clients</b></font>			
<b><font face="Arial" size="2">		
Please prepare payment payable to clients as per the details shown on this voucher.
...
<tr bgcolor="#000000">
	...
	<td align=right bgcolor="#000000"><b><font color="#FFFFFF" face="Arial" size="2">Net</font></b></td>
...
<%		
	...
	isDifferentClient = False
		 ...
		 Do Until isDifferentClient 
			totalNetAmount = totalNetAmount + FormatNum(rs.Fields("NetAmount")) %>
                <tr>
                        ...
                        <td align=right><%= FormatNum(rs.Fields("NetAmount")) %></td>
         ...
         <tr>
						<td colspan=6 align=right><b>Client Totals:</b></td>
                        <td align=right style="border-style: solid; border-color: #000000; border-width: 1" height="30px"><%= FormatNum(totalNetAmount) %></td>
