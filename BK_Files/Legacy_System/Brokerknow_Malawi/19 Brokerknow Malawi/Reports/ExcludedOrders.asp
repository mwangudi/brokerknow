...
<title>Excluded Purchase Orders</title>
...
<%
	...
	Dim Security2
		 ...
		 sqlStr = "SELECT * FROM Db_FineTradingSchedule WHERE ((Validity >= { fn CURDATE() }) OR " & _
             "(Validity IS NULL)) AND ordDetailSecType NOT LIKE 'Fixed' AND OrdDetailType = 'Purchase' AND Iscustodian = 0  ORDER BY Code,Client,Order_DPA_"   
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
     <tr>
		<td nowrap><b><font face="Arial Narrow" size="4">Excluded Purchase  Orders</font></b></td>
  ...
  <table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="1000">        
	...
	' and groupRs.Fields("OrdDetailType")="Purchase"
	if (Cdbl(groupRs("Excess"))>0) then    	
    ...
    %>
			<tr>
			  ...
			  <td align="right" width="50"><%= groupRs.Fields("BalanceQty").Value %> </td>
			  	...
			  	%>
			  	<td align="right" width="74"><%= FormatNum(groupRs.Fields("Price").Value * 1.020825) %> </td>
			  	<td align="right" width="74"><%= FormatNum(groupRs.Fields("BalanceQty")*groupRs.Fields("price").Value * 1.020825) %> </td>			  	
			  	<%
			  	else
			  	%>
