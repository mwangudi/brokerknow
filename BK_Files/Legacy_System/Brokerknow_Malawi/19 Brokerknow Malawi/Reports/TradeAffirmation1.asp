...
<%
   ...
   sqlStr = "SELECT Order_DPA_ FROM TradeAffirmation WHERE LotTDate = '" & FormatDate(selectedTradeDate) & "'"
   ...
   sqlStr = "SELECT Order_DPA_, OrderRef FROM TradeAffirmation WHERE LotTDate = '" & FormatDate(selectedTradeDate) & "'"
