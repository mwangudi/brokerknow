...
Const report_ViewName = "PaymentsReport"
...
If genReport = "" Or report_description = "" Then%>
	...
	<form method="POST" action="PaymentsListing.asp" Name="frmMain" id="frmMain">
			...
			<tr>
				...
				<td>
					<SELECT Name="genReport">
						<OPTION VALUE="1">Payments Listing</OPTION>
					</SELECT>
				</td>
			</tr>
