...
If genReport <> "1" Then%>
	...
	<form method="POST" action="TradingSummary.asp" Name="frmMain" id="frmMain">
...
End If
	...
	sqlStr = "Select * From [DB_Portfolios] WHERE Client_DPA_ = " & selectedClient & " And TransDate between '" & FormatDate(CDate(selectedFromDate)) & "' and '" & FormatDate(CDate(selectedToDate)) & "' order by Security_DPA_,TransDate"
...
<table border="0" cellspacing="2" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
	  <td bgcolor="#000000" width="80%" nowrap align="left"><font color="#FFFFFF" face="Impact" size="2">TRADING&nbsp;&nbsp;&nbsp;&nbsp;SUMMARY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
...
Security1=rs("Security_DPA_")	
	if(Security1<>Security2) then
		...
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNumEx(PreviousBookQty,0)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(PreviousBuy)%></font></b></td>
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(PreviousBookaValue)%></b></font></td>      
		</tr>
		<%
    ...
    <tr>      
      ...
      <td align="left" colspan="3" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="3"><b>HOLDINGS</b></font></td>            
    </tr>	
	<tr>      
	...
	<tr>      
		<td align="right" colspan="7"><font face="Arial Narrow" size="2"><b>PORTFOLIO&nbsp;TOTAL</b></font></td>      		
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(TotalBookValue)%></b></font></td>      
	</tr>
</table>	
</body>
