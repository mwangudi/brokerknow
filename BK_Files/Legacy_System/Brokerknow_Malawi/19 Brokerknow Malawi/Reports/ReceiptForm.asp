...
sqlStr = "SELECT * FROM ReceiptList"
...
%>
<div align="right">
<TABLE cellSpacing=0 cellPadding=0 border=1 width="100%" bordercolor="#111111" height="100" style="border-collapse: collapse">
  <TBODY 
  style="BORDER-LEFT-COLOR: black; BORDER-BOTTOM-COLOR: black; BORDER-TOP-COLOR: black; BORDER-RIGHT-COLOR: black">
	<TR>	  
    <TD colspan="4" height="50" width="100%">&nbsp;<TD>
    </TR>
	<TR>	    
    <TD align="left" colspan="4" height="20" valign="center"><P><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs("EntityCode")%></strong>&nbsp;&nbsp;<strong><%=rs("EntityName")%></strong><br>
            <STRONG> &nbsp;&nbsp; </STRONG><br>
          </P></TD>
    </TR>      	
  <TR>
  <TD colspan="4" height="40" valign="center" align="left" width="400">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><%=ConvertTowords(rs("PaymentAmount"),".")%></b></TD>
  </TR>
  <TR>	  
    <TD colspan="4" height="20">&nbsp;<TD>
  </TR>	  
  <TR>
      <TD align="right" colspan="4" height="10" valign="top"><font size="2">&nbsp; <b><font size="2"><%=rs("PaymentReceiptNo")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></b></font></TD>    
  </TR>   
  <TR>   
      <TD colspan="4" height="32" valign="top" valign="bottom">
       <P><b><STRONG>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=InPaymentOf%>&nbsp;<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs("PaymentNarrative")%></strong></b></P></TD>
  </TR>
  <TR>       
          <TD width="163" align="left" height="20" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><%=formatNumber(rs("PaymentAmount"))%></b></TD>
          <TD width="160" align="left" height="20" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><%=rs("PaymentReference")%></TD>          
          <TD width="163" align="left" height="20" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><%=formatDate(rs("PaymentPDate"))%></b> </TD></TD>
          <TD width="163" align="left" height="20" valign="bottom"><b>&nbsp;</b> </TD></TD>
   </TR></TBODY></TABLE>  
