<html>
<head>
<title>Transactions Journals</title>
...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then
	...
	<form method="POST" action="TransactionsJournals.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
	<tr>
		<td nowrap><b><font face="Arial Narrow" size="4">Journal Transactions</font></b></td>
...
<table border="0" width="100%" cellPadding="2" cellSpacing=0>
	<tr bgColor="#000000">
		...
		<td bgColor="#000000" nowrap align="left"><b><font color="#FFFFFF">Entity</font></b></td>
		<td bgColor="#000000" nowrap align="left"><b><font color="#FFFFFF">Account</font></b></td>
		<td bgColor="#000000" nowrap align="right"><b><font color="#FFFFFF">Debit</font></b></td>
		<td bgColor="#000000" nowrap align="right"><b><font color="#FFFFFF">Credit</font></b></td>
	...
	sqlStr = "SELECT TOP 10 [User] AS ChangedBy, [Mod Date] AS ModDate, [Journal Date] AS JournalDate, [Entry No] AS EntryNo, Entity, Account, Debit, Credit, Del" & _
	" FROM TransactionsList_Journal WHERE [Journal Date] = '" & FormatDate(selectedTradeDate) & "'"
	...
	If Not(rs.EOF Or rs.BOF) Then
		Do Until rs.EOF
			%>
			<tr>
				<td nowrap align="left"><font size="1"><%=Day(rs.Fields("JournalDate")) & " " & MonthName(Month(rs.Fields("JournalDate")), True) & " " & Year(rs("JournalDate"))%></font></td>
				<td nowrap align="left"><font size="1"><%=rs("EntryNo")%></font></td>
				<td nowrap align="left"><font size="1"><%=rs("Entity")%></font></td>
				<td nowrap align="left"><font size="1"><%=rs("Account")%></font></td>
				<td nowrap align="right"><font size="1"><%=FormatNumber(rs("Debit"),2)%></font></td>
				<td nowrap align="right"><font size="1"><%=FormatNumber(rs("Credit"),2)%></font></td>
			...
			TotalDebit = TotalDebit + rs("Debit")
			TotalCredit = TotalCredit + rs("Credit")
			
			rs.MoveNext
		Loop
		%>
		<tr>
			<td nowrap colspan=4 align="left"><font size="1">&nbsp;</font></td>
			<td nowrap align="right" style="font-weight:bold;border-top:1 solid black;border-bottom:1 solid black;"><font size="1"><b><%=FormatNumber(TotalDebit,2)%></b></font></td>
			<td nowrap align="right" style="font-weight:bold;border-top:1 solid black;border-bottom:1 solid black;"><font size="1"><b><%=FormatNumber(TotalCredit,2)%></b></font></td>
