...
<%
   ...
   if(trim(ucase(left(sumRs.Fields("Type").Value,1))) = "P") then
	

		pageNumber = pageNumber + 1
				
%> 
<table border="0" cellspacing=2 cellpadding=2 class="ReportsTable">
    ...
    <tr>
      <td width="253">&nbsp;</td>
      <td width="400" height = "82" valign = top ><b><% ' = sumRs.Fields("Type").Value %></b>&nbsp;</td>
    </tr>
    <tr>
      <td width="131">&nbsp;</td>
      <td height = "23" valign = top ><b><%= sumRs.Fields("SlipNo").Value %>&nbsp;</b></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td height = "23" valign = top ><b><%= FormatDate(sumRs("TransDate")) %></b>&nbsp;</td>
    </tr>
    <% if(isnull(sumRs("SettlementDate"))or sumRs("SettlementDate")="") then
	%>
    <tr>
      <td>&nbsp;</td>
      <td height = "23" valign = top ><b>&nbsp;<b>&nbsp;</td>
    </tr>
	<% else
	%>
    <tr>
      <td>&nbsp;</td>
      <td height = "23" valign = top ><b><%= FormatDate(sumRs("SettlementDate")) %><b>&nbsp;</td>
    </tr>
    <% end if%>
    <tr>
      <td>&nbsp;</td>
      <td height = "247" valign = top ><b><%=FormatNumEx(sumRs("Price"),4)%>%</b></td>
    </tr>
    <tr>
      <td width="131">&nbsp;</td>
      <td height = "23" valign = top ><b>KSH.<%= FormatNum(sumRs("FaceValue")) %></b></td>
    </tr>
    <tr>
      <td width="131">&nbsp;</td>
      <td height = "23" valign = top ><b><%=sumRs("BondIssue")%></b>&nbsp;</td>
    </tr>      
    <tr>
      <td width="131">&nbsp;</td>
      <td height = "23" valign = top ><b><%= FormatDate(sumRs.Fields("IssueDate").Value) %></b>&nbsp;</td>
    </tr>        
    <tr>
      <td width="131">&nbsp;</td>
      <td height = "46" valign = top ><b><%= FormatDate(sumRs.Fields("MaturityDate").Value) %></b>&nbsp;</td>
    </tr>
