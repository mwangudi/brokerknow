...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">	 
     <tr>		
		<td colspan=2 nowrap align=right><font face="Arial Narrow" size="3">Page&nbsp;<%= intPage %></font></td>
	</tr>	    
     <tr>
		<td nowrap><font face="Arial Narrow" size="3">Contracts</font><font face="Arial Narrow" size="4"> </font>
        <font face="Arial Narrow" size="3">Schedule</font></td>
		<td nowrap align=right><font face="Arial Narrow" size="3"><%= Session("CompanyName") %></font>&nbsp;</td>
	</tr>	
    <tr>
	   <td COLSPAN=2><font face="Arial Narrow"  size="3">for</font><font face="Arial Narrow"  size="3"> </font>
       <font face="Arial Narrow"  size="3">Deals</font><font face="Arial Narrow"  size="4"> </font>
       <font face="Arial Narrow"  size="3">traded</font><font face="Arial Narrow"  size="4"> </font>
       <font face="Arial Narrow"  size="3">on</font><font face="Arial Narrow"  size="4">:  <%= headerDescription %></font></td>
	</tr>
    <tr>
		  <td COLSPAN=2><font face="Arial Narrow"  size="3">&nbsp;</font></td>
	</tr>
</table>				
    ...
    <tr>
	  ...
	  <td  nowrap align="left"><font face="Arial Narrow"  size="2" ><u>CODE</u></font></td>
      <td  nowrap align="left" ><font face="Arial Narrow"  size="2" ><u>CLIENT</u></font></td>
      <td  nowrap align="left"><u><font face="Arial Narrow"  size="2" >BR</font><font face="Arial Narrow"  size="5" >&nbsp;</font></u></td>
      <td  nowrap align="left"><font face="Arial Narrow"  size="2" ><u>CONT</u></font></td>
      <td  nowrap align="left"><font face="Arial Narrow"  size="2" ><u>SECUR</u></font></td>            
      <td  nowrap align="left"><font face="Arial Narrow"  size="2" ><u>SLIP</u></font></td>
      <td  nowrap align="Right"><font face="Arial Narrow"  size="2" ><u>PRICE</u></font></td>
      <td  nowrap align="Right"><font face="Arial Narrow"  size="2" ><u>QTY</u></font></td>
      <td  nowrap>&nbsp;</td>
      <%
		...
		for i = beginLeviesCol to rs.fields.count - 2
				...
				%>
					<td nowrap  align="right" width="10%"><font face="Arial Narrow" size="2" ><u><%=Ucase(mid(rs.fields(i).name,2,4))%></u></font>&nbsp;</td>		
				<%				
		next
      ...
      %>
		...
		<td nowrap align="right"><font  face="Arial Narrow" size="2" ><u>&nbsp;&nbsp;</font><font  face="Arial Narrow" size="2" ><span lang="en-us">GROSS</span></font><font  face="Arial Narrow" size="2" >&nbsp;&nbsp;</font></u></td>
		<td nowrap align="right"><u><font  face="Arial Narrow" size="2" ><span lang="en-us">NET AMOUNT</span></font></u></td>
    </tr>        
 <%
 i=0
...
%>
        		...
        		<tr>
      <td nowrap><font face="Arial Narrow" size="2"><%= rs("Client_DPA_")%></font>&nbsp;</td>
      <td nowrap><font face="Arial Narrow" size="2"><% If Len(rs.Fields("ClientName")) > 25 Then 
									Response.Write Mid(rs.Fields("ClientName"), 1, 25)
								   Else
									Response.Write rs.Fields("ClientName")	
								   End If	 %></font>&nbsp;</td>
	  <td nowrap align="center"><font face="Arial Narrow" size="2"><%=rs.Fields("BrokerCode")%></font>&nbsp;</td>
	  <td nowrap><font face="Arial Narrow" size="2"><%=rs.Fields("ContractNumber")%></font>&nbsp;</td>
      <td nowrap><font face="Arial Narrow" size="2"><%=rs.Fields("SecurityCode")%></font>&nbsp;</td>            
      <td nowrap><font face="Arial Narrow" size="2"><%=rs.Fields("LotSlipNo")%></font>&nbsp;</td>
      <td nowrap align="right"><font face="Arial Narrow" size="2"><%=FormatNum(rs.Fields("LotPrice"))%></font>&nbsp;</td>
      <td nowrap align="right"><font face="Arial Narrow" size="2"><%=FormatNumCommasOnly(rs.Fields("LotQty"))%></font>&nbsp;</td>       
      <td style="BORDER-RIGHT: #C0C0C0 1px inset; BACKGROUND-COLOR: transparent">&nbsp;</td>
           <%	levyTotals = 0
				for i = beginLeviesCol to rs.fields.count - 2
						...
						End If
						%>
							<td  nowrap align=right  Style="<%= myStyle %>"><font face="Arial Narrow" size="2"><%=FormatNum(rs.fields(i).value)%></font>&nbsp;</td>		
						<%
						'i = i + 1						
             ...
             <td nowrap align="right"><font face="Arial Narrow" size="2"><%= FormatNum(grossAmt) %></font>&nbsp;</td>       
             <td nowrap align="right"><font face="Arial Narrow" size="2"><%= FormatNum(netAmt) %></font>&nbsp;</td> 
             </tr>  
   ...
   End if    
		...
		<tr height="30px">
			...
			<font face="Arial Narrow" size="2">	
					DAILY</font><font face="Arial Narrow" size="2">	
					</font>		
			<font face="Arial Narrow" size="2">	
					TOTALS</font><font face="Arial Narrow" size="2">:
			</font>		
			</td>	
			 <%	
				for i = 0 to UBound(TotalDailyTotals)
						...
						%>
							<td  nowrap align=right style="<%= myStyle %>"><font face="Arial Narrow" size="2"><%= FormatNum(Trim(TotalDailyTotals(i))) %></font>&nbsp;</td>		
						<%
				next
