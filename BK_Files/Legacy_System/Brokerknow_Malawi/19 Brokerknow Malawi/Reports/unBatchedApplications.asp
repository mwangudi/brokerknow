...
<title>Unbatched applications</title>
...
<%
	...
	sqlStr = "SELECT * FROM OfferingsList where Batch_No is null"
	...
	If rs.EOF Or rs.BOF Then%>
		<Script Language="JavaScript">
			alert("The specified Batch does not have any transaction using the specified date criterion")
			window.history.go(-1);
		</Script>
		<%Set Rs = Nothing
		Set Conn = Nothing
...
<table border="0" cellspacing="2" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
		<td width="10%" nowrap><font face="Impact" size="4">Unbatched Applications</font></td>
