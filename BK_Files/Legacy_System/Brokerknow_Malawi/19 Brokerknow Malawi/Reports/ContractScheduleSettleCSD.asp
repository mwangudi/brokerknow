...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then%>
	...
	<form method="POST" action="ContractScheduleSettleCSD.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
     <tr>
		<td nowrap><b><font face="Arial Narrow" size="4">Settlement Schedule CSD</font></b></td>
    ...
    <tr bgColor="#000000">
      ...
      <%
		...
		Set conn = GetActiveConnection("KBroker")
 		sqlStr = "ContractLeviesCrossTabNewSettleCSD '" & FormatDate(selectedTradeDate) & "'"	
