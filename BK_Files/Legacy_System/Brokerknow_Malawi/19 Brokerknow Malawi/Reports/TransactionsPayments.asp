<html>
<head>
<title>Transactions Payment</title>
...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then
	...
	<form method="POST" action="TransactionsPayments.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
	<tr>
		<td nowrap><b><font face="Arial Narrow" size="4">Payment Transactions</font></b></td>
...
<table border="0" width="100%" cellPadding="2" cellSpacing=0>
	...
	sqlStr = "SELECT [User] AS ChangedBy, [Mod Date] AS ModDate, [Payment Date] AS PaymentDate, [Payment No] AS PaymentNo, Narrative, Amount, Mode, Bank, Del" & _
	" FROM TransactionsList_Payment WHERE [Payment Date] = '" & FormatDate(selectedTradeDate) & "'"
	...
	If Not(rs.EOF Or rs.BOF) Then
		Do Until rs.EOF
			...
			<tr>
				...
				<td nowrap align="left"><font size="1"><%=rs("PaymentNo")%></font></td>
