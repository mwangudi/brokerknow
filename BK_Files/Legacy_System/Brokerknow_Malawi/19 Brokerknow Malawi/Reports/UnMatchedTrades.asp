...
<%
	...
	Dim Security2
		 ...
		 sqlStr = "SELECT * From CDSUnMatchedTradesList"
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
     <tr>
		<td nowrap><b><font face="Arial Narrow" size="4">Un Matched Trades</font></b></td>
  ...
  <table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="600">
    <tr>     
     ...
     <td bgcolor="#000000" ><b><font color="#FFFFFF" face="Arial Narrow">REF&nbsp;Ref</font></b></td>
     ...
     <td bgcolor="#000000" ><b><font color="#FFFFFF" face="Arial Narrow">Client&nbsp;REF&nbsp;No</font></b></td>     
     <td bgcolor="#000000" ><b><font color="#FFFFFF" face="Arial Narrow">Type</font></b></td>          		
	</tr>
    <tr>
      <td colspan="8" width="600">&nbsp; </td>
    </tr>        
    <%    
    Do Until groupRs.EOF       			    
		%>
	<tr>		  
      <td><font face="Arial Narrow"><%=FormatDate(grouprs.Fields("TradeDate"))%></font></td>      
      <td><font face="Arial Narrow"><%=grouprs.Fields("CDSRef")%></font></td>
      <td><font face="Arial Narrow"><%=grouprs.Fields("SecurityDescription")%></font></td>
      <td><font face="Arial Narrow"><%=FormatNumCommasOnly(grouprs.Fields("Quantity"))%></font></td>
      <td><font face="Arial Narrow"><%=FormatNum(grouprs.Fields("Price"))%></font></td>
      <td><font face="Arial Narrow"><%=grouprs.Fields("BrokerCode")%></font></td>
      <td><font face="Arial Narrow"><%=grouprs.Fields("ClientDescription")%></font></td>
      <td><font face="Arial Narrow"><%=IIf(grouprs.Fields("CDSOrderTypeSale") = "S", "S", "P")%></font></td>      
    </tr>		
    		<%		    		
		groupRs.MoveNext
    Loop
