...
Const report_ViewName = "BrokerReport"
...
If genReport = "" Or report_description = "" Then%>
	...
	<form method="POST" action="BrokerListing.asp" Name="frmMain" id="frmMain">
...
Set Rs = Conn.Execute(sqlStr)
 ...
 If Rs.EOF Or Rs.BOF Then%>
		<Script Language="JavaScript">	
			ShowMessage('No brokers were found using the criteria entered.');
