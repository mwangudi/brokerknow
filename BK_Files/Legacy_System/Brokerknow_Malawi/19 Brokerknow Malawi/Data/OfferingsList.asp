...
<%'======================= Begin_Alter_Across_Entities =================================%>
			...
			<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="SecurityCode:Code*0;ImportCode:Holdings Code*0;SecurityName:Name*0;SecurityMktPrice:Market Price*2;SecTransFeeFee:Transfer Fee*2;SecurityAddr:Address*0">
			<input type = 'hidden' name ='SortArgs' id="SortArgs" value="SecurityCode:Code;ImportCode:Holdings Code;SecurityName:Name;SecurityMktPrice:Market Price;SecTransFeeFee:Transfer Fee;SecurityAddr:Address">
			<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="SecurityCode:Code*0;ImportCode:Holdings Code*0;SecurityName:Name*0;SecurityMktPrice:Market Price*2;SecTransFeeFee:Transfer Fee*2;SecurityAddr:Address*0">
			<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:33em;width:30em">
