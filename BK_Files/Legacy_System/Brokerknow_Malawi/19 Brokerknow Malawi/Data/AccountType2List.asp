...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "AccountTypeLevel2"
		const DataEntity = "AccountType2"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("AccountType_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("AccountType_DPA_") & quote & ","  
			rowData = rowData & quote & rs.Fields("AccountTypeName") & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("Quarter1")) & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("Quarter2")) & quote & "," 
			rowData = rowData & quote & FormatNum(rs.Fields("Quarter3")) & quote & "," 
			rowData = rowData & quote & FormatNum(rs.Fields("Quarter4")) & quote 		 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("AccountType_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code","Account Type Name","Quarter1","Quarter2","Quarter3","Quarter4"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityTypeName:Entity Type*0;GenericDescription:Generic*0;GenericSettingDescription:Setting*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityTypeName:Entity Type;GenericDescription:Generic;GenericSettingDescription:Setting">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityTypeName:Entity Type*0;GenericDescription:Generic*0;GenericSettingDescription:Setting*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:15em;width:18em">
