...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "FullClientList"
		const ActionPage = "ClientList"
		const DataEntity = "Client"
...
'======================= End_Alter_Across_Entities =================================		
		...
		If sortQryStr <> "" Then
			...
			End	If
				...
				sqlStr = sqlStr & " ORDER BY client_dpa_ desc " 
		End If 
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-10 {width: 60px;}
					.active-column-10 {width: 90px;}
					.active-column-12 {width: 90px;}	
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & IIF(rs.Fields("IsCustodian")=true,"Y","N") & quote  & ","
			rowData = rowData & quote & rs.Fields("OwnerName") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentName") & quote & ","
			rowData = rowData & quote & rs.Fields("ClientContact") & quote & "," 
			rowData = rowData & quote & rs.Fields("ClientCellTel") & quote & "," 
			rowData = rowData & quote & rs.Fields("ClientEmail") & quote & "," 
			rowData = rowData & quote & rs.Fields("ClientOfficeTel") & quote & "," 
			rowData = rowData & quote & replace(rs.Fields("ClientAddr"),vbCrLf," ,") & quote & "," 
			rowData = rowData & quote & TimeChanged & quote 
			
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Client_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Mod","Code", "Name","Cust","Manager", "Agent", "Contact", "Cell", "Email", "Phone", 
			"Address", "Changed"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_: Code*2;ClientName: Name*0;OwnerName: Owner*0;ClientCDSNo: CDS No*0;ClientContact: Contact Name*0;AgentName: Agent*0;ClientOfficeTel: Office Phone*0;ClientCellTel: Cell Phone*0;ClientEmail: Email*0;ClientAddr: Address*0;IsCustodian: Custodian*2;ChangedBy: Last Modified By*0;TimeChanged: Time Modified*1">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_: Code;ClientName: Name;OwnerName: Owner;ClientCDSNo: CDS No;ClientContact: Contact Name;AgentName: Agent;ClientOfficeTel: Office Phone;ClientCellTel: Cell Phone;ClientEmail: Email;ClientAddr: Address;IsCustodian: Custodian;ChangedBy: Last Modified By;TimeChanged: Time Modified">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_: Code*2;ClientName: Name*0;OwnerName: Owner*0;ClientCDSNo: CDS No*0;ClientContact: Contact Name*0;AgentName: Agent*0;ClientOfficeTel: Office Phone*0;ClientCellTel: Cell Phone*0;ClientEmail: Email*0;ClientAddr: Address*0;IsCustodian: Custodian*2;ChangedBy: Last Modified By*0;TimeChanged: Time Modified*1">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:39em;width:40em">
