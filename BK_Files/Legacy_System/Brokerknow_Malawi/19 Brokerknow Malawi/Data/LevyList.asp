...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "LevyList"
		const DataEntity = "Levy"
		const DataEntityPlural = "Levies"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-4 {width: 120px;  text-align: center;}
					.active-column-5 {width: 100px;text-align: center;}	
					.active-column-6 {width: 100px;text-align: center;}	
					.active-column-7 {width: 100px;text-align: center;}	
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Levy_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("LevyDescription") & quote & "," 
			rowData = rowData & quote & rs.Fields("LevyAmount") & quote & "," 
			rowData = rowData & quote & rs.Fields("LevyType") & quote & "," 
			rowData = rowData & quote & rs.Fields("LevyBlock") & quote & "," 
			if (rs.Fields("LevyAppBond")) then 
				rowData = rowData & quote & "Yes" & quote & ","
			else 
				rowData = rowData & quote & "No" & quote & ","
			end if 
			...
			rowData = rowData & quote & iif(cbool(rs.Fields("Vatable")) =true,"Y","N") & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Levy_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Levy", "Amount", "Type", "Block", 
			"Apply To Bonds", "Apply To Security", "VAT"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="LevyDescription:Levy*0;LevyAmount:Amount*2;LevyType:Type*0;LevyBlock:Block*0;LevyAppBond:Apply To Bond*6;LevyAppSecurity:Apply To Security*6">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="LevyDescription:Levy;LevyAmount:Amount;LevyType:Type;LevyBlock:Block;LevyAppBond:Apply To Bond;LevyAppSecurity:Apply To Security">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="LevyDescription:Levy*0;LevyAmount:Amount*2;LevyType:Type*0;LevyBlock:Block*0;LevyAppBond:Apply To Bond*6;LevyAppSecurity:Apply To Security*6">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:31em;width:38em">
