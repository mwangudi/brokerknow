...
<body Class="Dialog" marginLeft=0 marginwidth=0 margintop=0 marginheight=0>
	<table cellspacing=0 cellpadding=0 style="left: 0;top: 0"><tr><td>
			<IFRAME FRAMEBORDER=0 marginwidth="0" marginheight="0" NAME="header" SCROLLING=yes SRC="AddRegisterOrders2.asp?ID=<%=ID%>&action=<%=action%>" height="570" width="780"></IFRAME>
	 </td></tr>
