...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "PathConfigurations"
		const DataEntity = "PathConfiguration"
		const DataEntityPlural = "PathConfigurations"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("DocumentID") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("DocumentName") & quote & ","
			rowData = rowData & quote & replace(rs.Fields("Path"),"\","\\") & quote & ","
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("DocumentID") & quote 
			rowCount = rowCount + 1
