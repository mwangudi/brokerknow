...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ResidencyList"
		const DataEntity = "Residency"
		const DataEntityPlural = "Residencies"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Residency_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("ResidencyName") & quote  
			
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Residency_DPA_") & quote 
			rowCount = rowCount + 1
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="ResidencyName:Residency*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="ResidencyName:Residency">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="ResidencyName:Residency*0">
