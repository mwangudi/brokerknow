...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "EmailConfigurations"
		const DataEntity = "EmailConfiguration"
		const DataEntityPlural = "EmailConfigurations"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("EmailID") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("Document") & quote & ","
			rowData = rowData & quote & rs.Fields("EmailTo") & quote & ","
			rowData = rowData & quote & rs.Fields("EmailCc") & quote & ","
			rowData = rowData & quote & rs.Fields("EmailBcc") & quote & ","
			rowData = rowData & quote & formatdatetime(rs.Fields("importTime"),vblongtime) & quote & ","
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("EmailID") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 5;
			var myColumns = ["Document", "EmailTo", "EmailCc", "EmailBcc", "Email Time"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Action:TimeLimitAction*0;Internal Limit:TimeLimitInternal*0;NSE Limit:TimeLimitNSE*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Action:TimeLimitAction;Internal Limit:TimeLimitInternal;NSE Limit:TimeLimitNSE">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Action:TimeLimitAction*0;Internal Limit:TimeLimitInternal*0;NSE Limit:TimeLimitNSE*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:17em;width:22em">	
