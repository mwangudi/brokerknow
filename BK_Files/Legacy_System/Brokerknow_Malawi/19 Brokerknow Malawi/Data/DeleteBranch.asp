...
<title>Delete Branch</title>
 ...
 function ItemSelected(itemID, itemText)
 		...
 		frmDeleteBranchList.elements("ID").value = itemID
 		frmDeleteBranchList.submit
 end function
 </script>
</head>
   ...
   Dim rs
	...
	if action = "EXECUTE" then
       ...
       ID = Request.Form("ID")
        ...
        sqlStr = "SELECT Child,DeletionMessage,ParentKey FROM [_Parent_Child_Links_] WHERE (Parent = 'Branch') AND (ChildType = " & LinkedIndependent & ")"
        ...
        If Not (rs.BOF Or rs.EOF) Then
                ...
                Do Until rs.EOF
                        ...
                        sqlStr = "SELECT TOP 1 * FROM [" & tableName & "] WHERE Branch_DPA_ = " & ID
        ...
        sqlStr = "DELETE FROM [BnkBranch] WHERE BnkBranch_DPA_ = " & ID
