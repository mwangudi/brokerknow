...
<%
	...
	if action = "EXECUTE" then
       ...
       ID = Request.Form("ID")
        ...
        sqlStr = "SELECT Child,DeletionMessage,ParentKey FROM [_Parent_Child_Links_] WHERE (Parent = 'Bond') AND (ChildType = " & LinkedIndependent & ")"
        ...
        sqlStr = "DELETE FROM [Bond] WHERE Bond_DPA_ = " & ID
