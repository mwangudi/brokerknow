...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "GenderList"
		const DataEntity = "Gender"
		const DataEntityPlural = "Gender"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Gender_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("GenderGender") & quote & "," 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Gender_DPA_") & quote 
			rowCount = rowCount + 1
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="GenderGender:Gender*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="GenderGender:Gender">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="GenderGender:Gender*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:9em;width:17em">	
