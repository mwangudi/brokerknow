...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "GenericSettingList"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("GenericSetting_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("EntityTypeName") & quote & ","  
			rowData = rowData & quote & rs.Fields("GenericDescription") & quote & ","
			rowData = rowData & quote & rs.Fields("GenericSettingDescription") & quote 			 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("GenericSetting_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Entity Type","Generic","Setting"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
