   ...
   Dim rs
	...
	if action = "EXECUTE" then
       ...
       ID = Request.Form("ID")
        ...
        sqlStr = "SELECT Child,DeletionMessage,ParentKey FROM [_Parent_Child_Links_] WHERE (Parent = 'Printers') AND (ChildType = " & LinkedIndependent & ")"
        ...
        If Not (rs.BOF Or rs.EOF) Then
                ...
                Do Until rs.EOF
                        ...
                        sqlStr = "SELECT TOP 1 * FROM [" & tableName & "] WHERE Printer_DPA_ = " & ID
        ...
        sqlStr = "DELETE FROM [Printers] WHERE Printer_DPA_ = " & ID
