...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "CPortfolioList"
		const DataEntity = "ClientPortFolio"
		const DataEntityPlural = "Client Portfolios"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-2 {width: 120px; text-align: right;}
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("CPortfolio_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("Client_DPA_") & quote & "," 
			rowData = rowData & quote & rs.Fields("CPortfolioClient") & quote & "," 
			rowData = rowData & quote & FormatNum(rs.Fields("CPortfolioPrice")) & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("CPortfolioQty")) & quote & "," 
			rowData = rowData & quote & rs.Fields("CPortfolioSecurity") & quote & ","
			rowData = rowData & quote & rs.Fields("Reference") & quote & ","    
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("CPortfolio_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 6;
			var colNames = ["Code","Client", "Price", "Quantity", "Security",""];
			
			var myColumns = ["Code","Client", "Price", "Quantity", "Security","Reference"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_:Client Code*0;CPortfolioClient:Client*0;CPortfolioPrice:Price*0;CPortfolioQty:Quantity*2;CPortfolioSecurity:Security*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_:Client Code;CPortfolioClient:Client;CPortfolioPrice:Price;CPortfolioQty:Quantity;CPortfolioSecurity:Security">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_:Client Code*0;CPortfolioClient:Client*0;CPortfolioPrice:Price*0;CPortfolioQty:Quantity*2;CPortfolioSecurity:Security*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:20em;width:35em">
