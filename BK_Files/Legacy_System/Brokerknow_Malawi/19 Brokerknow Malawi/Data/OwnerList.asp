...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "OwnerList"
		const DataEntity = "Owner"
		const DataEntityPlural = "Owners"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-4 {width: 60px; text-align: center;}
				</style>
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Owner_DPA_") & quote & " : " 
			...
			rowData = rowData & quote & rs.Fields("IdNo") & quote & ","
			rowData = rowData & quote & rs.Fields("MobileNo") & quote & ","
			rowData = rowData & quote & sendSMS & quote 
			
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Owner_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Account Manager","Commision","ID Number","Mobile Number", "Send SMS"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="OwnerName:Owner*0;IdNo:ID Number*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="OwnerName:Owner;IdNo:ID Number">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="OwnerName:Owner*0;IdNo:ID Number*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:20em;width:20em">
