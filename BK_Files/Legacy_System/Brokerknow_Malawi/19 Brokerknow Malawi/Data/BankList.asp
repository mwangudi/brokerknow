...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & rs.Fields("BankName") & quote & ","
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Bank Code", "Bank", "Branch"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="BankCode:Bank Code*0;BankName:Bank*0;BnkBranchName:Branch*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="BankCode:Bank Code;BankName:Bank;BnkBranchName:Branch">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="BankCode:Bank Code*0;BankName:Bank*0;BnkBranchName:Branch*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:16em;width:27em">	
