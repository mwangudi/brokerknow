...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "InstitutionList"
		const DataEntity = "Institution"
		const DataEntityPlural = "Institutions"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Institution_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("InstitutionName") & quote & "," 
			
			rowData = rowData & quote & rs.Fields("PhoneNumber") & quote & "," 
			rowData = rowData & quote & rs.Fields("Fax") & quote & "," 
			rowData = rowData & quote & rs.Fields("Address") & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Institution_DPA_") & quote 
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="InstitutionName:Name*0;PhoneNumber:Office Phone*0;Fax:Fax*0;Address:Address*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="InstitutionName:Name*0;PhoneNumber:Office Phone*0;Fax:Fax*0;Address:Address*0">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="InstitutionName:Name*0;PhoneNumber:Office Phone*0;Fax:Fax*0;Address:Address*0">
