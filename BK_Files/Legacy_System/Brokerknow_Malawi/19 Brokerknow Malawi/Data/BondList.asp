...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "BondListBond"
		const DataEntity = "Bond"
		const DataEntityPlural = "Bonds"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-1 {width: 230px;}
					.active-column-2 {width: 70px; text-align: right;}
					.active-column-3 {width: 75px; text-align: right;}	
					.active-column-4 {width: 230px;}		
				</style>
...
'======================= Begin_Alter_Across_Entities =================================
			...
			'rowData = rowData & quote & rs.Fields("OrderSecTypeDisplayName") & quote
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "Name", "Market Price", "Transfer Fee", 
				"Address"];
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='ActionPage' id = "ActionPage" value = "BondList.asp">

<%'======================= Begin_Alter_Across_Entities =================================%>
				
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="SecurityCode:Code*0;SecurityName:Name*0;SecurityMktPrice:Market Price*2;SecTransFeeFee:Transfer Fee*2;SecurityAddr:Address*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="SecurityCode:Code;SecurityName:Name;SecurityMktPrice:Market Price;SecTransFeeFee:Transfer Fee;SecurityAddr:Address">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="SecurityCode:Code*0;SecurityName:Name*0;SecurityMktPrice:Market Price*2;SecTransFeeFee:Transfer Fee*2;SecurityAddr:Address*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:24em;width:25em">
