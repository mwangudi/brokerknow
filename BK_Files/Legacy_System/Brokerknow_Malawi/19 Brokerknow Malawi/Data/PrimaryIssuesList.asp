...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "PrimaryIssuesList"
		...
		<LINK REL="STYLESHEET" Rate="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" Rate="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-9 {width: 90px; text-align: left;}
					.active-column-10 {width: 90px; text-align: left;}
					.active-column-11 {width: 90px; text-align: left;}
					.active-column-12 {width: 90px; text-align: left;}
					.active-column-13 {width: 90px; text-align: left;}
					.active-column-14 {width: 90px; text-align: left;}
					.active-column-15 {width: 90px; text-align: left;}
...
'======================= Begin_Alter_Across_Entities =================================
			...
			'row ID 
			rowData = rowData & quote & rs.Fields("PrimaryIssues_DPA_") & quote & " : " 
			...
			rowData = rowData & quote & formatnumber(rs.Fields("FaceValue"),2)  & quote & "," 
			rowData = rowData & quote & FormatNumEx(rs.Fields("Price"),4) & quote & ","
			rowData = rowData & quote & rs.Fields("ForwardRate") & quote & ","
			rowData = rowData & quote & rs.Fields("ApplicationNo") & quote & "," 
			rowData = rowData & quote & formatnumber(rs.Fields("AcceptedAmount"),2) & quote & "," 
			rowData = rowData & quote & rs.Fields("PaymentType") & quote & "," 
			rowData = rowData & quote & formatdate(rs.Fields("PaymentDate")) & quote & "," 
			rowData = rowData & quote & rs.Fields("Reference") & quote & "," 
			rowData = rowData & quote & formatnumber(rs.Fields("PaidAmount"),2) & quote & "," 
			rowData = rowData & quote & rs.Fields("Narrative") & quote & ","
			rowData = rowData & quote & rs.Fields("User") & quote & ","
			rowData = rowData & quote & ModifiedDate & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("PrimaryIssues_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "Client", "Bond Type", "Bond Issue", "Value Date","Face Value", "Price", "Forward Rate", "Appication No", "Accepted Amount", "Payment Type", "Payment Date","Reference","Paid Amount","Narrative", "Last Modified By", "Date Modified"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_:Code*2;ClientName:Client*0;BondType:Bond Type*0;BondIssue:Bond Issue*0;ValueDate:Value Date*1;FaceValue:Face Value;Price:Price;ForwardRate:Forward Rate;ApplicationNo:Application No*0;AcceptedAmount:Accepted Amount*2;PaymentType:Payment Type*0;PaymentDate:Payment Date*1;Reference:Reference*0;PaidAmount:Paid Amount*2;Narrative:Narrative*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_:Code;ClientName:Client;BondType:Bond Type;BondIssue:Bond Issue;ValueDate:Value Date;FaceValue:Face Value;Price:Price;ForwardRate:Forward Rate;ApplicationNo:Application No;AcceptedAmount:Accepted Amount;PaymentType:Payment Type;PaymentDate:Payment Date;Reference:Reference;PaidAmount:Paid Amount;Narrative:Narrative">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_:Code*2;ClientName:Client*0;BondType:Bond Type*0;BondIssue:Bond Issue*0;ValueDate:Value Date*1;FaceValue:Face Value;Price:Price;ForwardRate:Forward Rate;ApplicationNo:Application No*0;AcceptedAmount:Accepted Amount*2;PaymentType:Payment Type*0;PaymentDate:Payment Date*1;Reference:Reference*0;PaidAmount:Paid Amount*2;Narrative:Narrative*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:37em;width:33em">
