...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ClassList"
		const DataEntity = "ClientClass"
		const DataEntityPlural = "Client Types"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Class_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("ClassClass") & quote & "," 
			rowData = rowData & quote & rs.Fields("DefaultCommission") & quote & "," 
			rowData = rowData & quote & iif(rs.Fields("IsCda"),"Yes","No") & quote & "," 
			rowData = rowData & quote & iif(rs.Fields("AgentStatus"),"Yes","No") & quote & "," 			
			rowData = rowData & quote & rs.Fields("Voucher") & quote 			

			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Class_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Class", "Default Commission","CDA","Retunable Agent","Voucher"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="ClassClass:Class*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="ClassClass:Class*">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="ClassClass:Class**0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:20em;width:26em">
