...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "UndoAcceptProposalList"
		const DataEntity = "AcceptProposal"
		const DataEntityPlural = "AcceptProposals"
...
'======================= End_Alter_Across_Entities =================================		
		...
		sqlStr = "SELECT * FROM [" & DataSource & "] where Accepted=1"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-11 {width: 70px; text-align: right;}										
				</style>
										
</head>
	<body leftMargin=0 topMargin=0 marginheight="0" marginwidth="0"> 
	<form name='frm<%=ActionPage%>' method='post' id='frmMain' action='AcceptProposal.asp'>
			<!-- grid data -->
		<% 'row data
		Dim rowCount
		Dim orderHeld
...
'======================= Begin_Alter_Across_Entities =================================
			if rs.Fields("Accepted")=True then
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("ProposalDate") &  "' style=BorderLess  value='False' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Bond_DPA_") & ");'>"
			else
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("ProposalDate") &  "' style=BorderLess checked value='True' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Bond_DPA_") & ");'>"
			end if
			...
			rowData = rowData & quote & FormatNumEx(rs.Fields("Fave_Value"),2) & quote & "," 
			rowData = rowData & quote & FormatDate(rs.Fields("BondIDate")) & quote & "," 
			rowData = rowData & quote & FormatDate(rs.Fields("BondMDate")) & quote & "," 						
			rowData = rowData & quote & rs.Fields("Determination") & quote & "," 
			rowData = rowData & quote & rs.Fields("BondPayment") & quote & "," 
			rowData = rowData & quote & rs.Fields("BondRate") & quote & "" 			
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Accept","Client Code", "Client Name","Bond Code", "Bond Name", "Issue No","Face Value","Issue Date", "Maturity Date","Determination","Coupon Payment", "Coupon Rate"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_:Client Code*0;ClientName:Client Name*0;SecurityCode:Code*0;SecurityName:Name*0;BondIssue:Bond*0;BondIDate:Issue Date*1;BondMDate:Maturity Date*1;BondSDate:Settlement Date*1;BondLife:Life*0;BondPayment:Coupon Payment*0;BondRate:Coupon Rate*0">
