...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "OfferTypeList"
		const DataEntity = "OfferType"
		const DataEntityPlural = "Offer Types"
		const ActionFolder = "Data"
		const ActionPage = "OfferTypeList"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("OfferType_DPA_") & quote & " : " 
			...
			rowIDs = rowIDs & quote & rs.Fields("OfferType_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Offer ID", "Description"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="OfferType_DPA_:Offer ID*2;Description:Description*0;">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="OfferType_DPA_:Offer ID;Description:Description;">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="OfferType_DPA_:Offer ID*2;Description:Description*0;">
