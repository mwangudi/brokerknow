...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "BondTradesList"
		const DataEntity = "BondTrade"
		const DataEntityPlural = "BondTrades"
		...
		<LINK REL="STYLESHEET" Rate="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" Rate="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-2 {width: 45px; text-align: left;}
...
'======================= Begin_Alter_Across_Entities =================================
		...
		if isdate(rs.Fields("DateModified")) then
			...
			'row ID 
			rowData = rowData & quote & rs.Fields("BondTrades_DPA_") & quote & " : " 
			...
			rowIDs = rowIDs & quote & rs.Fields("BondTrades_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "Client", "Bond Type", "Bond Issue","Trade Type", "Trade Date", "Price", "Quantity", "Reference", "Last Modified By", "Date Modified"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_:Code;ClientName:Client;BondType:Bond Type;BondIssue:Bond Issue;TradeType:Trade Type;TradeDate:Trade Date;Price:Price;Quantity:Quantity;Reference:Reference">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_:Code;ClientName:Client;BondType:Bond Type;BondIssue:Bond Issue;TradeType:Trade Type;TradeDate:Trade Date;Price:Price;Quantity:Quantity;Reference:Reference">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_:Code;ClientName:Client;BondType:Bond Type;BondIssue:Bond Issue;TradeType:Trade Type;TradeDate:Trade Date;Price:Price;Quantity:Quantity;Reference:Reference">
