...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ShareList"
		const DataEntity = "Share"
		const DataEntityPlural = "Shares"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Share_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("Security") & quote & "," 
			rowData = rowData & quote & rs.Fields("Announcement") & quote & ","
			rowData = rowData & quote & rs.Fields("AnnouncementDate") & quote & ","
			rowData = rowData & quote & rs.Fields("SharePDate") & quote & "," 
			rowData = rowData & quote & rs.Fields("ShareClosing") & quote & "," 
			rowData = rowData & quote & rs.Fields("ShareYEnd") & quote
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Share_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Security", "Announcement", "Announcement Date", "Closing", "Payment", "Year End"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Security:Security*0;Announcement:Announcement*0;AnnouncementDate:Announcement Date*1;SharePDate:Payment*1;ShareClosing:Closing*1;ShareYEnd:Year End*1">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Security:Security;AnnouncementDate:Announcement Date;SharePDate:Closing;ShareClosing:Payment;ShareYEnd:Year End">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Security:Security*0;Announcement:Announcement*0;AnnouncementDate:Announcement Date*1;SharePDate:Payment*1;ShareClosing:Closing*1;ShareYEnd:Year End*1">
