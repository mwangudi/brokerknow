...
<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
 ...
 function ItemSelected(itemID)
 		frmEditOwnerList.elements("ID").value = itemID
 		frmEditOwnerList.submit
 end function
 </script>
</head>
		...
		<TABLE class="ListNuggetHeader" cellPadding="0" cellSpacing="0" width="100%" name="AdvSearchtestHeader"> 
			...
			<TD class="ListNuggetTitleCellWhite"
					...
					<A class=ListNuggetTitle onclick="return PartWrapperToggle('AdvSearchHead');"  
					 href="javascript:PartWrapperToggle('AdvSearchHead');">Edit Owner Information
					</A>
				</TD>
...
%>
<form name = 'frmEditOwnerList' method = 'post' action = 'EditOwner.asp' >
...
<%		Do Until rs.EOF%>
                <tr>
                        <td width="34%"><b><font color="#000080"><a href = 'vbScript:ItemSelected(<%=rs.Fields("Owner_DPA_")%>)'><%=rs.Fields("OwnerName")%></a></font></b></td>
                </tr>
                <%rs.MoveNext
        Loop
        conn.Close
