...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "MarketSectorList"
		const DataEntity = "MarketSector"
		const DataEntityPlural = "MarketSector"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Sector_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 			
			rowData = rowData & quote & rs.Fields("ShortDescription") & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Sector_DPA_") & quote 
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="ShortDescription:Short Description*0;">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="ShortDescription:Short Description*0;">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="ShortDescription:Short Description*0;">
