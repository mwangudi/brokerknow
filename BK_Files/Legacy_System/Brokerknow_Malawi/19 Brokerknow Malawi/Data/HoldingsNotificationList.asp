...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "SystemNotification"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			'row ID 
			rowData = rowData & quote & rs.Fields("SysConfig_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("Title") & quote & "," 
			rowData = rowData & quote & rs.Fields("Description") & quote & "," 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("SysConfig_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Title", "Description"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Title: Title*0; Description: Description*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Title: Title; Description: Description">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Title: Title*0; Description: Description*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:10em;width:25em">
