...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "MailConfigList"
		const DataEntity = "MailConfiguration"
		const DataEntityPlural = "MailConfiguration"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("MailConfig_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("SMTPServer") & quote & ","
			rowData = rowData & quote & rs.Fields("SMTPServerPort") & quote & ","
			rowData = rowData & quote & rs.Fields("SendUserName") & quote & ","
			rowData = rowData & quote & rs.Fields("SendDisplayName") & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("MailConfig_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 4;
			var colNames = ["Mail Server", "Port", "UserName", "Mail Address"];
			
			var myColumns = ["Mail Server", "Port", "UserName", "Mail Address"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Mail Server:SMTPServer*0;Port:SMTPServerPort*0;UserName:SendUserName*0;Mail Address:SendDisplayName*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Mail Server:SMTPServer;Port:SMTPServerPort;UserName:SendUserName;Mail Address:SendDisplayName">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Mail Server:SMTPServer*0;Port:SMTPServerPort*0;UserName:SendUserName*0;Mail Address:SendDisplayName*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:20em;width:28em">	
