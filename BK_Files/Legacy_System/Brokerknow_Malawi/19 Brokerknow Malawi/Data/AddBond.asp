	...
	if action = "EXECUTE" then
       ...
       secType =  1
        ...
        sqlStr = "INSERT INTO [Security] (SecurityAddr,SecurityCode,SecurityMktPrice,SecurityName" & _
                "       ,Security_DPA_,OrderSecType_DPA_,Immobilised,Security_EIT_) SELECT " & "'" & addr & "'" & " as SecurityAddr," & "'" & Code & "'" & " as SecurityCode" & _
...
<form name = 'frmAddSecurity' method = 'post' id="frmMain" action = "AddBond.asp" >
