...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "CompanyInfoList"
		const DataEntity = "CompanyInfo"
		const DataEntityPlural = "Company Information"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("SetupID") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("CompanyName") & quote & "," 
			rowData = rowData & quote & rs.Fields("Address") & quote & "," 
			rowData = rowData & quote & rs.Fields("Location") & quote & "," 
			rowData = rowData & quote & rs.Fields("PhoneNumber") & quote & ","
			rowData = rowData & quote & rs.Fields("FaxNumber") & quote
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("SetupID") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Company Name", "Address", "Location", "Phone", "Fax"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="CompanyName:Company Name*0;Address:Address*0;Location:Location*0;PhoneNumber:Phone*0;FaxNumber:Fax*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="CompanyName:Company Name;Address:Address;Location:Location;PhoneNumber:Phone;FaxNumber:Fax">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="CompanyName:Company Name*0;Address:Address*0;Location:Location*0;PhoneNumber:Phone*0;FaxNumber:Fax*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:33em;width:25em">
