		...
		if Trim(Ucase(buttonAction ))= "SAVE" then
			...
			'end if 
				...
				sqlStr = "INSERT INTO [Client] (ClientAddr,ClientBDate,ClientCellTel,ClientContact,ClientEmail " & _
						",ClientFax,ClientComment,Institution_DPA_,GenericSetting_DPA_2,GenericSetting_DPA_3,ClientPAddr" & _
						...
						"," & " " & institution & " " & " as Institution_DPA_" & _
...
<table border="0" width="60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td width="10%" nowrap valign="top">Institution</td>
