		...
		if Trim(Ucase(buttonAction ))= "SAVE" then
			...
			'end if 
				...
				sqlStr = "INSERT INTO [Client] (ClientAddr,ClientBDate,ClientCellTel,ClientContact,ClientEmail" & _
						...
						",ClientOpeningBal, Owner_DPA_,Residency_DPA_,Client_EIT_, CreditLimit, IsCustodian,updateOnDebt,updateOnContract,UseContactNameInPortfolioReports,ChangedBY) SELECT " & "'" & addr & "'" & " as ClientAddr," & "#" & FormatDate(bDate) & "#" & " as ClientBDate" & _
...
<form name = 'frmAddClient' method = 'post' action = 'AddClient.asp' id = "frmAddClient" target="_self">
