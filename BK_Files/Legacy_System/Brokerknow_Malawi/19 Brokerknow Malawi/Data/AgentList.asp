...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "AgentList"
		const DataEntity = "Agent"
		const DataEntityPlural = "Agents"
		const ActionFolder = "Data"
'======================= End_Alter_Across_Entities =================================		
		const filterForNONE = "AgentName <> '_none_'"
		Dim conn 
		Dim sqlStr
		Dim rs
		Dim bcolor
		...
		If filterStr = "" Then
				filterStr = filterForNONE
		end if
			
		If filterStr <> "" Then
				If InStr(1, filterStr, filterForNONE, vbTextCompare) = 0 Then
						filterStr = filterStr &  " AND (" & filterForNONE &  ")"
				End If
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Agent_DPA_") & quote & " : " 
			...
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("Agent_DPA_") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentName") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentContact") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentOfficeTel") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentCellTel") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentEmail") & quote & "," 
			rowData = rowData & quote & rs.Fields("AgentAddr") & quote & ","
			rowData = rowData & quote & rs.Fields("ChangedBy") & quote  & ","
			rowData = rowData & quote & TimeChanged & quote  									
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Agent_DPA_") & quote 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "Name", "Contact Name", "Office Phone", 
			"Cell Phone", "Email", "Address", "Last Modified", "Time Changed"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Agent_DPA_:Agent Code*0;AgentName:Name*0;AgentContact:Contact Name*0;AgentOfficeTel:Office Phone*0;AgentCellTel:Cell Phone*0;AgentEmail:Email*0;AgentAddr:Address*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Agent_DPA_:Agent Code;AgentName:Name;AgentContact:Contact Name;AgentOfficeTel:Office Phone;AgentCellTel:Cell Phone;AgentEmail:Email;AgentAddr:Address">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Agent_DPA_:Agent Code*0;AgentName:Name*0;AgentContact:Contact Name*0;AgentOfficeTel:Office Phone*0;AgentCellTel:Cell Phone*0;AgentEmail:Email*0;AgentAddr:Address*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:32em;width:45em">
