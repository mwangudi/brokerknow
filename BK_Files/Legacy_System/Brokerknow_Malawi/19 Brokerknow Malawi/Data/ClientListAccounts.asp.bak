...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "ClientListAccounts"
		const DataEntity = "Client"
		const DataEntityPlural = "ClientAccounts"
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = [ "CDS No", "Code","Name", "Owner","Agent","Contact Name", "Office Phone", 
			"Cell Phone", "Email","Address","Custodian","Last Modified By","Time Modified"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_:Client Code*0;ClientName:Name*0;OwnerName:Owner*0;ClientContact:Contact Name*0;ClientOfficeTel:Office Phone*0;ClientCellTel:Cell Phone*0;ClientEmail:Email*0;ClientAddr:Address*0;ClientOpeningBal:Opening Balance*2;AgentName:Agent Name*0;Agent_DPA_:Agent Code*1;ClientCDSNo:CDS No*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_:Client Code;ClientName:Name;OwnerName:Owner;ClientContact:Contact Name;ClientOfficeTel:Office Phone;ClientCellTel:Cell Phone;ClientEmail:Email;ClientAddr:Address">
