...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "TimeLimitList"
		const DataEntity = "TimeLimit"
		const DataEntityPlural = "TimeLimits"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("TimeLimit_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("TimeLimitAction") & quote & ","
			rowData = rowData & quote & rs.Fields("TimeLimitInternal") & quote & ","
			rowData = rowData & quote & rs.Fields("TimeLimitNSE") & quote
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("TimeLimit_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 3;
			var colNames = ["Action", "Internal Limit", "NSE Limit"];
			
			var myColumns = ["Action", "Internal Limit", "NSE Limit"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:15em;width:22em">	
