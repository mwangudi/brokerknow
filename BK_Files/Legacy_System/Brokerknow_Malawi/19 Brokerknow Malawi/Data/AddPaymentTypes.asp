...
<%
	...
	const DataSource = "AddPaymentTypes"
	...
	if action = "EXECUTE" then
		...
		if buttonAction = "SAVE" then
				...
				sqlStr = "INSERT INTO [PaymentTypes] (Description,Reference,PaymentTypes_DPA_)" & _
						" SELECT " & "'" & strDesc & "'" & " as Description" & _
						"       ," & "'" & Ref & "'" & " as Reference," & " " & "iif(isnull(max([PaymentTypes_DPA_])),(SELECT InitialID FROM _Initial_Table_ID_ WHERE TableName = 'PaymentTypes'),max([PaymentTypes_DPA_]) + 1)" & " " & " as PaymentTypes_DPA_" & _
						"        FROM [PaymentTypes]"
...
<table border="0" width="100%" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td width="40%"> Require Reference&nbsp; </td>
    <td width="60%">
