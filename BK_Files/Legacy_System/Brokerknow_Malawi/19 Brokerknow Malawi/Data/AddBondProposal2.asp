...
sqlStr1 =" INSERT INTO BondProposals (Proposal_DPA_, ProposalDate, SettlementDate,Security_DPA_, Client_DPA_, " &_
				...
				" VALUES("& MaxNo &",'"& FormatDate(cdate(ProposalDate)) &"','"& FormatDate(cdate(SettlementDate)) &"',"& BondType & ",'"& Client &"','"& IssueNo & "'," &_
				"'"& FormatDate(CDate(IssueDate)) &"','"& cdate(MaturityDate) &"','"& CouponPayments & "'," &_
				"'"& CouponRate &"','"& ForwardRate &"','" & BondCleanPrice1 & "'," & AccruedInterest1 & "," &_
				"" & BondDirtyPrice1 & ",'"& FormatDate(ValidityDate) &"','"& DaysInCouponPeriod &"', " &_
		...
		sqlStr = "INSERT INTO [BondProposals] Proposal_DPA_, ProposalDate, SettlementDate,Security_DPA_, Client_DPA_, " &_
				...
				" Convexity,Commission, CommissionRate, CounterParty,Salutation, Bond_DPA_,AlternatePrice,NetAmount) SELECT " & _
				         ...
				         "," & "#" &  FormatDate(cdate(ProposalDate))  & "#" & " as ProposalDate" &_
				         "," & "#" &  FormatDate(cdate(SettlementDate))  & "#" & " as SettlementDate" &_
				         "," & " " & BondType & " " & " as Security_DPA_" & _
				         "," & " " & Client & " " & " as Client_DPA_" & _
				         "," & " '" & IssueNo & " '" & " as BondIssue" & _
				         "," & "#" &  FormatDate(cdate(BondIDate))  & "#" & " as BondIDate" &_
				         "," & "#" &  FormatDate(cdate(MaturityDate))  & "#" & " as BondMDate" &_
						 ...
						 "," & "#" &  FormatDate(cdate(ValidityDate))  & "#" & " as Validity" &_
...
<form name="frmBondCalculator" method = 'post' action = 'AddBondProposal2.asp' id = "frmBondCalculator">
