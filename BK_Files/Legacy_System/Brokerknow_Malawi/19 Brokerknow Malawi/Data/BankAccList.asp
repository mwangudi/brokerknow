...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "BankAccList"
		const DataEntity = "BankAcc"
		const DataEntityPlural = "Bank Accounts"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("BankAcc_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("BankAccClient") & quote & "," 
			rowData = rowData & quote & rs.Fields("BankAccAccount") & quote & "," 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("BankAcc_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 2;
			var colNames = ["Client", "Account"];
			
			var myColumns = ["Client", "Account"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="BankAccClient:Client*0;BankAccAccount:Account*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="BankAccClient:Client;BankAccAccount:Account">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="BankAccClient:Client*0;BankAccAccount:Account*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:13em;width:22em">
