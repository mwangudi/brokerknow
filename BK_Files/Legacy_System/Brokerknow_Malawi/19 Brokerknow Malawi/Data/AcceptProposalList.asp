...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "AcceptProposalList"
...
'======================= Begin_Alter_Across_Entities =================================
			if Cint(rs.Fields("Accepted"))=0 then
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("ProposalDate") &  "' style=BorderLess  value='True' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Bond_DPA_") & ");'>"
			else
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("ProposalDate") &  "' style=BorderLess checked value='False' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Bond_DPA_") & ");'>"
			end if
			...
			rowData = rowData & quote & rs.Fields("CouponRate") & quote & "" 			
			rowData = rowData & "]" 
