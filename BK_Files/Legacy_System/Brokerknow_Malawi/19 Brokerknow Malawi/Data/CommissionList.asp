...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "CommissionList"
		const DataEntity = "Commission"
		const DataEntityPlural = "Commissions"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-1 {width: 100px; text-align: right;}
					.active-column-2 {width: 100px; text-align: right;}
					.active-column-3 {width: 110px; text-align: right;}
					.active-column-4 {width: 110px; text-align: right;}
					.active-column-5 {width: 110px; text-align: right;}
					.active-column-6 {width: 110px; text-align: right;}
					.active-column-7 {width: 110px; text-align: right;}
					.active-column-8 {width: 110px; text-align: right;}
					.active-column-9 {width: 110px; text-align: right;}
					.active-column-10 {width: 110px; text-align: right;}
					.active-column-11 {width: 110px; text-align: right;}
					.active-column-12 {width: 110px; text-align: right;}
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Commission_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("CommissionDescription") & quote & "," 
			rowData = rowData & quote & FormatPercent(rs.Fields("CommissionRate")/100,2) & quote & ","
			rowData = rowData & quote & FormatPercent(rs.Fields("BondCommission")/100,2) & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("MinimumSecurityCommission")) & quote & ","			
			rowData = rowData & quote & FormatNum(rs.Fields("MinimumBondCommission")) & quote & ","

			rowData = rowData & quote & FormatPercent(rs.Fields("MedianSecurityCommission")/100,2) & quote & ","
			rowData = rowData & quote & FormatPercent(rs.Fields("MedianBondCommission")/100,2) & quote & ","

			rowData = rowData & quote & FormatPercent(rs.Fields("UpperSecurityCommission")/100,2) & quote & ","
			rowData = rowData & quote & FormatPercent(rs.Fields("UpperBondCommission")/100,2) & quote & ","

			rowData = rowData & quote & FormatNumEx(rs.Fields("SecurityBoundary"),0) & quote & ","
			rowData = rowData & quote & FormatNumEx(rs.Fields("SecondSecurityBoundary"),0) & quote & ","

			rowData = rowData & quote & FormatNumEx(rs.Fields("BondBoundary"),0) & quote & ","
			rowData = rowData & quote & FormatNumEx(rs.Fields("SecondBondBoundary"),0) & quote & ","
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Commission_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Description", "Upper Security Rate", " Upper Bond Rate","Min. Amount (Sec.)","Min. Amount (Bond)","Middle Volume Rate (Sec.)","Middle Volume Rate (Bond)","Lower Volume Rate (Sec.)","Lower Volume Rate (Bond)","First Vol. Boundary (Sec.)","Second Vol. Boundary (Sec.)","First Vol. Boundary (Bond)","Second Vol. Boundary (Bond)"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="CommissionDescription:Description*0;CommissionRate:Rate*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="CommissionDescription:Description;CommissionRate:Rate">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="CommissionDescription:Description*0;CommissionRate:Rate*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:28em;width:28em">
