...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 1;
			var colNames = ["Bank Branch"];
			
			var myColumns = ["Bank Branch"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="BnkBranchName:Bank Branch*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="BnkBranchName:Bank">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="BnkBranchName:Bank Branch*0">
