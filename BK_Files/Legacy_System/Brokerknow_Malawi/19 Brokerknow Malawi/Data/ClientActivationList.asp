...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "ClientActivationList"
...
'======================= End_Alter_Across_Entities =================================			
		...
		If filterStr <> "" Then
			filterStr = filterStr & ", OnlineRegistration = 1"  & " AND ClientCDSNo IS Null"
		Else
			filterStr = " OnlineRegistration = 1" & " AND ClientCDSNo IS Null"
		End If
...
<html>
	...
	<form name='frm<%=DataSource%>' method='post' id='frmMain' action='ActivateClient.asp'>
			<!-- grid data -->
		<% 'row data
		Dim rowCount
		quote = chr(34) 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Name", "Owner", "CDS No", "Contact Name", "Office Phone", 
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.setAction("dblclick", RowEditFn); //uncomment to enable in-place edit
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="ClientName:Name*0;OwnerName:Owner*0;ClientContact:Contact Name*0;ClientOfficeTel:Office Phone*0;ClientCellTel:Cell Phone*0;ClientEmail:Email*0;ClientAddr:Address*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="ClientName:Name;OwnerName:Owner;ClientContact:Contact Name;ClientOfficeTel:Office Phone;ClientCellTel:Cell Phone;ClientEmail:Email;ClientAddr:Address">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="ClientName:Name*0;OwnerName:Owner*0;ClientContact:Contact Name*0;ClientOfficeTel:Office Phone*0;ClientCellTel:Cell Phone*0;ClientEmail:Email*0;ClientAddr:Address*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:35em;width:40em">
