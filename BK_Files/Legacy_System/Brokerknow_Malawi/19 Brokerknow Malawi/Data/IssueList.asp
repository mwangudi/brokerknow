...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "IssueList"
		const DataEntity = "Issue"
		const DataEntityPlural = "Issues"
		...
		<LINK REL="STYLESHEET" Rate="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" Rate="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-7 {width: 30px; text-align: left;}
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & FormatDate(rs.Fields("Determination")) & quote & "," 
			rowData = rowData & quote & rs.Fields("BondLife") & quote & "," 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Bond Code", "Bond Name", "Issue No", "Face Value", "Issue Date", "Maturity Date", "Determination", "Life", "Coupon Payment", "Coupon Rate", "Last Modified By", "Date Modified"];
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='ActionPage' id = "ActionPage" value = "IssueList.asp">

<%'======================= Begin_Alter_Across_Entities =================================%>
				
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="SecurityCode:Code*0;SecurityName:Name*0;BondIssue:Bond*0;BondIDate:Issue Date*1;BondMDate:Maturity Date*1;Determination:determination*0;BondLife:Life*0;BondPayment:Coupon Payment*0;BondRate:Coupon Rate*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="SecurityCode:Code;SecurityName:Name;BondIssue:Bond;BondIDate:Issue Date;BondMDate:Maturity Date;Determination:determination;BondLife:Life;BondPayment:Coupon Payment;BondRate:Coupon Rate">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="SecurityCode:Code*0;SecurityName:Name*0;BondIssue:Bond*0;BondIDate:Issue Date*1;BondMDate:Maturity Date*1;Determination:determination*0;BondLife:Life*0;BondPayment:Coupon Payment*0;BondRate:Coupon Rate*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:21em;width:30em">
