...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "OrderTypeList"
		const DataEntity = "OrderType"
		const DataEntityPlural = "Order Types"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("OrderType_DPA_") & quote & " : " 
			...
			rowData = rowData & quote & rs.Fields("handlingfee") & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("OrderType_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Description", "Sale","Handling Fee"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="OrderTypeName:Description*0;OrderTypeSale:Sale*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="OrderTypeName:Description;OrderTypeSale:Sale">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="OrderTypeName:Description*0;OrderTypeSale:Sale*0">
