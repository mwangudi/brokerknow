...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "PrinterList"
		const DataEntity = "Printer"
		const DataEntityPlural = "Printers"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Printer_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("PrinterActualName") & quote & ","
			rowData = rowData & quote & rs.Fields("PrinterName") & quote & ","
			rowData = rowData & quote & rs.Fields("Description") & quote
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Printer_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 3;
			var colNames = ["Name", "Friendly Name", "Description"];
			
			var myColumns = ["Name", "Friendly Name", "Description"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Name:PrinterActualName*0;Friendly Name:PrinterName*0;Description:Description*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Name:PrinterActualName;Friendly Name:PrinterName;Description:Description">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Name:PrinterActualName*0;Friendly Name:PrinterName*0;Description:Description*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:15em;width:20em">	
