...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "HolidayList"
		const DataEntity = "Holiday"
		const DataEntityPlural = "Holidays"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Holiday_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("Holiday") & quote & ","
			rowData = rowData & quote & rs.Fields("Description") & quote & ","
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Holiday_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Holiday", "Description"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Holiday:Holiday*0;Description:Description*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Holiday:Holiday;Description:Description">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Holiday:Holiday*0;Description:Description*0">
