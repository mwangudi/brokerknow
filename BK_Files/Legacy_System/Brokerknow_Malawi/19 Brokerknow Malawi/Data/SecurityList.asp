...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "SecurityListSecurity"
		const DataEntity = "Security"
		const DataEntityPlural = "Securities"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			'rowData = rowData & quote & iif(rs.Fields("isonCSD"),"Y","N") & quote & "," 
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "Name", "Market Sector", "Market Price", "Address"];
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='ActionPage' id = "ActionPage" value = "SecurityList.asp">

<%'======================= Begin_Alter_Across_Entities =================================%>
				
			<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="SecurityCode:Code*0;ImportCode:Holdings Code*0;SecurityName:Name*0;SecurityMktPrice:Market Price*2;SecTransFeeFee:Transfer Fee*2;SecurityAddr:Address*0;ExpiryDate: Expiry Date*6">
			<input type = 'hidden' name ='SortArgs' id="SortArgs" value="SecurityCode:Code;ImportCode:Holdings Code;SecurityName:Name;SecurityMktPrice:Market Price;SecTransFeeFee:Transfer Fee;SecurityAddr:Address;ExpiryDate: Expiry Date">
			<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="SecurityCode:Code*0;ImportCode:Holdings Code*0;SecurityName:Name*0;SecurityMktPrice:Market Price*2;SecTransFeeFee:Transfer Fee*2;SecurityAddr:Address*0;ExpiryDate: Expiry Date*6">
			<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:35em;width:25em">
