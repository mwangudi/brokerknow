...
'======================= Begin_Alter_Across_Entities =================================
			...
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("AccountTypeParent") & quote & ","  
			rowData = rowData & quote & rs.Fields("AccountTypeLevel") & quote & ","
			rowData = rowData & quote & rs.Fields("AccountTypeSetting") & quote 			 
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Parent Type","Level","Setting"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:18em;width:20em">
