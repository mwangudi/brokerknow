...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "BatchedForwards"
		const DataEntity = "BatchedForward"
		const DataEntityPlural = "BatchedForwards"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & rs.Fields("TotalNo") & quote & "," 
			rowData = rowData & quote & FormatNumCommasOnly(rs.Fields("TotalQty")) & quote & "," 
			rowData = rowData & quote & formatnum(rs.Fields("TotalAmt")) & quote & ","
			rowData = rowData & quote & Downloaded & quote 
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Batch No","Offering","Total applications","Total Shares","Total Amount", "Downloaded"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Batch_No:Batch No*0;Totalno:Total Applications*0;SecurityName:Offerings*0;TotalQty: Total Shares*0;TotalAmt: Total Amount*2;Downloaded: Downloaded*6;">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Batch_No:Batch No;Totalno:Total Applications;SecurityName:Offerings;TotalQty: Total Shares;TotalAmt: Total Amount;Downloaded: Downloaded;">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Batch_No:Batch No*0;Totalno:Total Applications*0;SecurityName:Offerings*0;TotalQty: Total Shares*0;TotalAmt: Total Amount*2;Downloaded: Downloaded*6;">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:18em;width:42em">
