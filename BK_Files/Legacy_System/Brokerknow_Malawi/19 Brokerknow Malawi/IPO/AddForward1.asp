...
END IF
	...
	conn.BeginTrans		
			sqlStr = "INSERT INTO Offerings (PAL_No,Client_DPA_, " & _
				"Offering,Offering_Price,Alloted_Rights,ChangedBy,AcceptanceType,Additional,Batch_No,Forward,OfferCheque,OfferBank,DateCreated,CreatedBy) " & _
				" VALUES ('" & palno & "'," & ClientName & "," & offering & "," & Price & "," & AlRights & "," & UserId & "," & Accept & "," & AddNew & "," & BatchNo & ",1,'" & chkno & "','" & narrative & "',GetDate(),"& UserID &")"
...
<form name = 'frmAddSecurity' method = 'post' id="frmMain" action = "AddForward.asp" >
	<table border="0" width="80%" cellpadding=2 cellspacing=2>
		...
		<tr>
			<td width="20%">Bank</td>
			<td width="80%"><textarea name ='txtNarrative' id = 'txtNarrative' cols="50" rows="5"></textarea></td>   	
		</tr>
