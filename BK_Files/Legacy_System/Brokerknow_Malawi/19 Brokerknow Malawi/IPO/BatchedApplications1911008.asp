...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataEntity = "BatchedApplication"
		const DataEntityPlural = "BatchedApplications"
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Batch_No:Batch No*0;Totalno:Total Applications*0;SecurityName:Offering*0;TotalQty: Total Shares*0;TotalAmt: Total Amount*2;Downloaded: Downloaded*6;">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Batch_No:Batch No;Totalno:Total Applications;SecurityName:Offering;TotalQty: Total Shares;TotalAmt: Total Amount;Downloaded: Downloaded;">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Batch_No:Batch No*0;Totalno:Total Applications*0;SecurityName:Offering*0;TotalQty: Total Shares*0;TotalAmt: Total Amount*2;Downloaded: Downloaded*6;">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:28em;width:42em">
