...
If genReport <> "1" Or selectedBatch = ""  Then%>
	...
	<form method="POST" action="BatchedForwardsReport.asp" Name="frmMain" id="frmMain">
...
<table align=center border="0" cellspacing="0" cellpadding="5" width="90%">
	<tr>
		<td width="100%" colspan=5 nowrap align="left">BATCHED FORWARDS</td>      
	</tr>
	<tr>
		<td width="100%" colspan=5 nowrap height="0" align="LEFT" style="border-top:3 solid black;font-size: 11pt;"><b>EVEREADY IPO BATCH CONTROL SCHEDULE</b></td>      
	</tr>
	<tr>
			...
			<table border="0" cellspacing="0" cellpadding="5" width="100%">
				...
				do until Rs.eof
						...
						<tr>
							...
							<td width="10%" style="border:1 solid black;" nowrap align="center"><%If IsNull(RS("OfferCheque")) Then Response.Write("-") Else Response.write(Mid(RS("OfferCheque"),1,30))%></td>
						</tr>
						<%
	...
	<tr>
		<td width="100%" colspan=5 nowrap align="left">NOTE: To be completed in triplicate.</td>      
	</tr>
</table>
