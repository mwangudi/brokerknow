...
<%
	...
	If Rs("SecurityCode") = "EVEREADY" Then
		Response.Redirect "BatchedApplications_Eveready.asp?Offering="& Offering &"&genReport=1&cboBatch=" & selectedBatch
	End If
	
	If (Rs("SecurityCode") = "DTKR") Or (Rs("SecurityCode") = "DTKR1") Or (Rs("SecurityCode") = "DTKR2") Then
		Response.Redirect "BatchedApplications_DTKR.asp?Offering="& Offering &"&genReport=1&cboBatch=" & selectedBatch
	End If
