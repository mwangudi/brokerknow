...
If Len(selectedFrom) > 0 And Len(selectedTo) > 0 Then
	sqlStr = "SELECT * FROM OfferingList " & _
	" WHERE (Batch_No BETWEEN "& selectedFrom &" AND "& selectedTo &") AND (Offering = "& offering &")"
Else
	sqlStr = "SELECT * FROM OfferingList where (Batch_No = "& selectedFrom &") AND (Offering = "& offering &") AND (Deleted = 0)"
End If
...
If len(Request.QueryString) > 0 Then
	...
	<table border="0" cellspacing="2" cellpadding="3" style="font-family: Arial Narrow" width="100%">
		<tr>
		 <table border ="0" width ="100%">
		   <tr>
			<td><font face="Impact" size="3"nowrap>BATCHED APPLICATIONS</font></td>
	...
	<table border="0" cellspacing="0" cellpadding="3" style="font-family: Arial Narrow" width="100%">
	    <tr>
	      ...
	      <td style="border-left:1px solid black;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black" width="30%"><%=UCase(Session("CompanyName"))%></td>
		  <td width="15%">&nbsp;</td>
		  <td style="border-left:1px solid black;border-top:1px solid black;border-bottom:1px solid black" width="15%"><B>AGENT&nbsp;CODE</B></td>
	      <td style="border-left:1px solid black;border-top:1px solid black;border-bottom:1px solid black;border-right:1px solid black" width="25"><%="B" & Session("BrokerCode")%></td>
	   </tr>
	   <tr>
		  <td width="5%">&nbsp;</td>
	      <td style="border-left: 1px solid black; border-bottom: 1px solid black" width="10%"><B>DATE</B></td>
	      <td style="border-left: 1px solid black; border-bottom: 1px solid black;border-right:1px solid black" width="30%"><%=FormatDate(Now())%></td>
		  <td width="15%">&nbsp;</td>
		  <td style="border-left: 1px solid black; border-bottom: 1px solid black" width="15%"><B>SCHEDULE&nbsp;NO:</B></td>
	      <td style="border-left: 1px solid black; border-bottom: 1px solid black;border-right:1px solid black" width="25%"><%=Session("BrokerCode") & Right("000000" & selectedFrom,6)%></td>
	   </tr>
	...
	<table border="0" cellspacing="0" cellpadding="3"  style="font-family: Arial Narrow" width="100%">
		 <tr>
		   ...
		   <td style="border-right: 1px solid black;border-top: 1px solid black" width="30%"><B>NAME&nbsp;OF&nbsp;APPLICANT</B></td>
		   <td style="border-right: 1px solid black;border-top: 1px solid black" width=""><B>ID/PASSPORT NO.&nbsp;OF&nbsp;APPLICANT</B></td>
		   <td style="border-right: 1px solid black;border-top: 1px solid black" width="15%"><B>NO.&nbsp;OF&nbsp;SHARES</B></td>
		   <td style="border-right: 1px solid black;border-top: 1px solid black" width="15%"><B>AMOUNT&nbsp;PAYABLE</B></td>
		   <!--td style="border-right: 1px solid black;border-top: 1px solid black" width="25%"><B>CHEQUE&nbsp;NUMBER</B></td-->
		</tr>
		<%
		totalquantity=0
		totalpayable=0
		...
		If Not(Rs.EOF Or Rs.BOF) Then
		   ...
		   If selectedBrokerCode ="1" Then
			colSpans=2
		   %>
				 <td style="border-right: 1px solid black;border-top: 1px solid black" width="10%"><B><%=Rs("Client_DPA_")%></B></td>
		   <%
		   End if
		   %>
					<td nowrap style="border-right: 1px solid black;border-top: 1px solid black" width="10%"><%=Rs("AgentCode") & " - " & Rs("Pal_No")%></td>
					<td style="border-right: 1px solid black;border-top: 1px solid black" width="30%"><%=RS("ClientName")%></td>
					<td style="border-right: 1px solid black;border-top: 1px solid black" width="12%" align="left"><%=Rs("ClientIDPass")%>&nbsp;</td>
					<td style="border-right: 1px solid black;border-top: 1px solid black" width="15%" align="right"><%=FormatNumEx(Rs("Alloted_Rights"),0)%>&nbsp;</td>
					<td style="border-right: 1px solid black;border-top: 1px solid black" width="15%" align="right"><%=FormatNum(Rs("Alloted_Rights")*Rs("Offering_Price"))%>&nbsp;</td>
					<td style="border-right: 1px solid black;border-top: 1px solid black" width="25%" align="left">&nbsp;</td>
				</tr>
				<%
		...
		<tr>
			...
			<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" width="10%">&nbsp</td>
			<td colspan = <% = colSpan%> style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" width="30%"><b>TOTALS</b></td>
			...
			<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" align="right" width="15%"><b><%=FormatNum(totalpayable)%></b>&nbsp;</td>
			<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" align="right" width="25%">&nbsp;</td>
		</tr>
	</table>
	<BR>
	<table border="0" cellspacing="0" cellpadding="3"  style="font-family: Arial Narrow" width="100%">
	<tr>
		<td width="5%">&nbsp;</td>
		<td colspan="2" style="border-style: solid; border-width: 1px; border-color: black" width="40%"><B>SIGNATURE OF AGENT</B></td>
		<td width="15%">&nbsp;</td>
		<td colspan="2" style="border-style: solid; border-width: 1px; border-color: black" width="40%"><B>STAMP OF AGENT</B></td>
	</tr>
	<tr>
		<td width="5%">&nbsp;</td>
		<td colspan="2" style="border-left-style: solid; border-left-width: 1; border-left-color: black; border-right-style: solid; border-right-width: 1; border-right-color: black" width="40%">&nbsp;</td>
		<td width="15%">&nbsp;</td>
		<td colspan="2" style="border-left-style: solid; border-left-width: 1; border-left-color: black; border-right-style: solid; border-right-width: 1; border-right-color: black" width="40%">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="5%">&nbsp;</td>
		<td colspan="2" style="border-left-style: solid; border-left-width: 1; border-left-color: black; border-right-style: solid; border-right-width: 1; border-right-color: black; border-bottom-style: solid; border-bottom-width: 1; border-bottom-color: black" width="40%">&nbsp;</td>
		<td width="15%">&nbsp;</td>
		<td colspan="2" style="border-left-style: solid; border-left-width: 1; border-left-color: black; border-right-style: solid; border-right-width: 1; border-right-color: black; border-bottom-style: solid; border-bottom-width: 1; border-bottom-color: black" width="40%">&nbsp;</td>
	</tr>
	</table>
	...
	<tr>
		<td width="5%">&nbsp;</td>
		<td colspan="2" style="border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="40%"><B>FOR OFFICIAL USE ONLY</B></td>
		<td width="15%">&nbsp;</td>
		<td colspan="2" style="border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="40%"><B>PAYMENT MODE(TICK ONE ONLY)</B></td>
	</tr>
	<tr>
		<td width="5%">&nbsp</td>
		...
		<td style="border-right: 1px solid black;border-bottom: 1px solid black" width="30%">&nbsp;</td>
		<td align="right" width="15%">&nbsp;</td>
		<td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="15%"><B>DVP</B></td>
	...
	<tr>
		...
		<td style="border-right: 1px solid black;border-bottom: 1px solid black" width="30%">&nbsp;</td>
		<td align="right" width="15%">&nbsp;</td>
		<td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="15%"><B>Global Payment</B></td>
	...
	<tr>
		...
		<td style="border-right: 1px solid black;border-bottom: 1px solid black" width="30%"><%=Session("BrokerCode") & Right("000000" & selectedFrom,6)%></td>
		<td align="right" width="15%">&nbsp;</td>
		<td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="15%"><B>EFT</B></td>
...
<%Else
	...
	For i = selectedFrom To selectedTo
		...
		sqlStr = "SELECT * FROM OfferingList where (Batch_No = "& i &") AND (Offering = "& offering &") and (Deleted = 0)"
		set Rs = conn.execute(sqlStr)
		If Not(Rs.EOF Or Rs.BOF) Then
			'paymentMode = Trim(Rs("BatchPaymentMode"))%>
			<table border="0" cellspacing="2" cellpadding="3" style="font-family: Arial Narrow" width="100%">
			...
			<table border="0" cellspacing="0" cellpadding="3" style="font-family: Arial Narrow" width="100%">
			   ...
			   <tr>
				  ...
				  <td width="15%">&nbsp;</td>
				  <td style="border-left: 1px solid black; border-bottom: 1px solid black" width="15%"><B>SCHEDULE&nbsp;NO:</B></td>
			      <td style="border-left: 1px solid black; border-bottom: 1px solid black;border-right:1px solid black" width="25%"><%=Session("BrokerCode") & Right("000000" & i,6)%></td>
			   </tr>
			</table>
			<BR>
			<table border="0" cellspacing="0" cellpadding="3"  style="font-family: Arial Narrow" width="100%">
		   ...
		   %>
						...
						<td style="border-right: 1px solid black;border-top: 1px solid black" width="30%"><%=RS("ClientName")%></td>
						<td style="border-right: 1px solid black;border-top: 1px solid black"  align="left"><%=Rs("ClientIDPass")%>&nbsp;</td>
						<td style="border-right: 1px solid black;border-top: 1px solid black" width="15%" align="right"><%=FormatNumEx(Rs("Alloted_Rights"),0)%>&nbsp;</td>
						<td style="border-right: 1px solid black;border-top: 1px solid black" width="15%" align="right"><%=FormatNum(Rs("Alloted_Rights")*Rs("Offering_Price"))%>&nbsp;</td>
						<!--td style="border-right: 1px solid black;border-top: 1px solid black" width="25%" align="left">&nbsp;</td-->
					</tr>
				...
				<tr>
					<td style="border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="5%">&nbsp</td>
					<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" width="">&nbsp</td>
					<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" width="10%">&nbsp</td>
					<td colspan = <%=colSpan%> style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" width=""><b>TOTALS</b></td>
					<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" align="right" width="15%"><b><%=FormatNumEx(totalquantity,0)%></b>&nbsp;</td>
					<td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" align="right" width="15%"><b><%=FormatNum(totalpayable)%></b>&nbsp;</td>
					<!--td style="border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black" align="right" width="25%">&nbsp;</td-->
				</tr>
			...
			<tr>
				<td width="5%">&nbsp</td>
				<td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="10%"><B>Batch No:</B></td>
				<td style="border-right: 1px solid black;border-bottom: 1px solid black" width="30%"><%=Session("BrokerCode") & Right("000000" & i,6)%></td>
				<td align="right" width="15%">&nbsp;</td>
				<td style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" width="15%"><B>EFT</B></td>
				<% if cint(paymentMode) = 2 then 'EFT %>
					<td style="border-right: 1px solid black;border-bottom: 1px solid black" width="25%"><input type="checkbox" name="chkPayment" id="chkPayment" style="border-style: none; color: white; background-color: white" disabled="true" checked></td>
