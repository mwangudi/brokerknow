...
<%
	...
	if action = "EXECUTE" then
			...
			'save data
		     ...
		     Set conn = GetActiveConnection("KBroker")
				 ...
				 sqlStr="Update client set updateOnDebt ="& smsDebit &",ClientCellTel='"& trim(cellNo) &"' where client_DPA_= " & client
	...
	Set conn = GetActiveConnection("KBroker")
	sqlStr="select * from smsDebtors where client_DPA_ =" & ID
...
<body Class="Dialog">
<form name = 'frmMain' method = 'post' action = 'EditSmsDebtors.asp' id = "frmMain" >
<table border="0" width="100%" cellspacing="1" cellpadding="1">
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="54%">
    <input type="checkbox" name="smsDebit" id="smsDebit" value="1"<% if rs("updateOnDebt")=true then response.write "checked"%> ></td>
  </tr>
  <tr>
