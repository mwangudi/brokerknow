...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "FullEntityTypeList"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("EntityType_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("EntityTypeName") & quote & ","  
			rowData = rowData & quote & rs.Fields("EntityTypeCode") & quote & ","
			rowData = rowData & quote & rs.Fields("EntityTypeAccountType") & quote 			 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("EntityType_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Entity Type Name","Entity Type Code","Account Type"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='ActionPage' id = "ActionPage" value = "EntityTypeList.asp">

<%'======================= Begin_Alter_Across_Entities =================================%>
				
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityTypeName:Name*0;EntityTypeAccountType:Account Type*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityTypeName:Name;EntityTypeAccountType:Account Type">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityTypeName:Name*0;EntityTypeAccountType:Account Type*0">
