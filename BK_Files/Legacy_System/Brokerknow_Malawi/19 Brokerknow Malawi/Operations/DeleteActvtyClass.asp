...
<title>Delete Activity Type</title>
   ...
   Dim rs
	...
	if action = "EXECUTE" then
       ...
       ID = Request.Form("ID")
        ...
        sqlStr = "SELECT Child,DeletionMessage,ParentKey FROM [_Parent_Child_Links_] WHERE (Parent = 'ActvtyClass') AND (ChildType = " & LinkedIndependent & ")"
        ...
        If Not (rs.BOF Or rs.EOF) Then
                ...
                Do Until rs.EOF
                        ...
                        sqlStr = "SELECT TOP 1 * FROM [" & tableName & "] WHERE ActvtyClass_DPA_ = " & ID
        ...
        sqlStr = "DELETE FROM [ActvtyClass] WHERE ActvtyClass_DPA_ = " & ID
