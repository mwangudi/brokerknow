		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-9 {width:50px; text-align: center;}	
					.active-column-10 {width: 100px;}
					.active-column-11 {width: 200px;}	
					.active-column-12 {width: 30px;}
					.active-column-13 {width: 60px;}	
					.active-column-14 {width: 80px; text-align: right;}			
					.active-column-15 {width: 75px; text-align: left;}	
					.active-column-16 {width: 120px; }			
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Date",  "Type","Order","Security", "Price", "Limit", "Quantity","Amount",  
			"Reference","Code", "Client","Hold","Inter Bank","Balance","Date Released","Last Modified By","Time Modified"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
