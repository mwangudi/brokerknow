...
<%
	...
	if action = "EXECUTE" then
			...
			'save data
		     ...
		     Set conn = GetActiveConnection("KBroker")
				 ...
				 sqlStr="Update client set updateOnContract ="& smsDebit &",ClientCellTel='"& trim(cellNo) &"' where client_DPA_= " & client
	...
	sqlStr="select * from smsContract where client_DPA_ =" & client
	...
	if rs.eof or rs.bof then
		...
		<!--
				window.alert('There are no records to edit!!');
				window.close();
		//-->
		</SCRIPT>
		<%
...
<body Class="Dialog">
<form name = 'frmMain' method = 'post' action = 'EditsmsContract.asp' id = "frmMain" >
<table border="0" width="100%" cellspacing="1" cellpadding="1">
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="54%">
    <input type="text" name="code" id="code" value="<%=rs.fields("Contract_DPA_")%>" size="20" class="readonly" readonly></td>
  </tr>
     <tr>
    <td width="15%">Cell No.</td>
    <td width="54%">
    <input type="text" name="cellNo" id="cellNo" value="<%=rs.fields("ClientCellTel")%>" size="20"></td>
  </tr>
  <tr>
    <td width="15%">Sms Cotnract</td>
    <td width="54%">
    <input type="checkbox" name="smsDebit" id="smsDebit" value="1"<% if rs("updateOnContract")=true then response.write "checked"%> ></td>
  </tr>
  <tr>
