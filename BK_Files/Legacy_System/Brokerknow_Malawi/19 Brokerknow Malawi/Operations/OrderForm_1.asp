...
set Rs = conn.execute("SELECT top 4 * FROM OrderForm WHERE (Order_DPA_ = " & OrderID & ")")
...
<body>
<%
DrawPageFunctions2 true, true, true, "EditOrder.asp?ID=" & OrderID
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
	<tr>
		<td width="66%" colspan="2" height="85" valign="center">&nbsp;</td>
	</tr>
	<tr>
		<td width="66%" colspan="2" height="15" valign="center"><b><font face="Arial" size="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=Rs("OrderTypeDescription") & "&nbsp;" & Rs("Order_DPA_")%> </font></b></td>
	</tr>
	<tr>
		<td width="66%" colspan="3" height="8">&nbsp;</td>
	</tr>
	<%
	theMinute = Minute(Time())
	if Len(theMinute) = 1 then theMinute = "0" & Minute(Time())
	%>
	<tr>
		<td width="17%" height="15" nowrap valign="bottom"><font face="Arial"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<%=FormatDate(Date)%></b></font></td>
		<td width="49%" height="15" nowrap valign="bottom"><font face="Arial"><b>
		&nbsp;<%=Hour(Time()) & ":" & theMinute%> </b>
		</font> </td>
	</tr>
</table>
</td>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
	...
	k=k+1
		...
		<!--
		<tr height="20">
			<td width="30%"><%=Rs("SecurityName")%></td>
			<td width="12%" align="right"><%=Rs("OrdDetailQty")%></td>
			<td width="8%" align="right"><%=Rs("OrdDetailPrice")%></td>
			<td width="15%" nowrap>&nbsp;&nbsp;<%=Validity%></td>			
		</tr>
		-->		
		<tr>
			<%
...
'	set Rs = conn.execute("SELECT top 5 * FROM OrderForm WHERE (Order_DPA_ = " & OrderID & ")")
