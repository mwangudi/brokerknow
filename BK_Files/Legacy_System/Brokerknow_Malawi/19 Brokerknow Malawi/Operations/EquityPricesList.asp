...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataEntity = "EquityPrice"
		const DataEntityPlural = "Equity Prices"
		const ActionFolder = "Operations"
		const ActionPage = "EquityPricesList"
...
'======================= End_Alter_Across_Entities =================================		
		...
		'Default order by filter
		if filterStr = "" and searchStr = "" and sortQryStr = "" then
		   sqlStr =  sqlStr & " ORDER BY [Date] DESC, SecurityCode ASC"
		end if	
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-2 {width: 70px; text-align: left;}
...
'======================= Begin_Alter_Across_Entities =================================
			if isdate(rs.Fields("Date")) then
			   MarketDate =  FormatDate(rs.Fields("Date"))
		    else
			   MarketDate = ""
		    end if
		
			'row ID 
			rowData = rowData & quote & rs.Fields("Security_DPA_") & "-" & MarketDate  & quote & " : " 
			...
			rowData = rowData & quote & MarketDate & quote 
			rowData = rowData & "]" 
			
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Security_DPA_") & "-" & MarketDate & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "Name", "Market Price", "Market Date"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="SecurityCode: Security Code*0;SecurityName: Name*0;Price: Market Price*2;Date: Market Date*1">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="SecurityCode: Security Code;Name: SecurityName;Price: Market Price;Date: Market Date">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="SecurityCode: Security Code*0;SecurityName: Name*0;Price: Market Price*2;Date: Market Date*1">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:15em;width:30em">
