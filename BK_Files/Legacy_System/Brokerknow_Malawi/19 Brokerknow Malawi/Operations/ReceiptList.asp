		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-0 {width: 50px; text-align: right;}
					.active-column-1 {width: 90px;}
					.active-column-2 {width: 70px; text-align: center;}
					.active-column-3 {width: 180px;}
					.active-column-4 {width: 170px;}
					...
					.active-column-10 {width: 120px;  text-align: left;}			
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & rs.Fields("EntityType") & quote & "," 
			rowData = rowData & quote & rs.Fields("EntityName") & quote & "," 
			...
			rowData = rowData & quote & FormatNum(rs.Fields("PaymentType")) & quote & ","
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Receipt No", "Date", "Entity", "Account", 
			"Bank","Reference", "Amount"," Payment Type","Order No","Last Modified By","Time Modified"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityType:Entity*0;EntityName:Account*0;PaymentPDate:Date*3;PaymentAmount:Amount*2;PaymentReference:Reference*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityType:Entity;EntityName:Account;CPaymentReceiptNo:Receipt No;PaymentPDate:Date;PaymentAmount:Amount;PaymentReference:Reference;PaymentReference:Reference">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityType:Entity*0;EntityName:Account*0;CPaymentReceiptNo:Receipt No*2;PaymentPDate:Date*3;PaymentAmount:Amount*2;PaymentReference:Reference*0;PaymentReference:Reference*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:32em;width:32em">
