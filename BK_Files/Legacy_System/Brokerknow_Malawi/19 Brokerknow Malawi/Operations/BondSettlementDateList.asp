...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "BondSettlementDateList"
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="BondSettlementDate:Settlement Date;TransDate:Trade Date;ClientName:Client;Order_DPA_:Order No;ContractNumber:Contract;BondIssue:Security;SlipNo:Slip No;Price:Price;FaceValue:Quantity;Gross:Gross;Commission:Commission;NetAmount:Net Amount">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="BondSettlementDate:Settlement Date;TransDate:Trade Date;ClientName:Client;Order_DPA_:Order No;ContractNumber:Contract;BondIssue:Security;SlipNo:Slip No;Price:Price;FaceValue:Quantity;Gross:Gross;Commission:Commission;NetAmount:Net Amount">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="BondSettlementDate:Settlement Date;TransDate:Date;ClientName:Client;Order_DPA_:Order No;ContractNumber:Contract;BondIssue:Security;SlipNo:Slip No;Price:Price;FaceValue:Quantity;Gross:Gross;Commission:Commission;NetAmount:Net Amount">
