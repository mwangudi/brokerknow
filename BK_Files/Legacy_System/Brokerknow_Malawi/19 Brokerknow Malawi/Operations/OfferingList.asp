...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "OfferingList"		
		const DataSource = "EditOffering"
...
'======================= End_Alter_Across_Entities =================================		
		...
		'sqlStr = "SELECT * FROM [" & DataSource & "] ORDER BY ClosingDate DESC, Offerings_Date DESC, pal_no Desc"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-4 {width: 150px;  text-align: right;}
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="PAL_No:PAL No*0;Client_DPA_:Client Code*0;ClientName:Client*0;SecurityName:Offering*0;ID_No:ID*0;Offering_Price:Price*0;Alloted_Rights:Alloted*0;Amount_Payable:Payable*0;Accepted_Rights:Accepted*0;Renouncee:Renouncee*0;PaymentReceiptNo:Receipt No*0;PaymentReference:Cheque No*0;Submission_Date:Submission Date*3">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="PAL_No:PAL No;Client_DPA_:Client Code;ClientName:Client;SecurityName:Offering;ID_No:ID;Offering_Price:Price;Alloted_Rights:Alloted;Amount_Payable:Payable;Accepted_Rights:Accepted;Renouncee:Renouncee;PaymentReceiptNo:Receipt No;PaymentReference:Cheque No;Submission_Date:Submission Date">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="PAL_No:PAL No*0;Client_DPA_:Client Code*0;ClientName:Client*0;SecurityName:Offering*0;ID_No:ID*0;Offering_Price:Price*0;Alloted_Rights:Alloted*0;Amount_Payable:Payable*0;Accepted_Rights:Accepted*0;Renouncee:Renouncee*0;PaymentReceiptNo:Receipt No*0;PaymentReference:Cheque No*0;Submission_Date:Submission Date*3">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:24em;width:45em">
