   ...
   'WriteDialogRelocateScript "AddOffering.asp" 	
	   ...
	   Dim palno
					...
					conn.BeginTrans		
							...
							sqlStr = "INSERT INTO [Offerings] ( Offering_DPA_,PAL_No,Client_DPA_, " & _
									"Offering,Offering_Price,Alloted_Rights,Receipt,Forward,OfferCheque,OfferBank,ChangedBy) " & _
									...
									"," & " " & 1 & " " & " as Forward" & _
									"," & "'" & ChkNo & "'" & " as OfferCheque" & _
									"," & "'" & narrative & "'" & " as OfferBank" & _
	...
	'Dim palno
					...
					conn.BeginTrans		
							...
							sqlStr = "INSERT INTO [Offerings] ( Offering_DPA_,PAL_No,Client_DPA_, " & _
									"Offering,Offering_Price,Alloted_Rights,Receipt,Forward,OfferCheque,OfferBank,Offering_EIT_,ChangedBy) " & _
									" SELECT " & " " & "iif(isnull(max([Offering_DPA_])),(SELECT InitialID FROM _Initial_Table_ID_ WHERE TableName = 'Offerings'),max([Offering_DPA_]) + 1)" & " " & " as Offering_DPA_" & _
									"," & "'" & palno & "'" & " as PAL_No" & _
									"," & "" & ClientName & "" & " as Client_DPA_" & _
									"," & " " & offering & " " & " as Offering" & _						
					...
					'Retrieve Record ID
					sqlStr = "Select Offering_DPA_ From Offerings Where Offering_EIT_ Like '%" & guidStr & "%'"
					...
					End If
						...
						<%
						WriteDialogRelocateScript "OfferingForm.asp?ID=" & rs.Fields("Offering_DPA_")
...
%>
              ...
              <tr>
				...
				<td width="65%"><input type = 'text' name ='txtChkAmt' id = 'txtChkAmt' size="20" value='<%=ChkAmt%>'></td>   
              </tr>
              <tr>              
     <tr>
    <td width="15%">Bank</td>
...
%>
 ...
 <tr>
    ...
    <td width="65%"><textarea name ='txtNarrative' id = 'txtNarrative'><%=narrative%></textarea></td>   	
  </tr>      
  <tr>
...
<table border="0" width="100%" cellpadding=2 cellspacing=2>
 ...
 <tr>
    <td width="35%">Bank</td>
    <td width="65%"><textarea name ='txtNarrative' id = 'txtNarrative' cols="50" rows="5"><%=narrative%></textarea></td>   	
  </tr>
  <tr>
     <td width="100%" colspan="2" align=right>
		<BR>
		...
		<input type = 'hidden' name ='cboPaymentTypes' id = 'cboPaymentTypes' value='<%=PaymentTypes%>'>
		<input type = 'hidden' name ='securityname' id = 'securityname' value='<%=securityname%>'>
      </td>
  </tr>
</table>
