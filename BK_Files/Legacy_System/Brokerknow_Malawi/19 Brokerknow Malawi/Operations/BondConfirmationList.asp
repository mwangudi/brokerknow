...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "BondConfirmationList"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & FormatDate(rs.Fields("BondSettlementDate")) & quote & ","
			rowData = rowData & quote & FormatDate(rs.Fields("TransDate")) & quote & ","
			...
			rowData = rowData & quote & FormatNum(rs.Fields("FaceValue")) & quote & "," 
			rowData = rowData & quote & FormatNum(rs.Fields("Gross")) & quote & "," 			
			rowData = rowData & quote & FormatNum(rs.Fields("Commission")) & quote & "," 
			...
			rowData = rowData & quote & rs.Fields("ProposalNo") & quote  			
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Settlement Date","Trade Date",  "Client","Order No","Contract","Issue No", "Slip No", "Price", "Face Value","Consideration",  
			"Commission","Net Amount","Issue Date", "Maturity Date","Proposal No"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="TransDate:Date*3;ClientName:Client*0;Order_DPA_:Order No*0;BondIssue:Issue No*0;Price:Price*2;FaceValue:Face Value*2;Gross:Consideration*2;Commission:Commission*2;NetAmount:Net Amount*0;IssueDate:Issue Date*1;MaturityDate:Maturity Date*1;BondSettlementDate:Settlement Date*1;ContractNumber:Contract Number*0;SlipNo:Slip Number*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="TransDate:Date;ClientName:Client;Order_DPA_:Order No;BondIssue:Issue No;Price:Price;FaceValue:Face Value;Gross:Consideration;Commission:Commission;NetAmount:Net Amount;IssueDate:Issue Date;MaturityDate:Maturity Date;BondSettlementDate:Settlement Date;ContractNumber:Contract Number;SlipNo:Slip Number">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="TransDate:Date*3;ClientName:Client*0;Order_DPA_:Order No*0;BondIssue:Issue No*0;Price:Price*2;FaceValue:Face Value*2;Gross:Consideration*2;Commission:Commission*2;NetAmount:Net Amount*0;IssueDate:Issue Date*1;MaturityDate:Maturity Date*1;BondSettlementDate:Settlement Date*1;ContractNumber:Contract Number*0;SlipNo:Slip Number*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:28em;width:47em">
