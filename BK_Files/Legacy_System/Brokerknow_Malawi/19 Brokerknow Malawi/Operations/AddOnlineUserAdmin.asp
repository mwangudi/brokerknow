...
<form name = 'frmEditUser' method = 'post' action = 'AddOnlineUserAdmin.asp' >
<table border="0" width="100%" cellpadding=2 cellspacing=2>
 ...
 <tr>
	 ...
	 <td width="100%" colspan=2>	 
		...
		<P>
		<input type=checkbox name="chkExtra" Value="AskSecretQuestion" Class="BorderLess" ID="chkAskSecretQuestion"><label for="chkAskSecretQuestion" style="cursor: hand">&nbsp;Ask Secret Question</label>  
		<P>
		Client Name
        ...
        If Not (rs.EOF Or rs.BOF) Then
            rs.MoveFirst
            Do Until rs.EOF%>
                <option value = '<%=rs.Fields("Client_DPA_")%>'><%=Mid(rs.Fields("ClientName"),1,30)%></option>
                <%rs.MoveNext
            Loop
        End If
		%>
