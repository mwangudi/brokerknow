...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "BrokerCommissionList"
		const DataEntity = "BrokerCommission"
		const DataEntityPlural = "BrokerCommissions"
...
'======================= End_Alter_Across_Entities =================================		
		...
		sqlStr = "SELECT top 26 * FROM [" & DataSource & "]"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-2 {width: 50px; text-align: center;}
					.active-column-3 {width: 70px; text-align: right}
					.active-column-4 {width: 70px; text-align: right}
					.active-column-5 {width: 40px;  text-align: left;}	
					.active-column-6 {width: 70px;  text-align: right;}
					.active-column-7 {width: 70px;  text-align: right;}				
					.active-column-8 {width: 120px;  text-align: left;}
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & FormatNumEx(rs.Fields("LotQty"),0) & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("LotPrice")) & quote & ","
			rowData = rowData & quote & rs.Fields("Order_DPA_") & quote & ","			
			rowData = rowData & quote & FormatNum(rs.Fields("LevyRate")) & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("LevyAmount")) & quote & ","			
			rowData = rowData & quote & FormatDate(rs.Fields("ChangedBy")) & quote  & ","	
			if(isnull(rs.Fields("TimeChanged"))) then
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Date", "Contract", "Security", "Quantity", 
			"Price", "Order","Comm Rate","Comm Amount","Last Modified By","Time Modified"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="LotTDate:Contract Date*1;ContractNumber:Contract Number*0;SecurityCode:Security*0;Order_DPA_:Order No*0;LotQty:Quantity*2;LotPrice:Price*2;LevyAmount:Commission*2;LevyRate:Rate;ChangedBy:Last modified by*0;TimeChanged:Last Time Modified*1">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="LotTDate:Contract Date;ContractNumber:Contract Number;SecurityCode:Security;Order_DPA_:Order No;LotQty:Quantity;LotPrice:Price;LevyAmount:Commission;LevyRate:Rate;ChangedBy:Last modified by;TimeChanged:Last Time Modified">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="LotTDate:Contract Date*1;ContractNumber:Contract Number*0;SecurityCode:Security*0;Order_DPA_:Order No*0;LotQty:Quantity*2;LotPrice:Price*2;LevyAmount:Commission*2;LevyRate:Rate;ChangedBy:Last modified by*0;TimeChanged:Last Time Modified*1">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:20em;width:30em">
