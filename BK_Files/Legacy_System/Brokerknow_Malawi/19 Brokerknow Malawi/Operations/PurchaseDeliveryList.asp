...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "PurchaseContractList" 'table or view in database
		const DataEntityList = "PurchaseDeliveryList" 'this page
		const DataEntity = "PDelivery"
		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-3 {width: 50px; text-align: center;}
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 10;
			var colNames = ["", "txtTransferNo", "txtDDate", "", 
			"", "", "", "", "",""];
			
			var myColumns = ["Contract", "Transfer", "Delivery Date", "Broker", 
					...
					if(colNames[i] != "")
					{
						...
						else
						{
							if(colNames[i]=="txtDDate")
							{
								...
								myData[rowIndex][i] = "<INPUT TYPE='text' NAME='" + colNames[i] + "' ID='" + colNames[i] + "' VALUE='"+myData[rowIndex][9]+"' onChange = 'EditInPlaceDataChanged();event.cancelBubble=true;' OnClick='event.cancelBubble=true;'>";
							}
							else
							{
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
			...
			function changeDateInterface(){
				calDDate = new ctlSpiffyCalendarBox('calDDate', 'frm<%=DataSource%>', 'txtDDate', 'cmdDDate', '<%=formatdate(date)%>' , 1); 
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='EditPage' id = "EditPage" value = "<%=ActionFolder%>/EditPDelivery.asp">
				<input type = 'hidden' name ='AddPage' id = "AddPage" value = "<%=ActionFolder%>/EditPDeliveryInPlace.asp"> 
