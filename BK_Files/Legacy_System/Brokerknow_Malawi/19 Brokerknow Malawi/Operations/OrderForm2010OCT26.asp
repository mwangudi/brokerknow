...
returnPath ="EditOrder.asp"
OrdDetailID = Request.QueryString("OrdDetailID")
...
<tr>
<td colspan="2" align="center"><img src="../data/photos/aaprintlogo.jpg" border="0"></td>
</tr>
<td colspan="2" height="20">&nbsp;</td>
</tr>
<tr>
	<td colspan="2" height="10" align="center"><b><font face="Arial" size="5"><%=ucase(Rs("OrderTypeDescription")) & " ORDER" & " " & rs("Order_DPA_")%> </font></b></td>
</tr>
</tr>
<td colspan="2" >&nbsp;</td>
</tr>
...
<tr>
	...
	<td><b>CLIENT REF.:</b>&nbsp;&nbsp;&nbsp;<%=Rs("ClientCDSNo")%></td>
	<td></td>
</tr>
...
<tr><td colspan="6">
	...
	<tr>
		<td width="20%">Order taken by: </td>
		<td>&nbsp;</td>
		<td width="20%">Order approved by:</td>
		<td>&nbsp;</td>
