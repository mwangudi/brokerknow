	  ...
	  LevyRate=Request.Form("txtLevy")
		...
		Title	=Request.Form("txtTitle")
				...
				if(ForwardRate="") then
					...
					conn.BeginTrans					
				sqlStr = "INSERT INTO [BondConfirmation] (BondConfirmation_DPA_,SettlementDate,ForwardRate,NoDaysMaturity,Convexity,Duration,ConsiderationI,CommissionI,CounterPartyI,CounterParty_DPA_,ContactPerson,Title,Order_DPA_) SELECT " & " " & "iif(isnull(max([BondConfirmation_DPA_])),(SELECT InitialID FROM _Initial_Table_ID_ WHERE TableName = 'BondConfirmation'),max([BondConfirmation_DPA_]) + 1)" & " " & " as BondConfirmation_DPA_" & _
				         "," & "#" & FormatDate(SettlementDate) & "#" & " as SettlementDate," & " " & ForwardRate & " " & " as ForwardRate," & " " & NoDaysMaturity & " " & " as NoDaysMaturity" & _
				         "," & " " & Convexity & " " & " as Convexity" & _
				         "," & " " & Duration & " " & " as Duration" & _
				         "," & "'" & ConsiderationI & "'" & " as ConsiderationI" & _
				         "," & "'" & CommissionI & "'" & " as CommissionI" & _
				         "," & "'" & CounterPartyI & "'" & " as CounterPartyI" & _
				         "," & " " & CounterParty & " " & " as CounterParty_DPA_" & _
				         "," & "'" & Contact & "'" & " as ContactPerson " & _
				         "," & "'" & Title & "'" & " as Title " & _
				         "," & " " & ID & " " & " as Order_DPA_ " & _
				         " FROM [BondConfirmation]"						
						    ...
						    conn.Execute sqlStr
					sqlStr="UPDATE Contract SET ContractSettlementDate = '" & FormatDate(SettlementDate)& "' FROM Contract INNER JOIN" & _
                        	    	 " Lot ON Contract.Contract_DPA_ = Lot.Contract_DPA_ INNER JOIN OrdDetail ON Lot.OrdDetail_DPA_ = OrdDetail.OrdDetail_DPA_" & _
					    	 " WHERE (OrdDetail.Order_DPA_ = " & ID & ")"				
...
<form name = 'frmAddBondConfirmation' id="frmMain" method = 'post' action = 'AddBondConfirmation.asp' >
<tr>
...
<table border="1" width="90%" cellspacing="0" cellpadding="0" bordercolor="#000000">
  ...
  <tr>
    ...
    <td width="70%"><input readonly = 'true' class=readonly  type = 'text' name ='txtClient' id = 'txtClient' size="30" value = '<%=rs.Fields("ClientName")%>'></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="60%"><input  STYLE="WIDTH: 100px; text-align: left" type = 'text' name ='txtfrate' id = 'txtClient' size="30"></td>
  </tr>
  <tr>
    <td width="40%">&nbsp;&nbsp;No Of Days To Maturity</td>
    <td width="60%"><input STYLE="WIDTH: 100px; text-align: left" type = 'text'  name ='txtNoDays' id = 'txtNoDays' size="20"></td>
  </tr>
  <tr>
    <td width="40%">&nbsp;&nbsp;Convexity</td>
    <td width="60%"><input STYLE="WIDTH: 100px; text-align: left" type = 'text'  name ='txtConvexity' id = 'txtConvexity' size="20"></td>
  </tr>
  <tr>
    <td width="40%">&nbsp;&nbsp;Duration</td>
    <td width="60%"><input STYLE="WIDTH: 100px; text-align: left" type = 'text'  name ='txtDuration' id = 'txtDuration' size="20"></td>
  </tr>
  <tr>
    <td width="40%">&nbsp;&nbsp;Payment Instruction(Consideration)</td>
    <td width="60%"><input STYLE="WIDTH: 270px; text-align: left" type = 'text'  name ='txtConsiderationP' id = 'txtConsiderationP' size="20" Value='Via interbank transfer'></td>
  </tr>  
  <tr>
    <td width="40%">&nbsp;&nbsp;Payment Instruction(Commission)</td>
    <td width="60%"><input STYLE="WIDTH: 270px; text-align: left" type = 'text'  name ='txtCommissionP' id = 'txtCommissionP' size="20" Value='Pay Dyer and Blair investment bank Ltd'></td>
  </tr>
  <tr>
    <td width="40%">&nbsp;&nbsp;Payment Instruction(Counter Party)</td>
    <td width="60%"><input STYLE="WIDTH: 270px; text-align: left" type = 'text'  name ='txtCounter' id = 'txtCounter' size="20"></td>
  </tr>    	
  <tr>
    <td width="40%">&nbsp;&nbsp;Counter Party </td>
				<td width="60%"><input type = 'text' name ='txtClientCode' id = 'txtClientCode' size="10" onBlur="txtval = this.value; selectItem(cboBank);">
  ...
  <tr>
    ...
    <td width="60%"><input readonly = 'true' class=readonly STYLE="WIDTH: 270px; text-align: left" type = 'text'  name ='txtContact' id = 'txtContact' size="20" value='<%=rs("ClientContact")%>'></td>
  </tr>  
  <tr>
    <td width="40%">&nbsp;&nbsp;Title</td>
    <td width="60%"><input STYLE="WIDTH: 270px; text-align: left" type = 'text'  name ='txtTitle' id = 'txtTitle' size="20"></td>
  </tr>
  <tr>
