...
<%
   ...
   Set conn = GetActiveConnection("KBroker")
	...
	ID = Request("ID")
	sqlStr = "SELECT * FROM ForwardsList WHERE Offering_DPA_=" & ID
	...
	<%
	WriteDialogRelocateScript "OfferingForm.asp?ID=" & ID	
...
%>
              ...
              <tr>
				...
				<td width="70%"><input type = 'text' name ='txtChkAmt' id = 'txtChkAmt' size="20" value='<%=ChkAmt%>'></td>   
              </tr>
              <tr>              
     <tr>
 ...
 <tr>
  ...
  <tr>
     <td width="100%" colspan="2" align=right>
		...
		<BR>
		<input type = 'submit' Class=Buttons name ='cmdAdd' id = 'cmdAdd' value=" Save ">
		<input type = 'submit' Class=Buttons name ='cmdAdd' id = 'cmdPrint' value=" Print " OnClick="JavaScript: UpdateAction('print');">		
		<input type = 'button' Class=Buttons name ='cmdCancel' id = 'cmdCancel' value=" Cancel " OnClick="JavaScript: window.self.close();">
		&nbsp;&nbsp;
