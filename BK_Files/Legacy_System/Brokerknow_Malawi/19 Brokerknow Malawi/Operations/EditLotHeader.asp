 ...
 <!--<tr>
  ...
  <tr>
    <td align="right" colspan=2 nowrap width="17%" height="25">
		...
		&nbsp;&nbsp;
		<input type = 'button' class=buttons name ='cmdCancel' id = 'cmdCancel' value=" Close " onClick="window.parent.opener.location=window.parent.opener.location;window.parent.close();">
