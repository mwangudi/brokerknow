...
<SCRIPT>
		...
		function forceSubmit()
		{
			...
			document.frmAddOrder.method='post';
			document.frmAddOrder.target='_self';
			document.frmAddOrder.submit();	
...
<%
	...
	if action = "EXECUTE" then					
		...
		if instr(1,buttonAction,"SAVE") > 0 Or instr(1,buttonAction,"ADD") > 0 then
				...
				AvailableCredit=iif(AvailableCredit = "",0,AvailableCredit)
				AvailableCredit = cdbl(replace(AvailableCredit,",",""))
				...
				if instr(1,buttonAction,"LINE/S") > 0 then
					...
					<SCRIPT LANGUAGE="JAVASCRIPT">
						...
						//alert("hapa");
						//document.location.href="EditOrder.asp?ID=" +<%= rs.Fields("OrdDetail_DPA_")%>
						//this.parent.editDocOpener.location ="EditOrder.asp?ID=" +<%= rs.Fields("OrdDetail_DPA_")%>
						window.self.location.href='EditOrder.asp?ID=<%= rs.Fields("OrdDetail_DPA_")%>';
					</SCRIPT>
					<%

					'WriteDialogRelocateScript2( "EditOrder.asp?ID=" & rs.Fields("OrdDetail_DPA_"))
				elseif instr(1,buttonAction,"PRINT") > 0 then
					%>
					<SCRIPT LANGUAGE="JAVASCRIPT">
						window.opener.location= window.opener.location;
						window.self.location.href='OrderForm.asp?order_id=<%=OrderID%>&OrdDetailID=<%=rs.Fields("OrdDetail_DPA_")%>&returnPath=EditOrder.asp';
					</SCRIPT>
					<%
					'WriteDialogRelocateScript2 "OrderForm.asp?order_id=" & OrderID & "&returnPath=EditOrder.asp&OrdDetailID=" & rs.Fields("OrdDetail_DPA_")

				elseif instr(1,buttonAction,"ADD NEW") > 0 then%>
					<SCRIPT LANGUAGE="JAVASCRIPT">
						window.self.location.href='AddOrder.asp';
					</SCRIPT>
					<%
					'WriteDialogRelocateScript2 "AddOrder.asp"
				Else
...
<table border="0" width="830" height="357" cellspacing=2 cellpadding=2>
  ...
  <tr>
	...
	<td width="676" height="28">&nbsp;<input  name ='txtAccManager' id = 'txtAccManager'  readonly class="readonly" size="30">
...
&nbsp;<input  name ='txtAgent' id = 'txtAgent'  readonly class="readonly" size="30">
</td>
<input type = 'hidden' name ='AgentID' id = 'AgentID' >
  ...
  <tr>
    ...
    <td width="676" height="22">
    &nbsp;<input  name ='txtContact' id = 'txtContact' readonly class='readonly' size="40"></td>
  ...
  <tr id="HeldDate">
	...
	<td width="676" height="20">&nbsp;<input  name ='txtRef' readonly class='readonly' id = 'txtRef' size="20"></td>
...
%>
	...
	<td>	
      ...
      <td>
	  <input  name ='txtAmount' id = 'txtAmount' size="5" readonly="true" class="readonly" OnChange="JavaScript: format2NumberCommasOnly(this)"></td>
...
<table border="0"  width="830">
    ...
    <td width="20%"  align=right>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b id="hide" name="hide"><input type = 'button' Class=Buttons name ='cmdAdd' id = 'cmdAddMore' value=" Add Line/s " onclick = "document.getElementById('buttonAction').value='Add Line/s';AllowedNavigation();hideButton()">
		&nbsp;&nbsp;&nbsp; <input type = 'button' Class=Buttons name ='cmdAdd' id = 'cmdAddMoreNew' value=" Add New Order " onclick = "document.getElementById('buttonAction').value='Add New Order';AllowedNavigation();hideButton()">
        &nbsp;&nbsp; <input type = 'button' Class=Buttons name ='cmdAdd' id = 'cmdAddPrint' value=" Save & Print " onclick = "document.getElementById('buttonAction').value='Save & Print';AllowedNavigation();hideButton()">&nbsp;&nbsp;
        <input type = 'button' Class=Buttons name ='cmdAdd' id = 'cmdAdd' value=" Save & Close " onclick = "document.getElementById('buttonAction').value='Save & Close';AllowedNavigation();hideButton()"></b>
        &nbsp;&nbsp; <input type = 'button' Class=Buttons name ='cmdClose' id = "cmdClose" value=" Close " onclick = "window.opener.location= window.opener.location;window.self.close();">
