...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityType:Entity*0;EntityName:Account*0;PaymentPDate:Date*3;PaymentAmount:Amount*2;BankAccountName:Bank*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityType:Entity;EntityName:Account;PaymentPDate:Date;BankAccountName:Bank;PaymentAmount:Amount">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityType:Entity*0;EntityName:Account*0;PaymentPDate:Date*3;PaymentAmount:Amount*2;BankAccountName:Bank*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:45em;width:36em">
