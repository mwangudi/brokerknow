...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "clientSmsDebitList"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			if cbool(rs("updateOnDebt"))= true then  update="Yes" else update="No"


			'Rs1.Open "select Balance from debitb where client_DPA_ =" & Rs("Client_DPA_"), Conn, 0, 1
			'response.write "select Balance from debitb where client_DPA_ =" & Rs("Client_DPA_") & "<br>"
			...
			'rowData = rowData & quote & formatNum(0-TBal) & quote & ","
			rowData = rowData & quote & formatNum(0-rs.Fields("Balance")) & quote & ","
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "CDS", "Name","Cell No.", "T-5","Send Sms"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_: Code*2;ClientCDSNo: ClientCDSNO*0;clientName: Client Name*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_: Code;ClientCDSNo: ClientCDSNO;clientName: Client Name">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_: Code*2;ClientCDSNo: ClientCDSNO*0;Name: Client Name*0">
