...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ClientEmailDocsList"
		const DataEntity = "ClientEmailDocs"
		const DataEntityPlural = "ClientEmailDocsList"
		const ActionFolder = "Operations"
		const ActionPage = "ClientDocumentsList"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			'row ID 
			rowData = rowData & quote & rs.Fields("ID") & quote & " : " 
			...
			rowData = rowData & quote & rs.Fields("DocName") & quote & "," 
			rowData = rowData & quote & rs.Fields("ModeName") & quote & ","
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "CDS", "Name","Document", "Mode", "Changed By", "Time Changed"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_: Code*2;CDS: ClientCDSNO*0;clientName: Client Name*0;DocName: Document*0">

				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_: Code;CDS: ClientCDSNO;clientName: Client Name;DocName: Document">

				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_: Code*2;CDS: ClientCDSNO*0;clientName: Client Name*0;DocName: Document*0">
