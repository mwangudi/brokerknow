...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "OnlineUserList"
		const DataEntity = "OnlineUser"
		const DataEntityPlural = "OnlineUsers"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("UserID") & quote & " : " 
			...
			rowIDs = rowIDs & quote & rs.Fields("UserID") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["User", "User name","Description","Client Name","Client Email"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="User:User*0;UserName:User name*0;Description:Description*0;ClientEmail:Client Email*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="User:User;UserName:User name;Description:Description;ClientEmail:Client Email">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="User:User*0;UserName:User name*0;Description:Description*0;ClientEmail:Client Email*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:24em;width:30em">
