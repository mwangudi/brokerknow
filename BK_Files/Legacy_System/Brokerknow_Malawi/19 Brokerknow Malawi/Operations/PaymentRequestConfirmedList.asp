...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "PaymentRequestConfirmedList"
		const DataEntity = "PaymentConfirmedRequest"
		const DataEntityPlural = "PaymentConfirmedRequests"
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='EditPage' id = "EditPage" value = "<%=ActionFolder%>/EditPaymentRequest.asp">
...
<%'======================= Begin_Alter_Across_Entities =================================%>
																										var myColumns = ["Code", "Client", "Account", ];
