...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "kcbSchedules"
		const DataEntity = "IPOSchedule"
		const DataEntityPlural = "IPOSchedules"
...
'======================= End_Alter_Across_Entities =================================		
		...
		sqlStr = "SELECT distinct * FROM [" & DataSource & "]"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("ScdID") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("ScdID") & quote & "," 
			rowData = rowData & quote & rs.Fields("Total") & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("AmtPaid")) & quote & "," 
			rowData = rowData & quote & FormatNumEx(rs.Fields("TotalShares"),0) & quote & ","
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("ScdID") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Schedule No","Num","Total Amt","Total Shares"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="ScdID:Schedule Number*0;Total:Total Applications*0;AmtPaid:Total Amount*2;TotalShares:Total Shares*2;ChqNo:Cheque No*0;BankCode:Bank Code*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="ScdID:Schedule Number;Total:Total Applications;AmtPaid:Total Amount;TotalShares:Total Shares;ChqNo:Cheque No;BankCode:Bank Code">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="ScdID:Schedule Number*0;Total:Total Applications*0;AmtPaid:Total Amount*2;TotalShares:Total Shares*2;ChqNo:Cheque No*0;BankCode:Bank Code*0">
