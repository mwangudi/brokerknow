...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ContractList" 'table or view in database
		const DataEntityList = "DeliveryList" 'this page
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & rs.Fields("ContractDeliveryDate") & quote & "," 
			rowData = rowData & quote & rs.Fields("BrokerCode") & quote & "," 
			rowData = rowData & quote & rs.Fields("OrdDetailType") & quote & "," 
			...
			rowData = rowData & quote & rs.Fields("StatusDescription") & quote & ","
			rowData = rowData & quote & rs.Fields("OrdDetailClient") & quote  
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			//column titles 
			var colCount = 11;
			var colNames = ["", "Transfer", "", "DDate", "", 
			"", "", "", "", "",""];
			
			var myColumns = ["Contract", "Transfer", "Certificate", "Delivery Date", "Broker", 
			"Transaction Type", "Slip No", "Quantity", "Price", "Status","Client"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
			...
			function changeDateInterface(){
				calDDate = new ctlSpiffyCalendarBox('calDDate', 'frm<%=DataSource%>', 'DDate', 'cmdDDate','<%= FormatDate(Date) %>', 1); 
				calDDate.returnOutStringOnWrite(); 
				var parentDiv = document.all.item("DDate").parentNode;
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="OrdDetailClient:Client*0;OrderTypeSale:Is Sale?*6;ContractDelivered:Delivered*5">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="OrdDetailClient:Client;OrdDetailType:Transaction Type;ContractTransferNo:Transfer No;ContractDeliveryDate:Delivery Date;ContractCertificate:Certificate;BrokerCode:Broker;OrdDetailType:Transaction Type;LotSlipNo:Slip No;LotQty:Quantity;LotPrice:Price;StatusDescription:Status">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="OrdDetailClient:Client*0;OrdDetailType:Transaction Type*0;ContractDeliveryDate:Delivery Date*3;ContractTransferNo:Transfer No*0;ContractCertificate:Certificate*0;BrokerCode:Broker*0;LotSlipNo:Slip No*0;LotQty:Quantity*1;LotPrice:Price*1">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:27em;width:20em">
