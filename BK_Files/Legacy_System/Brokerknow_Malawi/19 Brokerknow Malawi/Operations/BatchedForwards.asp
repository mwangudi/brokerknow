...
'======================= Begin_Alter_Across_Entities =================================
			...
			'if trim(rs.Fields("Downloaded")) then
			' Downloaded = "Yes"
			'else
			' Downloaded = "No"
			'end if
			...
			rowIDs = rowIDs & quote & rs.Fields("Batch_No") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Batch No","Offering","Total applications","Total Shares","Total Amount", ""];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
