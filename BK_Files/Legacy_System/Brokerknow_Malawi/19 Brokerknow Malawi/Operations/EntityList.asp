...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Entity_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("EntityName") & quote & ","  
			rowData = rowData & quote & rs.Fields("EntityType") & quote & ","			 
			rowData = rowData & quote & FormatNum(rs.Fields("EntityOpeningBal")) & quote 

			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Entity_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Entity Name","Entity Type","Opening Balance"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityName:Name*0;EntityType:Entity Type*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityName:Name;EntityType:Entity Type">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityName:Name*0;EntityType:Entity Type*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:24em;width:22em">
