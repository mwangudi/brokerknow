        			...
        			<%
        						...
        						<%
        							...
        							Do Until Rs.EOF        								
        									...
        									displayAmt = Rs.Fields("ContractAmount").Value 
        									
        									
        									If ((CBool(Rs.Fields("ContractVouchered").Value) = True) And (CBool(Rs.Fields("OrderTypeSale").Value) = False)) Or _
        										((CBool(Rs.Fields("BrokerReceiptVouchered").Value) = True) And (CBool(Rs.Fields("OrderTypeSale").Value) = True))  Then
        										chkString = " checked "
        									Else
        										chkString = " "
        									End If	
...
<Script Language="JavaScript">
	function updateOwnerDocument(chkBox){
		if (chkBox.checked==true){
			window.parent.UpdateVoucherAmount(chkBox.value); 
		}
		else {
