...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ExistingOnlineUserList"
		const DataEntity = "ExistingOnlineUser"
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["User", "User name","Description","Client Name"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="User:User*0;UserName:User name*0;Description:Description*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="User:User;UserName:User name;Description:Description">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="User:User*0;UserName:User name*0;Description:Description*0">
