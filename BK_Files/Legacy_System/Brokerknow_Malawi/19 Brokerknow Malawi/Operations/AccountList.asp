...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("Account_DPA_") & quote & " : " 
			...
			rowData = rowData & quote & rs.Fields("AccountCode") & quote & "," 
			rowData = rowData & quote & rs.Fields("AccountTypeLevel1") & quote & ","			
			rowData = rowData & quote & rs.Fields("AccountTypeLevel2") & quote & ","			
			rowData = rowData & quote & rs.Fields("AccountTypeLevel3") & quote 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("Account_DPA_") & quote 
			rowCount = rowCount + 1
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Account Number","Account Name", "Account Code", "Account Type1", "Account Type2", "Account Type3"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Account_DPA_:Account Number*2;AccountName:Account Name*0;AccountCode:Account Code*0;AccountTypeLevel1:Account Type1*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Account_DPA_:Account Number;AccountName:Account Name;AccountCode:Account Code;AccountTypeLevel1:Account Type1">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Account_DPA_:Account Number*2;AccountName:Account Name*0;AccountCode:Account Code*0;AccountTypeLevel1:Account Type1*0">
