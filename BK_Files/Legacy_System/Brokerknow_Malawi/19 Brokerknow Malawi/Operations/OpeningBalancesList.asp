...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "OpeningBalances"
		const DataEntity = "OpeningBalance"
		const DataEntityPlural = "OpeningBalances"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID
			entityid=rs("TableName") & "<->" & rs("Entity_DPA_") 
			...
			rowData = rowData & quote & rs.Fields("EntityCode") & quote & ","			
			rowData = rowData & quote & FormatNum(rs.Fields("OpeningBalance")) & quote & ","			
			rowData = rowData & quote & FormatDate(rs.Fields("RegistrationDate")) & quote   
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Entity", "Account", "Code", "Opening Balance","Registration Date"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
/////==========================  End_CHanged   05 Apr 2004 =============================================================///////////////////////////////
		...
		<script> 
			...
			grid.getLayoutTemplate().action("adjustSize");
				...
				<input type = 'hidden' name ='ActionPage' id = "ActionPage" value = "<%=DataSource%>List.asp">

<%'======================= Begin_Alter_Across_Entities =================================%>
				
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityType:Entity*0;EntityName:Account*0;EntityCode:Code*0;OpeningBalance:Opening Balance*0;RegistrationDate:Registration Date*3">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityType:Entity;EntityName:Account;EntityCode:Code;OpeningBalance:Opening Balance;RegistrationDate:Registration Date">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityType:Entity*0;EntityName:Account*0;EntityCode:Code*0;OpeningBalance:Opening Balance*0;RegistrationDate:Registration Date*3">
