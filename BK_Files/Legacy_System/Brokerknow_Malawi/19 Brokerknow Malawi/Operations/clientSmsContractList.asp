		...
		<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/default.css">
			<LINK REL="STYLESHEET" TYPE="TEXT/CSS" HREF="../STYLE/webparts.css">
				...
				<style> 
					...
					.active-column-7 {width: 90px; text-align: right;}
...
'======================= Begin_Alter_Across_Entities =================================
			...
			if cbool(rs("updateOnContract"))= true then  update="Yes" else update="No"
			...
			rowData = rowData & quote & formatnum(rs.Fields("ContractAmount")) & quote & ","
			rowData = rowData & quote & update & quote & "," 
			rowData = rowData & "]" 
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Code", "CDS", "Name","Cell No.","Contract No", "Security", "Price", "ContractAmount","Send Sms"];
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="Client_DPA_: Code*2;ClientCDSNo: ClientCDSNO*0;clientName: Client Name*0;Contract_DPA_: Contract*0;SecurityCode: Security*0;LotPrice: Price*2;">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="Client_DPA_: Code;ClientCDSNo: ClientCDSNO;clientName: Client Name;Contract_DPA_: Contract;SecurityCode: Security;LotPrice: Price;">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="Client_DPA_: Code*2;ClientCDSNo: ClientCDSNO*0;Name: Client Name*0;Contract_DPA_: Contract*0;SecurityCode: Security*0;LotPrice: Price*2;">
