...
<%
		...
		DefaultDate =formatdate(conn.execute("SELECT     CONVERT(varchar(20), CASE WHEN DATEPART(dw, GETDATE() - 0) = 2 THEN getdate() - 0 + 4 ELSE getdate() - 0 + 6 END, 106) AS SettlementDate")(0))' FormatDate(dateadd("d",5,Now()))
        ...
        holidayRs.Open sqlStr, Conn.ConnectionString, 1, 3
