...
<%
	...
	if action = "EXECUTE" then					
		...
		if instr(1,buttonAction,"SAVE") > 0 Or instr(1,buttonAction,"ADD") > 0 then
				...
				'AvailableCredit = cdbl(AvailableCredit)
...
<table border="0"  width="830">
    ...
    <td width="20%"  align=right>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b id="hide" name="hide"><input type = 'submit' Class=Buttons name ='cmdAdd' id = 'cmdAddMore' value=" Add Line/s " onclick = "AllowedNavigation();hideButton()">&nbsp;&nbsp;&nbsp; <input type = 'submit' Class=Buttons name ='cmdAdd' id = 'cmdAddMoreNew' value=" Add New Order " onclick = "AllowedNavigation();hideButton()">
        &nbsp;&nbsp; <input type = 'submit' Class=Buttons name ='cmdAdd' id = 'cmdAddPrint' value=" Save & Print " onclick = "AllowedNavigation();hideButton()">&nbsp;&nbsp;
        <input type = 'submit' Class=Buttons name ='cmdAdd' id = 'cmdAdd' value=" Save & Close " onclick = "AllowedNavigation();hideButton()"></b>
