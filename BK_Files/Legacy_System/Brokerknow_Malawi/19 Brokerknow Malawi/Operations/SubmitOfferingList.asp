...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "SubmitOfferingList"
		const ActionPage = "SubmitOfferingList"
...
'======================= Begin_Alter_Across_Entities =================================
			if Cint(rs.Fields("Submitted"))=0 then
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("Submission_Date") &  "' style=BorderLess  value='True' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Offering_DPA_") & ");'>"
			else
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("Submission_Date") &  "' style=BorderLess checked value='False' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Offering_DPA_") & ");'>"
			end if
			...
			rowData = rowData & quote & FormatNumEx(rs.Fields("Offering_Price"),2) & quote & ","
			rowData = rowData & quote & rs.Fields("Alloted_Rights") & quote & "," 						
			rowData = rowData & quote & FormatNumEx(rs.Fields("Amount_Payable"),2) & quote & ","
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			"PAL NO", "Code", "Client", "Offering", "ID_No","Price","Alloted","Payable","Accepted","Renouncee","Receipt No","Cheque No"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
			...
			function  UpdateHoldStatus(theChk, theItem)
			{
				...
				if (theChk.checked)
				{
					holdVal = "1";//order to be released
				}
