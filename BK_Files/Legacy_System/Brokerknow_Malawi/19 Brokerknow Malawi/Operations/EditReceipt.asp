...
<script language = "javascript" >
		...
		{
				frm<%=DataSource%>.elements("txtClientCode").value = frm<%=DataSource%>.cboAccount.value
		}
...
<form name = 'frm<%=DataSource%>' method = 'post' action = '<%=DataSource%>.asp' id = "frm<%=DataSource%>">
