...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "LevyOrderList"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("LevyOrder_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("LevyName") & quote & "," 
			rowData = rowData & quote & rs.Fields("LevyOrder") & quote & ","
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("LevyOrder_DPA_") & quote 
			rowCount = rowCount + 1
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="LevyName:Name*0;LevyOrder:Order*2">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="LevyName:Name;LevyOrder:Order">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="LevyName:Name*0;LevyOrder:Order*2">
