...
<div id="spiffycalendar" class="text" STYLE="z-Index: 1000"></div>
	<form method="POST" action="BudgetReport.asp" Name="frmMain" id="frmMain">	
			<table>			
			<tr>
				<td>Select date:</td>
				<td>
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
     <tr>
		<td nowrap><b><font face="Arial Narrow" size="4">MONTHLY BUDGET</font></b></td>
	...
	<tr>
		  <td COLSPAN=2><font face="Arial" size="2"><b>For the month of&nbsp;<%=ucase(MonthName(Month((CDate(SelectedFromDate)))))%></b></font></td>
	</tr>
</table>			
	...
	SecondDate=DateSerial(Year(SelectedFromDate),Month(SelectedFromDate)+1,1)-1	
	...
	sqlStr="SELECT isnull(SUM(DB_BankAccountStatement.Credit - DB_BankAccountStatement.Debit),0) AS CurrentBal FROM         DB_BankAccountStatement INNER JOIN   Account ON DB_BankAccountStatement.BankAccount_DPA_ = Account.Account_DPA_ " & _
		 	...
		 	" WHERE  (Account.AccountTypeLevel2 = " & cloneRs("AccountType_DPA_") & ") and (Month(dbo.DB_BankAccountStatement.TransDate) =" & Month(CDate(selectedFromDate)) & " and Year(dbo.DB_BankAccountStatement.TransDate) =" & Year(CDate(selectedFromDate)) & ")" 			
	else
