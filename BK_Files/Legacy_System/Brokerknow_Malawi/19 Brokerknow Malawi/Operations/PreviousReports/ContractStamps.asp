...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then%>
	...
	<form method="POST" action="ContractStamps.asp" Name="frmMain" id="frmMain">
...
<%
   ...
   Dim rs
		 ...
		 sqlStr = "SELECT * FROM [ContractStamps] WHERE DATEPART(month, LotTDate) = " & Month(selectedTradeDate) & " AND DATEPART(yy, LotTDate) = " & Year(selectedTradeDate) & " Order by LotTDate"
...
<table border="0" cellspacing="0" cellpadding="4" style="font-family: Arial Narrow; LEFT-MARGIN:100PX">
     ...
     <tr>
		     <td colspan=6>
		        <b><font face="Arial Narrow" size="4">Contract Stamps</font></b></td>
    ...
    <tr>
      <td  colspan=7  align=left style="border-bottom-style: solid; border-bottom-width: 1"> &nbsp; </td>
    </tr>
    
    <tr>
      <td  colspan=7 align=left style="border-top-style: solid; border-top-width: 1;border-bottom-style: solid; border-bottom-width: 1">
			<PRE><b><font face="Arial" size="2">
TO:<%= Space(24) %>Commissioner of Customs and Excise
<%= Space(30) %>KENYA REVENUE AUTHORITY
RETURNS FOR:<%=  Space(6) & headerDescription %>
			</font></b></PRE></td>
      
    </tr>    
    <tr>
      <td  colspan=7 align=left style="border-top-style: solid; border-top-width: 1"> &nbsp;
	  </td>
    </tr>
    ...
    <tr>
		     <td colspan=7>
		        <PRE><b><font face="Arial" size="2">
Please find attached a schedule of contract stamps payable on
contracts issued to our clients and agents as shown below:</font></b></PRE></td>
		</tr>	
...
<tr>
	...
	<td bgcolor="#000000" align=right><b><font color="#FFFFFF" face="Arial" size="2">Stamps</font></b></td>
	<td bgcolor="#000000" align=right><b><font color="#FFFFFF" face="Arial" size="2">NSE Slip</font></b></td>
  </tr>
<%		
	totalLevyAmount = 0
	Do Until rs.EOF
        ...
        <tr>
         ...
         <tr>
						<td colspan=5 align=right><font face="Arial" size="2"><b>Monthly Totals:</b></font></td>
