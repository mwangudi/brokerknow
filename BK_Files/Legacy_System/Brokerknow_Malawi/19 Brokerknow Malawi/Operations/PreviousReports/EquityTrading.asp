...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="EquityTrading.asp" Name="frmMain" id="frmMain">
	...
	SettlementDate=LTdate(CDate(selectedFromDate),5)	
	    ...
	    sqlStr = "SELECT * FROM CDASettlement WHERE (Day(LotTDate) = Day(" & "#" & SelectedFromDate & "#" & ")) " & _
			 " and (Month(LotTDate) = Month(" & "#" & SelectedFromDate & "#" & ")) and " & _
                   " (Year(LotTDate) = Year(" & "#" & SelectedFromDate & "#" & ")) and (OrderSecType_DPA_ = 2)"
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    ...
    <tr>
      <td width="10%" nowrap><b><font face="Arial" size="4"><b>EQUITY TRADES</b></font></b></td>
...
<br>
 ...
 %>
    <tr>
      <td colspan="9" width="948" ALIGN="Center"><b><font face="Arial Narrow" size="3">CDAs</font></b></td>      
    </tr>
 ...
 %>
    <tr>
      <td colspan="9" width="948" ALIGN="Center"><b><font face="Arial Narrow" size="3">CDSes</font></b></td>      
    </tr>
	...
	%>
		...
		<tr>
			...
			<tr>
      			<td colspan="8" align="right"><b>CDS TOTAL </b></td>
			...
			<tr>
				<td colspan="9" width="948" align="Center"><b><font face="Arial Narrow" size="3">CDA SETTLEMENTS:</font></b></td>      
			</tr>	
	<%		
	...
	totalBal=0
		...
		if (Cds1<>Cds2) and (first<>0) then %>
			...
			<tr>
				<td colspan="9" width="948"><b><font face="Arial Narrow" size="3">PAYMENT:</font></b></td>      
			</tr>
			<tr>
	  			<td bgcolor="#000000" width="9"><b><font color="#FFFFFF" face="Arial Narrow" size="3">&nbsp;</font></b></td>	
      			<td bgcolor="#000000" width="63"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Ref:</font></b></td>      
	...
	%>
    <tr>
      <td colspan="8" align="right"><b>CDA TOTAL: </b></td>
      <td align="right"><b><%= FormatNum(totalBal-SubAmount) %></b>&nbsp;</td>     
      </td>
    </tr>  
	<% 
