...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="CDASettlement.asp" Name="frmMain" id="frmMain">
	...
	SettlementDate=LTdate(CDate(selectedFromDate),5)	
		...
		sqlStr = "SELECT * FROM SettlementSchedule  WHERE (Day(SettlementDate) = Day(" & "#" & SelectedFromDate & "#" & ")) " & _
			 " and (Month(SettlementDate) = Month(" & "#" & SelectedFromDate & "#" & ")) and " & _
                   " (Year(SettlementDate) = Year(" & "#" & SelectedFromDate & "#" & ")) and (OrderSecType_DPA_ = 2) order by IsCustodian"		
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    ...
    <tr>
      <td width="10%" nowrap><b><font face="Arial" size="4"><b>EQUITY SETTLEMENT SCHEDULE</b></font></b></td>
...
<br>
 ...
 %>
    <tr>
      <td colspan="10" width="948" ALIGN="Center"><b><font face="Arial Narrow" size="3">CDAs</font></b></td>      
    </tr>
 ...
 %>
    <tr>
      <td colspan="10" width="948" ALIGN="Center"><b><font face="Arial Narrow" size="3">CDSes</font></b></td>      
    </tr>
	...
	if(SaleType=2) then %>
    <tr>
      <td colspan="10" width="948"><b><font face="Arial Narrow" size="3">RECEIPTS:</font></b></td>      
    </tr>    
	<% else
	%>
    <tr>
      <td colspan="10" width="948"><b><font face="Arial Narrow" size="3">PAYMENTS:</font></b></td>      
    </tr>    
	<%
	end if
	%>
	...
	<td bgcolor="#000000" width="9"><b><font color="#FFFFFF" face="Arial Narrow" size="3">&nbsp;</font></b></td>
	  <td bgcolor="#000000" width="100"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Trade&nbsp;Date:</font></b></td>                  
	...
	%>
		<tr>
        <td colspan="10" width="814">
        &nbsp;</td>
        </tr> 
		<tr>
      	<td colspan="9" align="right"><b>Sub Total </b></td>
      	<td align="right"><b><%= FormatNum(SubAmount) %></b>&nbsp;</td>     
      	</td>
    	</tr>
    	<tr>
        <td colspan="10" width="948">
        &nbsp;</td>
        </tr>         
		<tr>
			...
			<tr>
      			<td colspan="9" align="right"><b>CDS TOTAL </b></td>
      			<td align="right"><b><%= FormatNum(totalBal-SubAmount) %></b>&nbsp;</td>     
      			</td>
    			</tr>
    			<tr>
        			<td colspan="10" width="948">
			...
			<tr>
				<td colspan="10" width="948" align="Center"><b><font face="Arial Narrow" size="3">CDA SETTLEMENTS:</font></b></td>      
			</tr>	
	<%		
	NetAmount=totalBal-SubAmount
	totalBal=0
			if(Cint(rs("OrderType_DPA_"))=2) then
			%>
			<tr>
				<td colspan="10" width="948"><b><font face="Arial Narrow" size="3">RECEIPTS:</font></b></td>      
			</tr>			
		...
		if (Cds1<>Cds2) and (first<>0) then %>
			...
			<tr>
				<td colspan="10" width="948"><b><font face="Arial Narrow" size="3">PAYMENT:</font></b></td>      
			</tr>
			<tr>
	  			<td bgcolor="#000000" width="9"><b><font color="#FFFFFF" face="Arial Narrow" size="3">&nbsp;</font></b></td>	
				<td bgcolor="#000000" width="100"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Trade&nbsp;Date:</font></b></td>                              			
	...
	SubAmount=SubAmount + Rs.Fields("LotGrossAmount").Value 
		...
		'CounterParty=Mid(rs("OwnerName"),1,30)
			...
			<tr>
			  ...
			  <td align="left" width="100"><font  face="Arial Narrow" size="3"><%= FormatDate(rs("LotTDate")) %></font></td>							  			  			  
	...
	%>
    <tr>
      <td colspan="9" align="right"><b>CDA TOTAL: </b></td>
      <td align="right"><b><%= FormatNum(totalBal-SubAmount) %></b>&nbsp;</td>     
      </td>
    </tr>  
	<% 
