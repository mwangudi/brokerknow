...
Const report_ViewName = "SecurityReport"
...
If genReport = "" Or report_description = "" Then%>
	...
	<form method="POST" action="SecurityListing.asp" Name="frmMain" id="frmMain">
			...
			<tr>
				...
				<td>
					<SELECT Name="genReport">
						<OPTION VALUE="1">All Securities</OPTION>						
					</SELECT>
				</td>
			</tr>
			<tr>
