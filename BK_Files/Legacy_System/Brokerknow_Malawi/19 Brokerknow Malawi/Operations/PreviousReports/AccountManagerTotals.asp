...
<title>Account Manager Totals</title>
...
report_description = "Account Manager Totals"
...
If genReport = ""  Then%>
	...
	<form method="POST" action="AccountManagerTotals.asp" Name="frmMain" id="frmMain">
			...
			<tr style="display: none;" id="OwnFieldsSelectRow" align="right">
				<td colspan=2 valign="top" style="PADDING-LEFT: 25px">
					<TABLE border="0" cellpadding="2" cellspacing="5">
						...
						Set Rs = Conn.OpenSchema (adSchemaColumns, Array(Empty, Empty, "AccountManagerTotals"))
...
sqlStr = "SELECT " & selColumns & " FROM AccountManagerTotals " & SelectedSearchArgs & " " &  orderByCols 
