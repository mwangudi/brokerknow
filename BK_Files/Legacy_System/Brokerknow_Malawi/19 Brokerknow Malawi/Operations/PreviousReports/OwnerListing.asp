...
<title>Account Manager Listing</title>
...
Const report_ViewName = "OwnerReport"
...
If genReport = "" Or report_description = "" Then%>
	...
	<form method="POST" action="OwnerListing.asp" Name="frmMain" id="frmMain">
			...
			<tr>
				...
				<td>
					<SELECT Name="genReport">
						<OPTION VALUE="1">All Account Managers</OPTION>
					</SELECT>
				</td>
			</tr>
...
Set Rs = Conn.Execute(sqlStr)
 ...
 If Rs.EOF Or Rs.BOF Then%>
		<Script Language="JavaScript">	
			ShowMessage('No account managers were found using the criteria entered.');
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
	...
	<tr>
		  <td COLSPAN=2><font face="Arial" size="2"><b><%=FormatDate(Date)%></b></font></td>
	</tr>
	<tr>
	...
	<% Do Until rs.EOF%>
        		<tr>
      				...
      				<%For i = 0 To Rs.Fields.Count - 1 
						if(i=5) then
						%>		
					 	 <td nowrap><%= FormatNum(Rs.Fields(i).Value) %></td>
				   		<%						
						else
						%>		
