...
<title>Agent Volume Totals</title>
...
report_description = "Agents Volume Totals"
...
If genReport = ""  Then%>
	...
	<form method="POST" action="AgentVolumeTotals.asp" Name="frmMain" id="frmMain">
			...
			<tr style="display: none;" id="OwnFieldsSelectRow" align="right">
				<td colspan=2 valign="top" style="PADDING-LEFT: 25px">
					<TABLE border="0" cellpadding="2" cellspacing="5">
						...
						Set Rs = Conn.OpenSchema (adSchemaColumns, Array(Empty, Empty, "AgentVolumeTotals"))
...
sqlStr = "SELECT " & selColumns & " FROM AgentVolumeTotals " & SelectedSearchArgs & " " &  orderByCols 
