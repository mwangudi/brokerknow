...
<title>Bond Settlement Schedule</title>
...
If genReport <> "1" Or Not IsDate(selectedFromDate) Then%>
	...
	<form method="POST" action="InterbankSchedule.asp" Name="frmMain" id="frmMain">
...
<%
   ...
   set TimeLimitRs=Conn.Execute(sqlStr) 
	...
	SettlementDate=LTdate(CDate(selectedFromDate),5)	
	    ...
	    sqlStr = "SELECT * FROM InterbankSchedule  WHERE (Day(TransferDate) = Day(" & "#" & SelectedFromDate & "#" & ")) " & _
			 " and (Month(TransferDate) = Month(" & "#" & SelectedFromDate & "#" & ")) and " & _
                   " (Year(TransferDate) = Year(" & "#" & SelectedFromDate & "#" & ")) and OrderSecType_DPA_ <>2 "
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
      <td width="10%" nowrap><b><font face="Arial" size="4"><b>INTERBANK SETTLEMENT SCHEDULE</b></font></b></td>
...
<br>
 <table border="0" cellspacing="0" cellpadding="3" style="font-family: Arial Narrow; LEFT-MARGIN:100PX" width="900">
	...
	<tr>
	  ...
	  <td bgcolor="#000000" width="63"><b><font color="#FFFFFF" face="Arial Narrow" size="3">Trade&nbsp;Date:</font></b></td>            
	...
	if (Cds1<>Cds2) and (first<>0) then %>
		...
		<tr>
      	<td colspan="5" width="144"><b>Total </b></td>
    ...
    <tr>
      <td colspan="5" width="144"><b>Net Amount: </b></td>
