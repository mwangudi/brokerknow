...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
  ...
  <table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="946">
    <tr>
      ...
      <td  width="52"><b><font  face="Arial Narrow">ORDER</font></b></td>
      <td  width="55"><b><font  face="Arial Narrow">TYPE</font></b></td>
      <td  width="200"><b><font  face="Arial Narrow">AGENT</font></b></td>
    ...
    if ((Cdbl(groupRs("Excess"))>0) and groupRs.Fields("OrdDetailType")="Purchase") or (groupRs.Fields("OrdDetailType")="Sale" and (groupRs.Fields("BalanceFree")="N" or Cdbl(groupRs.Fields("TotalBalance"))<Cdbl(groupRs.Fields("BalanceQty"))))  then     
    else
	...
	Security1=OrdDetailSecurity    
    	...
    	%>
    		<tr>
			  ...
			  <td width="200"><%= groupRs.Fields("AgentName").Value %></td>
