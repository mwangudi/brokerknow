		...
		For i = 0 To UBound(LevyOrdersSelArray)
				...
				Else
					 sqlStr = "INSERT INTO [LevyReportOrder] (LevyOrder" & _
								...
								"," & " " & "iif(isnull(max([LevyOrder_DPA_])),(SELECT InitialID FROM _Initial_Table_ID_ WHERE TableName = 'LevyReportOrder'),max([LevyOrder_DPA_]) + 1)" & " " & " as LevyOrder_DPA_" & _
