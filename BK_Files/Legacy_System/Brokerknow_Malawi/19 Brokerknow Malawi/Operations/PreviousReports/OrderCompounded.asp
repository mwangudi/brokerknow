...
<%
	...
	Do Until OrderRs.EOF
			...
			sqlStr7="Select Gross,Quantity From ContractCompounded where(Order_DPA_=" & OrderRs.Fields("Order_DPA_").Value & ") and (Security_DPA_=" & OrderRs.Fields("Security_DPA_").Value & ")"
			
			'Response.write(sqlStr7)
			'Response.end
...
<table border="0" cellspacing=2 cellpadding=2 class="ReportsTable" width="700">
	<THEAD>
	<tr class="pageNumbering">
		<td align="left" colspan=2 width="889">
	...
	<THEAD>  
	<tr>
		<td  align="center" height="52" width="584">
            <table border="0" width="100%">
              <tr>
                <td width="43%" style="border: 1px solid #000000" valign="top">
                  <table border="0" width="100%">
                    <tr>
                      <td width="41%" valign="top">NSE TRADING
                  SLIP NO</td>
                      <td width="59%" valign="top">
							<table border=0 cellpadding=1 cellspacing=0>
									...
									Else%>
									<tr><td nowrap><B><%= slipNos %></B></td></tr>
									<%End If%>
                  ...
                  &nbsp;</td>
                <td width="6%"></td>
                <td width="51%" valign="top" style="border: 1px solid #000000">
                  <table border="0" width="100%">
                    <tr>
	...
	<tr>
		<td align="right" height="8" width="584">
            &nbsp;			
		</td>		
	</tr>
 
	<tr>
		<td style="border: 1px solid #000000"  valign="top" width="582">
...
<table border="0" cellspacing=2 cellpadding=2 class="ReportsTable"  width="650">	
	<tr>
		<td width="519">&nbsp;</td>
		<td align=right width="247">KShs </td>
	</tr>
	<tr>
		<td nowrap width="519"><B><%= FormatNumCommasOnly(Quantity) %>&nbsp; <%= Rs.Fields("OrdDetailSecurity").Value %> @
		...
		<td align=right width="247"><b> <%= FormatNum(totalGross) %> </b></td>
	</tr>
	<tr>
		<TD COLSPAN=2 VALIGN="TOP" width="772">
	...
	<%if trim(transferFeeDesc) <> "" then%>
			<tr>
				<td width="519"><%= transferFeeDesc %></td>
				<td align=right width="247">	
	...
	<%if trim(contractStampsDesc) <> "" then%>
			<tr>
				<td width="519"><%= contractStampsDesc %></td>
				<td align=right width="247">	
	...
	<tr>
		<td width="519">TOTAL AMOUNT PAYABLE IN KSHS</td>
		<td align=right width="247">
			<b>
			<%
	...
	<tr>
		<td colspan=2 align="right" height="16" width="772">
            &nbsp;			
		</td>		
	</tr>
	<tr>
		<td align="left" colspan=2 width="772"><small><small>Dividends, Bonuses and Rights are subject to the Rules and Customs of the NSE.</small></small></td>
	</tr>
	<%Dim additionalText
	if lcase(rs.Fields("OrdDetailSecType")) = "fixed" Then
	...
	<tr>
		<td align="left" colspan=2 width="772"><small><small><%=additionalText%></small></small></td>
	</tr>
	
	
	<tr>
		<td colspan=2 width="772"><!--#Include file="DirectorFooter.asp"--></td>
	</tr>
</table>
				<BR class="newpage">
