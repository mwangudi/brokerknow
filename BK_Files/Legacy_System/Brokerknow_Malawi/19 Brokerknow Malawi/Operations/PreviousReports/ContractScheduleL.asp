...
If genReport <> "1" Or Not IsDate(selectedTradeDate) Then%>
	...
	<form method="POST" action="ViewContractSchedule.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    ...
    <tr bgColor="#000000">
	  ...
	  <td bgColor="#000000" nowrap align="center"><b><font size="1.5" color="#FFFFFF">Client&nbsp;Code</font></b></td>
      <td bgColor="#000000" nowrap align="center"><b><font size="1.5" color="#FFFFFF">Client</font></b></td>
      <td bgColor="#000000" nowrap align="center"><b><font size="1.5" color="#FFFFFF">Br&nbsp;</font></b></td>
      <td bgColor="#000000" nowrap align="center"><b><font size="1.5" color="#FFFFFF">Security</font></b></td>      
      <td bgColor="#000000" nowrap align="center"><b><font size="1.5" color="#FFFFFF">Contr</font></b></td>
      <td bgColor="#000000" nowrap align="center"><b><font size="1.5" color="#FFFFFF">Slip</font></b></td>
      <td bgColor="#000000" nowrap align="right"><b><font size="1.5" color="#FFFFFF">Price</font></b></td>
      <td bgColor="#000000" nowrap align="right"><b><font size="1.5" color="#FFFFFF">Quantity</font></b></td>
      ...
      <%
		...
		for i = beginLeviesCol to rs.fields.count - 2
				...
				%>
					<td bgColor="#000000" nowrap  align="center"><b><font size="2" color="#FFFFFF"><%=rs.fields(i).name%></font></b>&nbsp;</td>		
				<%				
		next
      ...
      %>
		...
		<td bgColor="#000000" nowrap align="center"><b><font  size="2" color="#FFFFFF">&nbsp;&nbsp;Gross&nbsp;&nbsp;</font></b></td>
		<td bgColor="#000000" nowrap align="center"><b><font  size="2" color="#FFFFFF">Net Amount</font></b></td>
    </tr>
 <%
     If Not(rs.EOF Or rs.BOF) Then
        ...
        Do Until rs.EOF%>
        		<tr>
      <td nowrap><font size="2"><%= rs("Client_DPA_")%></font>&nbsp;</td>
      <td nowrap><font size="2"><% If Len(rs.Fields("ClientName")) > 25 Then 
									Response.Write Mid(rs.Fields("ClientName"), 1, 25)
								   Else
									Response.Write rs.Fields("ClientName")	
								   End If	 %></font>&nbsp;</td>
	  <td nowrap align="center"><font size="2"><%=rs.Fields("BrokerCode")%></font>&nbsp;</td>
      <td nowrap><font size="2"><%=rs.Fields("SecurityCode")%></font>&nbsp;</td>      
      <td nowrap><font size="2"><%=rs.Fields("ContractNumber")%></font>&nbsp;</td>
      <td nowrap><font size="2"><%=rs.Fields("LotSlipNo")%></font>&nbsp;</td>
      <td nowrap align="right"><font size="2"><%=FormatNum(rs.Fields("LotPrice"))%></font>&nbsp;</td>
      <td nowrap align="right"><font size="2"><%=FormatNumCommasOnly(rs.Fields("LotQty"))%></font>&nbsp;</td>       
      <td style="BORDER-RIGHT: #C0C0C0 1px inset; BACKGROUND-COLOR: transparent">&nbsp;</td>
           <%	levyTotals = 0
				for i = beginLeviesCol to rs.fields.count - 2
						...
						End If
						%>
							<td  nowrap align=right  Style="<%= myStyle %>"><font size="2"><%=FormatNum(rs.fields(i).value)%></font>&nbsp;</td>		
						<%
						'i = i + 1						
             ...
             <td nowrap align="right"><font size="2"><%= FormatNum(grossAmt) %></font>&nbsp;</td>       
             <td nowrap align="right"><font size="2"><%= FormatNum(netAmt) %></font>&nbsp;</td> 
             </tr>      
             <%rs.MoveNext
        Loop%>
			...
			<td colspan=9 align=right>
			 ...
			 <%	
				for i = 0 to UBound(dailyTotalsArray)
						...
						%>
							<td  nowrap align=right style="<%= myStyle %>"><font size="1.5"><%= FormatNum(Trim(dailyTotalsArray(i))) %></font>&nbsp;</td>		
						<%
				next
