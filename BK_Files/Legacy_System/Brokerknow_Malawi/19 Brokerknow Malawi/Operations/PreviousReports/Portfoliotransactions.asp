...
If genReport <> "1" Then%>
	...
	<form method="POST" action="Portfoliotransactions.asp" Name="frmMain" id="frmMain">
...
<table border="0" cellspacing="2" cellpadding="2" style="font-family: Arial Narrow" width="100%">
    <tr>
	  <td bgcolor="#000000" width="80%" nowrap align="left"><font color="#FFFFFF" face="Impact" size="2">PORTFOLIO&nbsp;&nbsp;&nbsp;&nbsp;TRANSACTIONS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
...
Security1=rs("Security_DPA_")	
	if(Security1<>Security2) then
		...
		%>
		<tr>      
		<td align="right" colspan="5"><font face="Arial Narrow" size="3"><b>Holding&nbsp;&nbsp;Totals</font></b></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNumEx(SecurityBoughtQty,0)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNumEx(SecuritySoldQty,0)%></font></b></td>
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNumEx(PreviousBalanceQty,0)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(SecurityBoughtAmount)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(SecuritySoldAmount)%></font></b></td>
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(PreviousBalanceAmount)%></b></font></td>      		
		</tr>
		<%
	...
	%>
	<tr>      
      <td align="left" colspan="8"><font face="Arial Narrow" size="3"><b>Security:&nbsp;<%=rs("SecurityName")%></b></font></td>      
    </tr>
    <tr>      
	...
	<tr>      
      <td align="left" style="border: 1px solid #000000" valign="top" width="100"><font face="Arial Narrow" size="2"><b>Date</b></font></td>
	...
	%>
	<tr>      
      <td width="100"><font face="Arial Narrow" size="2"><%=FormatDate(rs("TransDate"))%></font></td>
	...
	<% 
		 ...
		 BalanceQty=BookQty		 
            %>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNumEx(BoughtQty,0)%></font></td>      
	<%
			if(Security1<>Security2) then
				if(rs("OrderTypeSale")=1) then
				BookPrice=0
      ...
      %>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNumEx(SoldQty,0)%></font></td>
	<%BookValue=BookQty*BookPrice
	BalanceAmount=BookValue		 
	%>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNumEx(BalanceQty,0)%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(BoughtAmount)%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(SoldAmount)%></font></td>
      <td align="Right"><font face="Arial Narrow" size="2"><%=FormatNum(BalanceAmount)%></font></td>
	</tr>
	...
	%>	
	<tr>      
		<td align="right" colspan="5"><font face="Arial Narrow" size="3"><b>Holding&nbsp;&nbsp;Totals</b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNumEx(SecurityBoughtQty,0)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(SecuritySoldQty)%></font></b></td>
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(PreviousBalanceQty)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNumEx(SecurityBoughtAmount,0)%></b></font></td>      
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(SecuritySoldAmount)%></font></b></td>
		<td align="Right" style="border: 1px solid #000000" valign="top"><font face="Arial Narrow" size="2"><b><%=FormatNum(PreviousBalanceAmount)%></b></font></td>      				
	</tr>
	<tr>      
	...
	<tr>      
		<td align="right" colspan="5"><font face="Arial Narrow" size="2"><b>PORTFOLIO&nbsp;TOTAL</b></font></td>
