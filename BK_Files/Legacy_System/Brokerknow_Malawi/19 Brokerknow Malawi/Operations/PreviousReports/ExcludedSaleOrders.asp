...
<%
	...
	Dim Security2
	    ...
	    If (groupRs.EOF=true Or groupRs.BOF=true) Then %>
			...
			'response.write groupRs("BalanceFree") & "  kkksdk"
	    End If
...
<table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">
  ...
  <table border="0" cellspacing="0" cellpadding="2" style="font-family: Arial Narrow" width="100%">        
	...
	'if (groupRs.Fields("OrdDetailType")="Sale" and (groupRs.Fields("BalanceFree")="N" or Cdbl(groupRs.Fields("TotalBalance"))<Cdbl(groupRs.Fields("BalanceQty")))) then 
