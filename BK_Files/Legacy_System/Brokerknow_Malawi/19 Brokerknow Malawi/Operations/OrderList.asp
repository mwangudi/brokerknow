...
'======================= Begin_Alter_Across_Entities =================================
			...
			'rowData = rowData & quote & FormatDate(rs.Fields("TimeChanged")) & quote  
			rowData = rowData & "]" 
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:35em;width:65em">
