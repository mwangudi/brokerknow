...
'======================= End_Alter_Across_Entities =================================
	...
	rowData = rowData & quote & "<input type = 'text' name ='txtDebit' id = 'txtDebit' size='9' onChange = 'event.cancelBubble=true;' OnClick='event.cancelBubble=true;'>" & quote & ","
...
<form name = 'frm<%=DataSource%>Item' id='frmMain' method = 'post' action = '<%=DataSource%>Item.asp'>
