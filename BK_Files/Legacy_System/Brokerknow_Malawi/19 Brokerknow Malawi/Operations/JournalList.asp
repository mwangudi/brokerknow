...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & rs.Fields("JournalNarrative") & quote & ","		
			rowData = rowData & quote & Release & quote & "," 
			rowData = rowData & quote & rs.Fields("ReleasedBy") & quote  & ","
			rowData = rowData & quote & FormatDate(rs.Fields("ReleaseDate")) & quote & ","
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["No",  "Date","User", "Entity", "Account", "Debit",  
			"Credit", "Narrative", "Released","Released By", "Release Date","Last Modified By","Time Modified"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="JournalDate:Date*3;JournalEntryUser:User*0;JournalEntryEntity:Entity*0;JournalEntryAccount:Account*0;JournalEntryDebit:Debit*2;JournalEntryCredit:Credit*2;JournalNarrative:Narrative*0;Released:Released*0;ReleaseDate:Release Date*3">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="JournalDate:Date;JournalEntryUser:User;JournalEntryEntity:Entity;JournalEntryAccount:Account;JournalEntryDebit:Debit;JournalEntryCredit:Credit;JournalNarrative:Narrative;Released:Released;ReleaseDate:Release Date">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="JournalDate:Date*3;JournalEntryUser:User*0;JournalEntryEntity:Entity*0;JournalEntryAccount:Account*0;JournalEntryDebit:Debit*2;JournalEntryCredit:Credit*2;JournalNarrative:Narrative*0;Released:Released*0;ReleaseDate:Release Date*3">
