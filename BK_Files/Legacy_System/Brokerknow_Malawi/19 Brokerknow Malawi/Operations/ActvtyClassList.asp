...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ActvtyClassList"
		const DataEntity = "ActvtyClass"
		const DataEntityPlural = "Activity Types"
...
'======================= Begin_Alter_Across_Entities =================================
			'row ID 
			rowData = rowData & quote & rs.Fields("ActvtyClass_DPA_") & quote & " : " 
			
			'row data 
			rowData = rowData & "[" 
			rowData = rowData & quote & rs.Fields("ActvtyClassDescription") & quote & "," 
			rowData = rowData & "]" 
			'build the row IDs array 
			rowIDs = rowIDs & quote & rs.Fields("ActvtyClass_DPA_") & quote 
			rowCount = rowCount + 1
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="ActvtyClassDescription:Description*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="ActvtyClassDescription:Description">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="ActvtyClassDescription:Description*0">
