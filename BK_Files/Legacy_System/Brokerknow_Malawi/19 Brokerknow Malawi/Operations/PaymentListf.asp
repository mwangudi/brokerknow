...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "PaymentListWithoutCDSPrePaid"
		const DataEntity = "Paymentf"
		const DataEntityPlural = "Paymentfs"
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["Date", "Entity", "Account", "Bank", 
			"Amount", "Reference","Last Modified By","Time Modified"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
...
<%'======================= Begin_Alter_Across_Entities =================================%>
				...
				<input type = 'hidden' name ='FilterArgs' id="FilterArgs" value="EntityType:Entity*0;EntityName:Account*0;PaymentPDate:Date*3;PaymentAmount:Amount*2;BankAccountName:Bank*0;ChangedBy:Last Modified By*0;PaymentReference:Reference*0">
				<input type = 'hidden' name ='SortArgs' id="SortArgs" value="EntityType:Entity;EntityName:Account;PaymentPDate:Date;BankAccountName:Bank;PaymentAmount:Amount;ChangedBy:Last Modified By;PaymentReference:Reference">
				<input type = 'hidden' name ='SearchArgs' id="SearchArgs" value="EntityType:Entity*0;EntityName:Account*0;PaymentPDate:Date*3;PaymentAmount:Amount*2;BankAccountName:Bank*0;ChangedBy:Last Modified By*0;PaymentReference:Reference*0">
				<input type = 'hidden' name ='dialogLayout' id="dialogLayout" value="height:36em;width:36em">
