	   ...
	   Dim palno
					...
					conn.BeginTrans		
							...
							sqlStr = "INSERT INTO [PaymentRequests] (Request_DPA_,Client_DPA_, " & _
									"PaymentAmount,RequestNarrative,RequestPayDate,ModifiedBy,CreatedBy) " & _
...
<form name = 'frmAddOffering' method = 'post' id="frmMain" action = "AddPaymentRequest.asp" >
	<table border="0" width="100%" cellpadding=2 cellspacing=2>
     ...
     <tr>
		...
		<tr>
			...
			<td><input type = 'text' name ='txtAmount' id = 'txtAmount' size="25" value='' onblur='UpdatePayable()'></td>
		</tr>
		<tr>
     ...
     <tr>
		...
		<td><textarea name ='txtNarrative' id = 'txtNarrative' rows="5" cols="30" ></textarea>
		</td>     
     </tr>                         
  <tr>
