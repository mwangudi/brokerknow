...
'======================= Begin_Alter_Across_Entities =================================
		...
		const DataSource = "ManualReleaseOrderList"
...
'======================= Begin_Alter_Across_Entities =================================
			if rs.Fields("OrderHold") then
					...
					orderHeld = "<input type=checkbox class='BorderLess' ReleaseDate = '" & rs.Fields("OrderAutoReleaseDate") &  "' style=BorderLess checked value='True' name='chkHold' onClick = 'UpdateHoldStatus(this, " & rs.Fields("Order_DPA_") & ");'>"
			end if
			...
			if rs.Fields("OrderTypeName")="Sale" then
			  cash=""
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			"Reference", "Client", "Cash", "Portfolio", "Release"];
		    </script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
