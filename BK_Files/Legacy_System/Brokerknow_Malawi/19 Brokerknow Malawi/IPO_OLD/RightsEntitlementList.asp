...
'======================= Begin_Alter_Across_Entities =================================
		...
		const ActionPage = "RightsEntitlementList"		
		const DataSource = "RightsEntitlementList"
		const DataEntity = "RightsEntitlementList"
		const DataEntityPlural = "RightsEntitlementLists"
...
'======================= Begin_Alter_Across_Entities =================================
			...
			rowData = rowData & quote & FormatNum(rs.Fields("Box1")) & quote & ","
			rowData = rowData & quote & FormatNumEx(rs.Fields("Box2"),0) & quote & ","
			rowData = rowData & quote & FormatNum(rs.Fields("Box3")) & quote & ","			
			rowData = rowData & quote & FormatNum(rs.Fields("Box4")) & quote & ","			
...
'======================= Begin_Alter_Across_Entities =================================%> 
		<script>
			...
			var myColumns = ["PAL NO","Batch","Code","Client Name","Offering","Alloted Quantity",
			"Alloted Amount Payable"," Full Quantity"," Full Amount Payable","Applied","Apply Date"];
		</script>
<%'======================= End_Alter_Across_Entities =================================%>			
		<script>
			//data
