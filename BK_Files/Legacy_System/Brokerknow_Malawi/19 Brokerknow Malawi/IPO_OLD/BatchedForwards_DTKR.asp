			...
			<table border="0" cellspacing="0" cellpadding="5" width="100%">
				...
				do until Rs.eof
						...
						<tr>
							...
							<td width="10%" style="border:1 solid black;" nowrap align="center"><%=Rs("OfferBank")%></td>
							<td width="10%" style="border:1 solid black;" nowrap align="center"><%=Rs("OfferCheque")%></td>
						</tr>
						<%
