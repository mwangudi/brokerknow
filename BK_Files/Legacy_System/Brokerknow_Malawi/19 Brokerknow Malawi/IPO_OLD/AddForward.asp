...
END IF
	...
	conn.BeginTrans		
			sqlStr = "INSERT INTO Offerings (PAL_No,Client_DPA_, " & _
				"Offering,Offering_Price,Alloted_Rights,ChangedBy,AcceptanceType,Additional,Batch_No,Forward,OfferCheque,OfferBank,DateCreated,CreatedBy,ReceivingBroker) " & _
				" VALUES ('" & palno & "'," & ClientName & "," & offering & "," & Price & "," & AlRights & "," & UserId & "," & Accept & "," & AddNew & "," & BatchNo & ",1,'" & chkno & "','" & narrative & "',GetDate(),"& UserID &","& Broker &")"
