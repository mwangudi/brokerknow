...
%>
<head>
<title>UnBatched Offerings</title>
...
If genReport <> "1" Then%>
	...
	<form method="POST" action="unBatchedApplications.asp" Name="frmMain" id="frmMain">
...
<%
	...
	sqlStr = "SELECT * FROM OfferingsList where Offering = "& Offering &" AND (Batch_No IS NULL)"
	...
	If rs.EOF Or rs.BOF Then%>
		<Script Language="JavaScript">
			alert("No unbatched applications were found.")
			window.location.href='unBatchedApplications.asp';
		</Script>
		<%Set Rs = Nothing
		Set Conn = Nothing
		Response.End
