...
%>
<head>
<title>UnBatched Forwards</title>
...
If genReport <> "1" Then%>
	...
	<form method="POST" action="UnBatchedForwards.asp" Name="frmMain" id="frmMain">
...
<%
	...
	sqlStr = "SELECT * FROM ForwardsList where Offering = "& Offering &" AND (Batch_No IS NULL)"
	...
	If rs.EOF Or rs.BOF Then%>
		<Script Language="JavaScript">
			alert("No unbatched forwards were found.")
			window.location.href='UnBatchedForwards.asp';
		</Script>
		<%Set Rs = Nothing
		Set Conn = Nothing
		Response.End
...
<table border="0" cellspacing="0" cellpadding="0" style="font-family: Arial Narrow" width="100%">
	...
	<br>
	<tr>
		<td width="100%" nowrap align="left"><font face="Impact" size="4">UNBATCHED FORWARDS</font></td>      
	</tr>
	<tr>
