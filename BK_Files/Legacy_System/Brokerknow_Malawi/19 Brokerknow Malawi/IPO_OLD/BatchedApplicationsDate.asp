...
<%
	...
	sqlStr = "SELECT * FROM OfferingsList where Offering = "& Offering &" AND (NOT (Batch_No IS NULL)) AND Cast(floor(cast(Offerings_Date as float)) as DateTime) Between '" & FormatDate(CDate(selectedFromDate)) & "' and '" & FormatDate(CDate(selectedToDate)) & "' " & _
	...
	If rs.EOF Or rs.BOF Then%>
		<Script Language="JavaScript">
			...
			window.location.href='BatchedApplicationsDate.asp';
		</Script>
		<%Set Rs = Nothing
		Set Conn = Nothing
		Response.End
...
<%
   ...
   'Prepare cover page
	...
	<br>
	<tr>
		<td width="100%" nowrap align="left"><font face="Impact" size="4">BATCHED APPLICATIONS SUMMARY</font></td>      
	</tr>
	<tr>
